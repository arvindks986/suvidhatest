...
<table class="border">
    <tr><td style="text-align: center; font-weight: bold !important;">
                        <p style="font-size: 16px !important; text-transform: uppercase;"><b>31 -WINNING CANDIDATES ANALYSIS OVER TOTAL ELECTORS</b></p>
                  </td>
              </tr>
</table>
<br>
...
@php
			...
			<tr>
                <td style="font-weight: bold !important;"><b>Total Seats</b></td>
                <td style="font-weight: bold !important;"><b>{{$all_total_sheet}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$zero_to_10}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$one_to_20}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$two_to_30}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$three_to_40}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$four_to_50}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$five_to_60}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$six_to_70}}</b></td>
                <td style="font-weight: bold !important;"><b>{{$seven_to_80}}</b></td>
            </tr>
