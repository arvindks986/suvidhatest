        ...
        <div class="row">
            <div class="card text-left mt-5" style="width:100%; margin:0 auto;">
                 ...
                 <div class=" card-header">
                    <div class=" row">
                        <div class="col"><h4> Election Commission Of India, General Elections, {{getElectionYear()}}<br>(4 - List Of Successful Candidate)</h4></div>
                        <div class="col">
                               <p class="mb-0 text-right"><b class="bolt">All India</b> <span class="badge badge-info">All State</span> &nbsp;&nbsp; <b></b>
                                </p>
                            <p class="mb-0 text-right">
                                <a href="{{'list-of-successfull-candidate-pdf'}}" target="_blank" class="btn show pdfbut"><img src="/assets/images/pdf.png" style="width: 53px !important;"></a>
<!--                                Eci-list-of-successfull-candidatexls-->
                                <a href="{{'list-of-successfull-candidate-excell'}}" target="_blank" class="btn  show pdfbut"><img src="/assets/images/excel.jpg" style="position: relative; top: -3px; width: 61px !important;display: table-row;"></a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" style="width: 100%;table-layout: fixed;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="col">{{$allsuccessfullcondidate['state']}}</th>
                            <tr>
