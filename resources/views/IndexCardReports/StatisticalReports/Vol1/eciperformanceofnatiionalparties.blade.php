                    ...
                    <div class=" row">
                        ...
                        <div class="col">
                            ...
                            <p class="mb-0 text-right">
                                <a href="performance-of-national-partys-pdf" target="_blank" class="btn show pdfbut"><img src="/assets/images/pdf.png" style="width: 53px !important;"></a>
                                <a href="{{'performance-of-national-partys-xls'}}" target="_blank" class="btn  show pdfbut"><img src="/assets/images/excel.jpg" style="position: relative; top: -3px; width: 61px !important;display: table-row;"></a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead class="">
                            ...
                            <tr>
                                ...
                                <th scope="col">Won</th>
                                <th scope="col">DF</th>
                                <th scope="col">Votes <br> Secured by <br> Party</th>
                                <th scope="col">Over total <br> electors</th>
                                <th scope="col">Over total valid <br> votes polled</th>
                            </tr>
                        </thead>
                        <tbody>
                           <?php
                           ...
                           ?>
                            ...
                            <tr>
                                ...
                                //$electorspercent += $totalElectors[0]->total_electors;
                                //$overtotalvaliedpercent += $totalVotes[0]->totalVotes;
