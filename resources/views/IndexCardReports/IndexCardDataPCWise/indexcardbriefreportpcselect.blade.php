...
<section class="">
 ...
 <div class="card-body" style="">
	...
	<form class="form form-inline" method="POST" action="getindexcardbriefdata" style="padding:75px 0px;">
	
	 
	 <div class="col-sm-12 form-group">	   
	    <div class="col-sm-8">
	    	@csrf
	    	<input type="hidden" name="st_code" value="{{$session['election_detail']['st_code']}}">
