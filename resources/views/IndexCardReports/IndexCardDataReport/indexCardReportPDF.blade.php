<html>
    ...
    <div class="bordertestreport">
        ...
        <table>
            ...
            <tr>
                <td>
                    <h3>Index Card Data Report</h3>
                </td>
                <td style="text-align: right;">
                      <p><strong>State :</strong> <?php echo $session['admin_login_details']['placename'];?> </p>
                </td>
            </tr>
        ...
        <div class="">
            <table>
                <tr style="margin-bottom: 10px;">
                    <td style="">
                        <p>Type of Constituency &nbsp;&nbsp;{{$value->PC_TYPE}}</p></td>
                        
                      <td style="text-align: right;">
                                <p class="text-right"> Number & Name of PC&nbsp;&nbsp;&nbsp; {{$value->PC_NO}} : {{$value->PC_NAME}} </p>
                            </td>
                        </tr>
                    ...
                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped" style="width: 100%;">
                                    ...
                                    <tr class="table-primary">
                                        ...
                                        <th scope="col" rowspan="2" valign="middle">Electors II</th>
                                        <th scope="col" colspan="2" align="center" style="text-align:center">Other Than NRIs</th>
                     ...
                     <table class="table table-bordered table-striped" style="width: 100%;">
                                ...
                                <tr class="table-primary">
                                    <th scope="col"> IV</th>
                                    <th scope="col" colspan="5">DETAILS OF POSTAL VOTES POLLED ON EVM</th>
                                </tr>
                                ...
                                <tr style="border-bottom: 1px solid #000 !important;">
                                    <td>2</td>
                                    <td colspan="4">Test Votes Under Rule Rule 49 MA</td>
                                ...
                                <br>
                                    <caption>DETAILS OF VOTES POLLED BY EACH CANDIDATE</caption>
                                <table class="table table-bordered table-striped" style="width: 100%;">
                                    <thead>
                                        <tr class="table-primary">
                                            <th scope="col"> SNo</th>
                            ...
                            <p></p>
                            <div class="table-responsive">
                                <caption>DETAILS OF ELECTORS -ASSEMBLY SEGMENT WISE</caption>
                                <table class="table table-bordered table-striped" style="width: 100%;">
                                    <thead>
                                        <tr class="table-primary">
                                            <th scope="col" rowspan="2"> AC No. and AC Name </th>
                                            <th scope="col" colspan="4">General(Other <b> NRIs)</th>
