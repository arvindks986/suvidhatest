...
<table class="border">
  <tr><td style="text-align: center; font-weight: bold !important;">
                        <p style="font-size: 18px !important; text-transform: uppercase;"><b>26 - PARTICIPATION OF WOMEN IN NATIONAL PARTIES</b></p>
                  </td>
              </tr>
...
<br>
                        ...
                        <table class="table borders" style="width: 100%;">
                            <thead>
                                ...
                                <tr>
                                    <th rowspan="2" class="blc" style="width: 10%;">Party Name </th>
                                    <th colspan="3" style="text-decoration: underline;">Candidates </th>
                                    <th colspan="2" style="text-decoration: underline;">Percentage </th>
                                    <th rowspan="2" class="blc">Votes <br>secured by <br> Women <br> Candidate </th>
                             ...
                             <tr>
								 ...
								 <th class="blc">Won</th>
                                 <th class="blc">DF</th>
                                 <th class="blc">Over total <br> electors</th>
                                  <th class="blc">Over total <br>Valid Votes</th>
                        ...
                        @endforeach
                           ...
                           <td class="blcs"><b>{{round($totvsp,2)}}</b></td>
                            </tr>
