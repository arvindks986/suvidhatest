...
<script>
var pcAcs = new Array();
<?php foreach($selected_PCACS as $hole => $leave){ ?>
pcAcs.push('<?php echo $leave; ?>');
<?php } ?>
//alert(pcAcs);
</script>
  ...
  <div class="container-fluid">
	 ...
	 <div class="row" style="display:none;">
	  ...
	  <div class="part-1">
            ...
            <div class="col-sm-5 col-12">
			 ...
			 <div class="col-sm-2 col-12">
              <div class="custom-control custom-radio customRadioBtn">  
			    ...
			    @endif
				<label class="custom-control-label" for="both">{{ __('messages.Both') }}</label>
              </div>
            </div>
		 ...
		 <div class="form-group ">
				  ...
				  @if(empty($thumb))
				  <div class="animate-help-text profile_img" style="display:block">
				    <div class="help-text">Please Upload Image</div>
				  ...
				  @endif
                    <div class="browse_image_outer">
                      ...
                      <div class="avatar-upload btn file-frame">
								...
								@else
									<img src="https://demo.eci.nic.in/suvidhaac/public/img/vendor/avtar.jpg" class="img-responsive">
			...
			<div class="form-group row align-items-center justify-contant-around py-2 px-5">
			  ...
			  @foreach($pcs as $iterate_ac)
			  @if($iterate_ac['PC_NO'] == $pc_no)
			  <option value="{!! $iterate_ac['PC_NO'] !!}" selected="selected">{!! $iterate_ac['pc_name'] !!}</option>
			  @else
			  <option value="{!! $iterate_ac['PC_NO'] !!}">{!! $iterate_ac['pc_name'] !!}</option>
			  @endif
			  @endforeach
			</select>		  
            </div>
			
			<input type="hidden" name="legislative_assembly" id="legislative_assembly" class="form-control nomination-field-2" value="{{$pc_no}}">
		  ...
		  <fieldset class="py-4 px-5 mb-4">
            ...
            <div class="row">
			  ...
			  <div class="col-sm-6 col-12">
                <div class="form-group mt-2 mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.canac') }}</label>
            ...
            <input type="hidden" name="resident_ac_no" id="resident_ac_no" class="form-control nomination-field-2" value="{{$resident_ac_no}}">
              ...
              <div class="col-sm-6 col-12">
                <div class="form-group mt-2 mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.canpc') }} </label>
                  <select name="resident_pc_no" id="resident_pc_no" class="form-control nomination-field-2" disabled>
                      <option value="">{{ __('step3.select') }} </option>
                      @foreach($resident_pcs as $iterate_ac)
                      @if($iterate_ac['PC_NO'] == $resident_pc_no)
                      <option value="{!! $iterate_ac['PC_NO'] !!}" selected="selected">{!! $iterate_ac['pc_name'] !!}</option>
                      @else
                      <option value="{!! $iterate_ac['PC_NO'] !!}">{!! $iterate_ac['pc_name'] !!}</option>
                      @endif
          ...
          <input type="hidden" name="resident_pc_no" id="resident_pc_no" class="form-control nomination-field-2" value="{{$resident_pc_no}}">
          ...
          <fieldset class="py-4 px-5 mt-2 mb-4">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-12">
			   ...
			   <div class="col-sm-6 col-12">
                <div class="form-group mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.papc') }}</label>
                  <select name="proposer_pc" id="proposer_pc" class="form-control nomination-field-2" onchange="getAcByPC(this.value,'{{$st_code}}','first');">
                      <option value="">{{ __('step3.select') }}</option>
                      @foreach($pcs as $iterate_pc)
                      @if($iterate_pc['PC_NO'] == $proposer_pc)
                      <option value="{!! $proposer_pc !!}" selected="selected">{!! $iterate_pc['pc_name'] !!}</option>
                      @else
                      <option value="{!! $iterate_pc['PC_NO'] !!}">{!! $iterate_pc['pc_name'] !!}</option>
                      @endif
                      @endforeach
                    </select>
		...
		<div class="part-2" id="part_2" style="display:<?php echo $disp2; ?>">
		 <form method="post" action="{!! $action !!}" enctype="multipart/form-data">
          ...
          <h6 class="part-sub-title mb-5">({{ __('step3.notrec') }})</h6>
			...
			<input type="hidden" name="legislative_assembly" id="legislative_assembly" value="{{$pc_no}}">
            ...
            <input type="hidden" name="resident_ac_no" id="resident_ac_no" class="form-control nomination-field-2" value="{{$resident_ac_no}}">
                ...
                <div class="col-sm-6 col-12">
                  <div class="form-group mb-2">
                    <label for="" class="lbl-mandry">{{ __('step3.canpc') }}   </label>
                    <select name="resident_pc_no" id="resident_ac_nott" class="form-control" disabled>
					  <option value="">{{ __('step3.select') }}</option>
					  @foreach($resident_pcs as $iterate_ac)
                      @if($iterate_ac['PC_NO'] == $resident_pc_no)
                      <option value="{!! $iterate_ac['PC_NO'] !!}" selected="selected">{!! $iterate_ac['pc_name'] !!}</option>
			 ...
			 <input type="hidden" name="resident_pc_no" id="resident_ac_nott" value="{{$resident_pc_no}}">
            <div class="row my-3">
		  ...
		  <fieldset class="py-4 px-5 mb-4">
            ...
            <input type="hidden" name="resident_ac_no" id="resident_ac_no" class="form-control nomination-field-2" value="{{$resident_ac_no}}">
              ...
              <div class="col-sm-6 col-12">
                <div class="form-group mt-2 mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.canpc') }}</label>
                  <select name="resident_pc_no" id="resident_ac_no" class="form-control nomination-field-2" disabled>
                      <option value="">{{ __('step3.select') }} </option>
                      @foreach($resident_pcs as $iterate_ac)
                      @if($iterate_ac['PC_NO'] == $resident_pc_no)
                      <option value="{!! $iterate_ac['PC_NO'] !!}" selected="selected">{!! $iterate_ac['pc_name'] !!}</option>
            ...
            <input type="hidden" name="resident_pc_no" id="resident_pc_no" class="form-control nomination-field-2" value="{{$resident_ac_no}}">
          ...
          <fieldset class="py-4 px-5 mt-2 mb-4">
            ...
            <div class="row">
			  ...
			  <div class="col-sm-6 col-12">
                <div class="form-group mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.papc') }}</label>
                  <select name="proposer_pc" id="proposer_pc_both" class="form-control nomination-field-2" onchange="getAcByPC(this.value,'{{$st_code}}','both');">
                      <option value="">{{ __('step3.select') }}</option>
                      @foreach($pcs as $iterate_pc)
                      @if($iterate_pc['PC_NO'] == $proposer_pc)
                      <option value="{!! $proposer_pc !!}" selected="selected">{!! $iterate_pc['pc_name'] !!}</option>
	...
	<!--End Both Part Start Here  -->  
	  ...
	  <script type="text/javascript">
		function getAcByPC(pc_no,st_code,type){
			if(pc_no !='' && st_code !=''){
				$.ajax({
					url: "{!! url('get-ac-by-pcno') !!}",
					type: 'GET',
					data: 'st_code='+st_code+'&pc_no='+pc_no,
					dataType: 'json', 
					beforeSend: function() {
					  $('.loading_spinner').remove();
					  $('.error_message').remove();
					  $('#proposer_pc_both').append(" <i class='fa fa-circle-o-notch loading_spinner fa-spin load' aria-hidden='true'></i>");
					},  
					complete: function() {
					  $('.loading_spinner').remove();
					  $('#proposer_pc_both').prop('disabled', false);
					},        
					  ...
					  if(json['success'] == false){  
					   //$('#epic_no_'+idt).parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
						$("#errorDatat_both_"+idt).html(json['message']);
						  ...
						  var aclist = json['data'];
						  if(type=='both'){
							  var $el = $("#proposer_assembly_both");
						  }else{
							  var $el = $("#proposer_assembly");
						  }
						  
							$el.empty(); // remove old options
							$el.prepend("<option value='' selected='selected'>Select</option>");
							$.each(aclist, function(key,value) {
							  $el.append($("<option></option>")
								 .attr("value", value.AC_NO).text(value.AC_NO+'-'+value.AC_NAME));
							});
						  //alert(aclist);
					  }  
					  $('.loading_spinner').remove();    
	   ...
	   // if(json['basic'].st_code == '<?php echo $st_code ?>' && json['basic'].ac_no == '<?php echo $ac_no ?>'){       
		function checkProposalAc(val, error, sub){
			...
			//alert(val);
			//alert(pcAcs);
			//alert(pcAcs.indexOf(val.toString()));
						 //if(val != selAc){
						if(pcAcs.indexOf(val.toString())==-1){	 //alert("Text");
        ...
        success: function(json) { 
          ...
          if(json['success'] == false){
           // $('#epic_no').parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
			...
			if(json['basic'].st_code === "<?php echo $st_code ?>"){          	
				if(json['basic'].ac_no != '' && json['basic'].ac_no != null){
					if(pcAcs.indexOf(json['basic'].ac_no.toString())!==-1){
					//		if(pcAcs.indexOf(val.toString())==-1){
        ...
        success: function(json) { 
          ...
          if(json['success'] == false){  
           //$('#epic_no_'+idt).parent('.input-group').after("<span class='text-danger error_message'>"+json['message']+"</span>");
			...
			if(json['basic'].st_code == '<?php echo $st_code ?>'){       
				if(pcAcs.indexOf(json['basic'].ac_no.toString())!==-1){	 //alert("Text");
