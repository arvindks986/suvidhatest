...
<div id="content" >   
  <div style="width: 100%; border: 1px solid #000;">
	...
	@if($recognized_party == 'recognized' or $recognized_party ==1 or $recognized_party ==0 or $recognized_party ==3)
	  ...
	  <div>{{ __('finalize.nominate_ac') }}<span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;"><b>&nbsp;   {{$legislative_assembly}}-<?php echo app(App\Http\Controllers\Nomination\NominationController::class)->getPcName($st_code, $legislative_assembly); ?></b></span>  {{ __('finalize.Assembly_Constituency') }}. </div>
		<div class="param-area">
			<p>{{ __('finalize.Candidate_name') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;"> <b>&nbsp;{{$name}}</b></span> {{ __('finalize.Father_husband_mother') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{!! $father_name !!}</b></span> {{ __('finalize.His_postal_address') }} <span  style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp;  <b>{!! $address !!}</b> </span> {{ __('finalize.His_name_is_entered_at_Sl') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{$serial_no}}</b></span> {{ __('finalize.in_Part_No') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp;<b>{{$part_no}}</b></span> {{ __('finalize.of_the_electoral_roll_for') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{$candidate_ac}}-<?php echo app(App\Http\Controllers\Nomination\NominationController::class)->getAcName($candidate_state, $candidate_ac); ?>&nbsp;</b></span> {{ __('finalize.amb_comp_with') }}  <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{$candidate_pc}}-<?php echo app(App\Http\Controllers\Nomination\NominationController::class)->getPcName($candidate_state, $candidate_pc); ?>	</b> </span> {{ __('finalize.Assembly_Constituency') }}. 
			</p>
			<p> {{ __('finalize.My_name_is') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp;<b>{{$proposer_name}}</b> </span> {{ __('finalize.and_it_is_entered_at_Sl') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{$proposer_serial_no}}</b> </span>{{ __('finalize.in_Part_No') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{@$proposer_part_no}}</b> </span> {{ __('finalize.of_the_electoral_roll_for') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{$proposer_assembly}}-<?php echo app(App\Http\Controllers\Nomination\NominationController::class)->getAcName($st_code, $proposer_assembly); ?>	</b> </span> {{ __('finalize.amb_comp_with') }}  <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>{{$pc_no}}-<?php echo app(App\Http\Controllers\Nomination\NominationController::class)->getPcName($st_code, $pc_no); ?>	</b> </span> {{ __('finalize.Assembly_Constituency') }}. </p>
		</div>
		...
		<div class="td-center td-bold" style="border-top: 2px solid #000; padding-top:0.85rem;"><strong> {{ __('finalize.PART2') }} </strong></div>
		  ...
		  <p> <strike>{{ __('finalize.Candidate_name') }}<span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>...........</b></span> {{ __('finalize.Father_husband_mother') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>...........</b></span> {{ __('finalize.His_postal_address') }}<span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp;  <b>...........</b> </span>
			...
			{{ __('finalize.His_name_is_entered_at_Sl') }} <span  style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>...........</b></span> {{ __('finalize.in_Part_No') }} <span  style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>...........</b></span> {{ __('finalize.of_the_electoral_roll_for') }}  <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>...........</b></span>  {{ __('finalize.amb_comp_with') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>...........</b></span>   {{ __('finalize.Assembly_Constituency') }}. <strike>
		</p>	
		</div>  </strike> 
		<div>
		  <p>
	...
	@if($recognized_party != '3')		
	  ...
	  <div><strike>{{ __('finalize.nominate_ac') }}<span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;"><b>&nbsp;........</b></span>  {{ __('finalize.Assembly_Constituency') }}. </strike></div>
		<div class="param-area">
			...
			<p><strike> {{ __('finalize.My_name_is') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp;<b>........</b> </span> {{ __('finalize.and_it_is_entered_at_Sl') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>........</b> </span>{{ __('finalize.in_Part_No') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>@if($proposer_part_no !='0'){{$proposer_part_no}}@endif</b> </span> {{ __('finalize.of_the_electoral_roll_for') }} <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b> ........	</b> </span>
			{{ __('finalize.amb_comp_with') }}  <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;">&nbsp; <b>
			</b> </span>
			{{ __('finalize.Assembly_Constituency') }}. </strike></p>
		</div>
	    <div class="table-wrap">
			<table style="width: 100%; margin: 1.5rem 0;">
			 <tbody>
	 ...
	 @endif	
		...
		<div class="param-area">
		  <p>
			{{ __('finalize.nominate_ac') }}  <span style="border-bottom: 1px dashed #000; display: inline-block; width: 100%;"><b>&nbsp; <b>{{$pc_no}}-<?php echo app(App\Http\Controllers\Nomination\NominationController::class)->getPcName($st_code, $pc_no); ?>	</b> </span> {{ __('finalize.Assembly_Constituency') }}. 
		  </p><br>  
