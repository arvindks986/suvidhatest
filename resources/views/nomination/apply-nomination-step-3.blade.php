		 ...
		 <h3 class="part-title"><span>{{ __('step3.partn') }}</span></h3>
		  ...
		  <fieldset class="py-4 px-5 mb-4">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-12">
                <div class="form-group mt-2 mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.elecpc') }}</label>
                  <select name="resident_ac_no" id="resident_ac_no" class="form-control nomination-field-2" disabled>
                      ...
                      @if($iterate_ac['pc_no'] == $resident_ac_no)
                      <option value="{!! $iterate_ac['pc_no'] !!}" selected="selected">{!! $iterate_ac['pc_name'] !!}</option>
                      @else
                      <option value="{!! $iterate_ac['pc_no'] !!}">{!! $iterate_ac['pc_name'] !!}</option>
                      @endif
          ...
          <fieldset class="py-4 px-5 mt-2 mb-4">
            ...
            <div class="row">
			  ...
			  <div class="col-sm-6 col-12">
                <div class="form-group mb-2">
                  <label for="" class="lbl-mandry">{{ __('step3.ppc') }}</label>
                  <select name="proposer_assembly" id="proposer_assembly" class="form-control nomination-field-2" onchange="return checkProposalAc(this.value, 'state_error', 'sub');">
                      <option value="">{{ __('step3.select') }}</option>
                      @foreach($acs as $iterate_ac)
                      @if($iterate_ac['pc_no'] == $proposer_assembly)
                      <option value="{!! $iterate_ac['pc_no'] !!}" selected="selected">{!! $iterate_ac['pc_name'] !!}</option>
                      @else
                      <option value="{!! $iterate_ac['pc_no'] !!}">{!! $iterate_ac['pc_name'] !!}</option>
                      @endif
                      ...
                      <tbody>
						...
						//echo "<pre>"; print_r($iterate_proposer); ?>
                          <tr class="non_recognized_proposers_row">
                            ...
                            <td>
								<div class="input-group"  style="width: 250px;">
								  <input type="text"  name="non_recognized_proposers[{{$key}}][epic_no_proposer_serch_part_2]" value="{{$iterate_proposer['epic_no_proposer_serch_part_2']}}" id="epic_no_{{$i}}" onkeyup="myFunction({{$i}})" class="form-control"  placeholder="{{ __('step3.enterepic') }}"  />
								  <div class="input-group-append">
