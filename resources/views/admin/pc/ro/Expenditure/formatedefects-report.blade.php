...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col"><h2 class="mr-auto">Defect in account: {{$count}}</h2></div> 
		 ...
		 <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
		   ...
		   <?php
			...
			<tr>
			   ...
			   <td><a href="javascript:void(0)" onclick="getProfile('{{$candDetails->candidate_id}}')">
...
<script type="text/javascript">
  /*  google.charts.load('current', {'packages': ['bar']});
    ...
    function drawChart() {
        ...
        $.ajax({
            type: "get",
            url: "{{url('/')}}/ropc/formatedefectsgraph",
            dataType: "json",
