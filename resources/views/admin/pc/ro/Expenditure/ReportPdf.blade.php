   ...
   <table style="width:100%;  border: 1px solid #000;" border="0" align="center" cellpadding="5">
               <thead>
                <tr>
                    ...
                    <img src="<?php echo url('/'); ?>/admintheme/images/logo/eci-logo.png" alt=""  width="100" border="0"/></th>
    ...
    <table style="width:100%; border: 1px solid #000;" border="0" align="center">  
                <tr>
                 <td  style="width:49%;">
                    <table  style="width:100%">ST_NAME
                      <tbody>
                         <tr>
                           <td><strong>Scrutiny Candidate Reports</strong></td>
                         </tr>
                         <tr>  
            ...
            <p style="text-align: center; font-size: 18pt; font-family: Arial;"><b>Scrutiny Report Filed By RO</b></p>
            <p style="text-align: center; font-size: 14pt; font-family: Arial;"><b>Candidate Account Detail</b></p>
          <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
          <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;" width="60%">Name :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" width="40%">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->contensting_candiate:'--'}}</td>
          </tr>
          <tr>   
          <td style="border: 1px solid #5d5f61; padding: 12px;">Address of the Candidate :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->candidate_residence_address:'--'}}</td>
         </tr>
         <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">PC Name :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->PC_NAME:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Political Party Affliation, If Any :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->PARTYNAME:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Date of Declaration of Result :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->date_of_declaration:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Date of Account Reconciliation Meeting :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->date_of_account_rec_meetng:'--'}}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(ii) Whether he or his Agent has attended the Meeting :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->reconciliation_meeting_writing:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Whether all the defects Reconciled by the Candidate after Account Reconciliation Meeting (Yes or No). (If not, defects that could not be reconciled be shown in Column No. 15) :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->defect_reconciliation_meeting:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Last Date Prescribed for Lodging Account :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->last_date_prescribed_acct_lodge:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Whether the Candidate has Lodged the Account :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->candidate_lodged_acct:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">If the Candidate has Lodged the Account, Date of Lodging of Account by the Candidate (i) Original Account</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->date_orginal_acct:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(ii) Revised Account after the Account Reconciliation Meeting :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->date_revised_acct:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Whether Account Lodged in Time:</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->account_lodged_time:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">If Account not Lodged or not Lodged in Time, Whether DEO called for Explanation from the Candidate. If not, reason thereof :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->reason_lodged_not_lodged:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Explanation, if any, given by the Candidate :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->explaination_by_candidate:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Comments of the DEO on the Explanation if any, of the Candidate :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->comment_by_deo:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Grand Total of all Election Expenses Reported by the Candidate in Part-II of the Abstract Statement :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->grand_total_election_exp_by_cadidate:'--'}}</td>
        </tr>
      </table>
      ...
      <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;" width="60%">Whether in the RO's Opinion, the Account of Election Expenses of the Candidate has been Lodged in the manner required by the R.P. Act 1951 and C.E. Rules, 1961. :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" width="40%">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->rp_act:'--'}}</td>
        </tr>
        <tr>
          ...
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->comprising:'--'}}<br/>{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->comprising_comment:'--'}}</td>
         </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(ii) Whether duly sworn in affidavit has been submitted by the Candidate :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->duly_sworn:'--'}}{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->duly_sworn_comment:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(iii) Whether requisite Vouchers in respect of items of Election Expenditure Submited :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->Vouchers:'--'}}{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->Vouchers_comment:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(iv) Whether separate Bank Account Opened by for Election :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->seprate_comment:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(v) Whether all Expenditure (Except petty Expenditure) routed through bank Account :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->routed_comment:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(i) Whether the RO had issued a notice to the Candidate for Rectifying the Defect :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->rectifying_comment:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(ii) Whether the Candidate Rectified the Defect :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->rectified:'--'}}{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->rectified_comment:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(iii) Comments of the RO on the above, i.e. whether the defect was rectified or not. :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->comment_of_deo:'--'}}</td>
        </tr>
      </table>
    <br />

    <p style="text-align: center; font-size: 14pt; font-family: Arial;"><b>Expenses Understated</b></p><br />
      <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;" width="60%">Whether the items of Election Expenses Reported by the Candidate correspond with the Expenses shown in the Shadow Observation Register and Folder of Evidance. If no then mention the following.</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" width="40%">{{!empty($expenseunderstated[0])?$expenseunderstated[0]->status:'--'}}</td>
        </tr>
      </table>
      ...
      <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
        ...
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($item->expenditure_type)? $item->expenditure_type:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($item->date_understated)? $item->date_understated:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($item->page_no_observation)? $item->page_no_observation:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($item->amt_as_per_observation)? $item->amt_as_per_observation:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($item->amt_understated_by_candidate)? $item->amt_understated_by_candidate:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($item->description)? $item->description:'--'}}</td>
      ...
      <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;" width="60%">Did the Candidate produce his Register of the Accounting Election Expenditure Register for Inspection by the Observer/RO/Authorized persons 3 times during Campaign Period.</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" width="40%" colspan="2">{{!empty($expenseunderstated[1])? $expenseunderstated[1]->status:''}}</td>
        </tr>
         <tr>
          ...
          <td style="border: 1px solid #5d5f61; padding: 12px;" colspan="2">{{!empty($expenseunderstated[2])? $expenseunderstated[2]->status:''}}</td>
        </tr>
         <tr>
        ...
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(iii) Did the Candidate give any reply to the Notice ? :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" colspan="2">{{!empty($expenseunderstated[4])? $expenseunderstated[4]->status:''}}</td>
        </tr>
        <tr>
        ...
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">(v) RO's Comments/Observations on the Candidate's Explanation :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" colspan="2">{{!empty($expenseunderstated[6])? $expenseunderstated[6]->comment:''}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Whether the RO Agrees that the Expenses are correctly Reported by the Candidate. should be similar to Column no. 8 of Summary Repods of RO :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">No</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;">{{!empty($expenseunderstated[7])? $expenseunderstated[7]->comment:''}}</td>   
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px;">Comments, If Any by the Expenditure Observer :</td>
           <td style="border: 1px solid #5d5f61; padding: 12px;" colspan="2">{{!empty($expenseunderstated[8])? $expenseunderstated[8]->comment:''}}</td>
        </tr>
      </table>
      <br />
    <p style="text-align: center; font-size: 14pt; font-family: Arial;"><b>Fund Given by Political Party</b></p><br />
      <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
        <tr>
        ...
        <tr>
          ...
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;" colspan="6">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_cash:'--'}}</td>
        </tr>
         <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">By Cheque</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_checque:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_checque_date:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_bank_name:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_acct_no:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_ifsc:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_checque_num:'--'}}</td>
        </tr>
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">In Kind</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;" colspan="6">{{!empty($scrutinyReportData[0])?$scrutinyReportData[0]->political_fund_kind:'--'}}</td>
        </tr>
      </table>
      <br />
    <p style="text-align: center; font-size: 14pt; font-family: Arial;"><b>Fund Given By Other Sources</b></p><br />
      <table id="customers" style="border-collapse: collapse; width: 100%; color: #36393c; font-size: 12pt;">
        <tr>
        ...
        <tr>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($items->other_souce_name)?$items->other_souce_name:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($items->other_source_payment_mode)?$items->other_source_payment_mode:'--'}}</td>
          <td style="border: 1px solid #5d5f61; padding: 12px; text-align: center;">{{!empty($items->other_source_amount)?$items->other_source_amount:'--'}}</td>
        </tr>
        @endforeach
        @endif
      </table>
