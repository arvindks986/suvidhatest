            ...
            <div class=" row">
                ...
                <div class="col-md-7 mt-2 mb-2 text-right"><p class="mb-0">
                       ...
                       <!-- <a href="{{url('/eci-expenditure/pendingatroPDF')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a>--> &nbsp;&nbsp;
                        <a href="{{url('/ropc/noticeatdeoEXL')}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;

                        <b></b><a href="{{url('/ropc/statusExpdashboard')}}"> <button type="button" id="Back" class="btn btn-primary">Back</button></a>
...
<td>@if(!empty($candDetails->date_sending_notice_service_to_deo)) {{  date('d-m-Y',strtotime($candDetails->date_sending_notice_service_to_deo))}} @else {{ 'N/A'}} @endif</td>
