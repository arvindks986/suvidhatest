        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action Taken By ARO</a></h2><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i class="fa fa-angle-down"></i></a>
                        </div>
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label">Document Uploded by ARO</label>
...
<!--                                            <button class="btn btn-success float-right text-white" value="Accept" name="accept" id="accept">Accept</button>
                ...
                <div class="col-lg-12 p-0">
                    ...
                    <div class="form-group row text-center">
                        <div class="col">
                            <button type="submit" class="btn btn-primary"><a href="{{url('/aro/permission/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}" style="color: white">Print</a></button>
                        </div>
                    </div>
                </div>
                @endif
