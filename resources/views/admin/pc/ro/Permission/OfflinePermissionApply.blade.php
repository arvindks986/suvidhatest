                ...
                <div class="col-lg-12 p-0">
                    <div class="card">
                        ...
                        <div class="card-body tabular-pane">
                            <form class="form-horizontal" id="permission" method="post" action="{{url('/aro/permission/UserDetails')}}" enctype="multipart/form-data" autocomplete="off">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col">
                                        <div class="row">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select name="police_station" class="form-control">
                                                            ...
                                                            <option value="{{$ps->id}}" {{ (collect(old('police_station'))->contains($ps->id)) ? 'selected':'' }}>{{$ps->police_st_name}}</option>
                                                            @endforeach
                                                            @else
                                                            <option value=""></option>
                                                            @endif
...
//            var permsn_id = $(this).val();
            ...
            else if(ptype_id == 8)
            {
                ...
                $.ajax({
                url: base_url + '/aro/permission/getalldistrict',
                type: 'POST',
