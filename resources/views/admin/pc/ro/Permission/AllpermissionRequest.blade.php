                            ...
                            <table id="list-table" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/aro/permission/getpermissiondetails')}}/{{encrypt($data->permission_id)}}">{{$data->permission_id}}<i class="fa fa-edit float-right font-size01"></i></a></td>
                        ...
                        <div class="tab-pane fade bgactive" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                            <table id="list-table" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/aro/permission/getpermissiondetails')}}/{{encrypt($rdata->permission_id)}}">{{$rdata->permission_id}}<i class="fa fa-edit float-right font-size01"></i></a></td>
                                        <td>{{$rdata->name}}</td>
                        ...
                        <div class="tab-pane fade bgactive" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <table id="list-table" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/aro/permission/getpermissiondetails')}}/{{encrypt($adata->permission_id)}}">{{$adata->permission_id}}<i class="fa fa-edit float-right font-size01"></i></a></td>
                                        <td>{{$adata->name}}</td>
                        ...
                        <div class="tab-pane fade bgactive" id="pills-pending" role="tabpanel" aria-labelledby="pills-contact-tab">
                            <table id="list-table" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/aro/permission/getpermissiondetails')}}/{{encrypt($pdata->permission_id)}}">{{$pdata->permission_id}}<i class="fa fa-edit float-right font-size01"></i></a></td>
                                        <td>{{$pdata->name}}</td>
