                        ...
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            <div class="card-body getpermission ">
                                ...
                                <div class="form-group row">
                                    ...
                                    @else
                                    <label class="col-sm-4 form-control-label">Document Uploded by Nodal</label>
                                    <p class="col-sm-4">Not Uploaded yet</p>

                                </div>
                            </div>

                            <div class="card-footer">
                                <form class="form-horizontal" id="formid{{$i}}" method="post" action="{{url('/aro/permission/uploadnodaldoc')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
...
<!--                                                    <div class="file-select-name" id="noFile1">No file chosen...</div> -->
                                                    ...
                                                    <input type="file" name="nodal-document" id="nodal-document{{$i}}" class="form-control default-file-input" accept=".pdf" style="height: 45px !important;"/>
...
<!--                                                    <div class="file-select-button customchoose" id="fileName">Choose File</div>-->
            ...
            <div class="container">
                <div class="col-lg-12 pl-0 pr-0">
                    ...
                    <div class="card mb-3">        
                        <div class="card-header d-flex align-items-center">
                            <h5 class="mr-auto">Action Taken By ARO</h5> 
                        </div>	
                        <form class="form-horizontal" method="POST" action="{{url('/aro/permission/updateaction')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="file" class="form-control default-file-input" name="rofile"  accept=".pdf" style="height: 45px !important;">
                                        <span class="text-danger">{{ $errors->error->first('rofile') }}</span>
                                    </div>
<!--                                    <div class="file-upload col-sm-8">
                                        <div class="file-select">
                                            <div class="file-select-name" id="noFile">No file chosen...</div> 
                                            <input type="file" class="custom-file-input affidavit form-control mr-auto" id="customFile" name="rofile"  accept=".pdf"/>
                                            <div class="file-select-button customchoose" id="fileName">Choose File</div>
                                            <span class="text-danger">{{ $errors->error->first('nodal-document') }}</span>
                                        </div>
                                    </div>-->
                ...
                <div class="col-lg-12 p-0">
                    ...
                    <div class="form-group row text-center">
                        <div class="col">
                            <button type="submit" class="btn btn-primary btn-lg"><a href="{{url('/aro/permission/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}" style="color: white">Print</a></button>
                        </div>
                    </div>
                </div>
                @endif
