...
<section class="statistics">
        <div class="container-fluid mt-5 mb-5">
		  ...
		  <a type="button" href="{{url('/pcdeo/viewagent')}}" class="btn btn-sm btn-outline-primary">View</a>
                  <a type="button" href="{{url('/pcdeo/agentCreation')}}" class="btn btn-sm btn-primary">Add</a>
				  </div></div>
              </div>
            </div>
                    ...
                    <div class="sidebar__inner">
                        <div class="card"><!--  style="max-width:700px; margin:0 auto;" -->
                            ...
                            <div class="card-body getpermission">
                                ...
                                <form class="form-horizontal" method="POST" action="{{url('/pcdeo/addagent')}}">
                                    {{csrf_field()}}
...
<!--                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" placeholder="Enter Password" name="pass" value="{{old('pass')}}">
