                ...
                <div class="col-lg-12 p-0">
                    <div class="card">
                        ...
                        <div class="card-body tabular-pane">
                            <form class="form-horizontal" id="permission" method="post" action="{{url('/pcdeo/UserDetails')}}" enctype="multipart/form-data" autocomplete="off">
                                {{csrf_field()}}
                                <div class="row">
                                    <div class="col">
                                        <div class="row">
                                            ...
                                            <div class="col" id="pcno">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        @if(!empty($getAllPC))
                                                        @foreach($getAllPC as $pcdata)
                                                            <option value="{{$pcdata->PC_NO}}" > {{ $pcdata->PC_NAME_EN }}</option>
                                                            @endforeach
                                                         @endif
                                                         </select>
...
//        $("#mobileno").blur(function () {
            ...
            {
                $.ajax({
                    url: base_url + '/pcdeo/getUserDetails',
                    type: 'POST',
...
//                    alert(response);exit;
                   ...
                   {
                       $("#ac").empty();
                       $("#ac").append("<option value='0'>Select AC</option>");
//                       $("#ac").css('display','none');
                   }
                }
        });
     ...
     $('select#ac').change(function () {
            ...
            $.ajax({
                url: base_url + '/pcdeo/getlocation',
                type: 'POST',
...
//                $.ajax({
//                url: base_url + '/pcdeo/getalldistrict',
//                type: 'POST',
...
//                });
            ...
            //alert(permsn_id);
            $.ajax({
                url: base_url + '/pcdeo/offlinePermission',
                type: 'POST',
