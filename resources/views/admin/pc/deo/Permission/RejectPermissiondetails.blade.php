...
<main role="main" class="inner cover mb-3 mb-auto">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 pl-0 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action Taken By DEO</a></h5><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i class="fa fa-angle-down"></i></a>
                        </div>
 ...
 @if($RO->cancel_status ==0)
                ...
                @endif
<!--                <div class="container">-->
                    @if(!empty($result->cancel_status) && $result->cancel_status == 0)
                <div class="col-lg-12 pl-0 pr-0">
