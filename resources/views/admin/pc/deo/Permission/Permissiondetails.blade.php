                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        ...
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            ...
                            <div class="card-footer">
                                <form class="form-horizontal" id="formid{{$i}}" method="post" action="{{url('/pcdeo/uploadnodaldoc')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
...
<!--                                                    <div class="file-select-name" id="noFile">No file chosen...</div> -->
                                                    ...
                                                    <input type="file" name="nodal-document" id="nodal-document{{$i}}" class="default-file-input form-control mr-auto" accept=".pdf" style="height: 45px !important;" />
...
<!--                                            <div class="file-select-name" id="noFile1">No file chosen...</div> -->
                                                <input type="file" class="form-control default-file-input mr-auto" id="customFile" name="rofile" style="height: 45px !important;"  accept=".pdf"/>
<!--                                            <div class="file-select-button customchoose" id="fileName">Choose File</div>-->
...
<!--                                        </div>-->
                ...
                <div class="col-lg-12 p-0">
                    ...
                    <div class="form-group row text-center">
                        <div class="col">
                            <button type="submit" class="btn btn-primary btn-lg"><a href="{{url('/pcdeo/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}" style="color: white">Print</a></button>
                        </div>
                    </div>
                </div>
                @endif
