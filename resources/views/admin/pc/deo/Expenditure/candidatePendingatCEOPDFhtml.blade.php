...
$all_pc=getpcbystate($st_code);
 ...
 $countingData=\app(App\models\Expenditure\ExpenditureModel::class)->getResultDeclarationDate();
...
<html lang="en">
    ...
    <body>
                 ...
                 <td  style="width:50%">
                  <table style="width:100%">
                      <tbody>
						 ...
						 <tr>
                           <td align="right"><strong>Date of Counting:</strong> {{ date('d-M-Y',strtotime($countingData['start_result_declared_date'])) }}</td>
                         </tr>
                       <!-- <tr>  
     ...
     $count = 1; 
        $TotalUsers = 0;
        @endphp
         @forelse ($pendingatCEOCandList as $candDetails)
