...
<section class="mt-5">
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
                ...
                <div class=" row">
                 <div class="col"><h2 class="mr-auto">Officer Details</h2></div> 
  ...
  <table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
        ...
        <tbody>
            ...
            @foreach($officerlist as $officerDetailsList)  
              <?php
               $j++; 
              // echo '<pre>'; print_r($officerDetailsList); echo '<pre>';
              ...
              <tr>
               ...
               <td style="background-color:white;">
                <a href="{{url('/pcdeo/officer-profile/'.encrypt($officerDetailsList->id).'/')}}" class="btn btn-primary btn-block">Edit</a>
