            ...
            <div class="col-lg-3 pl-0">
              ...
              <div class="card income text-center">
                ...
                <div class="text-success text-center"><b>Pending</b> &nbsp; <div class="btn-group float-right">
					<a type="button" href="{{url('/ropc/permission/permissioncountdetails')}}/{{'0'}}" class="btn btn-sm btn-outline-primary">@if(!empty($allrecord)) {{$allrecord[0]->Pending}} @else {{'0'}} @endif</a>
              ...
              <div class="card income text-center">
               <!--  <div class="icon"><i class="icon-line-chart"></i></div> -->
                <div class="text-info"><b>Inprogress</b> &nbsp; <div class="btn-group float-right mt-2">
					<a type="button" href="{{url('/ropc/permission/permissioncountdetails')}}/{{'1'}}" class="btn btn-sm btn-outline-primary">@if(!empty($allrecord)) {{$allrecord[0]->Inprogress}} @else {{'0'}} @endif</a>
              ...
              <div class="card income text-center">
               <!--  <div class="icon"><i class="icon-line-chart"></i></div> -->
                <div class="text-info"><b>Accepted</b> &nbsp; <div class="btn-group float-right mt-2">
					<a type="button" href="{{url('/ropc/permission/permissioncountdetails')}}/{{'2'}}" class="btn btn-sm btn-outline-primary">@if(!empty($allrecord)) {{$allrecord[0]->Accepted}} @else {{'0'}} @endif</a>
              ...
              <div class="card income text-center">
               <!--  <div class="icon"><i class="icon-line-chart"></i></div> -->
                <div class="text-warning"><b>Rejected</b> &nbsp; <div class="btn-group float-right mt-2">
					<a type="button" href="{{url('/ropc/permission/permissioncountdetails')}}/{{'3'}}" class="btn btn-sm btn-outline-danger">@if(!empty($allrecord)) {{$allrecord[0]->Rejected}} @else {{'0'}} @endif</a>
