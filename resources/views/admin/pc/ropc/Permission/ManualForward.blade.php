...
<!--                                        @if($data->approved_status == 0)
                                        <td><a class="btn btn-outline-danger btn-block" style=" text-align: left;" href="{{url('/ropc/permission/getpermissiondetails')}}/{{$data->permission_id}}{{'&'}}{{$data->approved_status}}{{'&'}}{{$data->location_id}}">{{$data->permission_id}}<i class="fa fa-edit float-right font-size01"></i></a></td>
                                        ...
                                        <td><a href="{{url('/ropc/permission/manulaforwarddownload')}}/{{$data->permission_id}}">Manual Forward</a></td>
                                        <td>{{$data->name}}</td>
