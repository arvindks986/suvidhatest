...
<main role="main" class="inner cover mb-3">
 ...
 <div class=" card-header">
  <form method="post" action="{{url('/eci/EciCustomReportFilter')}}" id="EciCustomReportFilterGet">
                 {{ csrf_field() }}
      <div class=" row">
            <div class="col-md-4">
               @if(Session::has('ScheduleList'))
             <label for="state">Enter States</label>
                 ...
                 <div class="col-md-4">
				 <label for="ScheduleList">Select Schedule</label>
...
<section>
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      <div class=" card-header">
      <div class=" row">
            <div class="col"><h4> List Of Election Schedule {{$user_data->placename}}
			
			<small><br />@if($phaseid != '') Election Schedule In @if($state != '') {{$state}} @endif Election Phase &nbsp; {{$phaseid}}</small>  @else  @endif</h4></div> 
              <div class="col"><p class="mb-0 text-right"><b>Name:</b> <span class="badge badge-info">{{$user_data->placename}}</span> &nbsp;&nbsp; <b></b> 
              <span class="badge badge-info"></span>&nbsp;&nbsp;  <a href="{{url('/eci/EciCustomReportFilterGetPdf')}}/{{base64_encode($state_code)}}/{{base64_encode($ScheduleList)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
              <a href="{{url('/eci/EciCustomReportFilterGetExcel')}}/{{base64_encode($state_code)}}/{{base64_encode($ScheduleList)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
...
$("#EciCustomReportFilterGet").validate({
    rules: {
