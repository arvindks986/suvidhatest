...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>List Of Finalized PCs In States Phase Wise</title>
    ...
    <body>
      ...
      <style type="text/css">
                ...
                <tr>
                 <td  style="width:50%;">
                    <table  style="width:100%">
                      <tbody>
                         <tr>
                           <td><strong>List Of Finalized PCs In States Phase Wise </strong></td>
                         </tr>
                         <tr>  
        ...
        @endphp
         ...
         @forelse ($EciNominationFinalizedByPhaseIdPdf as $key=>$listdata)
