...
<div class="container-fluid">
  ...
  <br>
       ...
       <tr>
          <th>State</th>
          <?php foreach($active_phases as $phase_result){ ?>
          <th>2019 Voting <br>Phase {!! $phase_result !!} <br>(in %)</th>
          <?php } ?>
          <th>2019 Voting <br>Total(in %)</th>
        </tr>
      ...
      @foreach($results as $result)
        ...
        <?php foreach($active_phases as $phase_result){ ?>
        <td>
          <span>{!! $result['phase'.$phase_result] !!}</span>
        </td> 
        <?php } ?>
        <td>
        ...
        <tfoot>
          ...
          <?php foreach($active_phases as $phase_result){ ?>
          <td>
            <span>{!! $totals['phase'.$phase_result] !!}</span>
          </td> 
          <?php } ?>
