...
<section>
  ...
  <div class="card text-left mt-3" style="width:100%; margin:0 auto;">
      <div class=" card-header">
      <div class=" row">
            <div class="col"><h4> List Of Election Nomination Phase Wise {{$user_data->placename}}</h4>
			 @if($phaseid != '') <small> 
               @if($phaseid != '')  List Of Election Nomination In Phase &nbsp; {{$phaseid}}</small>  @else  @endif  @else  @endif
			</div> 
              <div class="col"><p class="mb-0 text-right"><b>Name:</b> <span class="badge badge-info">{{$user_data->placename}}</span> &nbsp;&nbsp; <b></b> 
              <span class="badge badge-info"></span>&nbsp;&nbsp; <a href="{{url('/eci/EciPhaseInfoDataCandWisePdf')}}/{{base64_encode($phaseid)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
              <a href="{{url('/eci/EciPhaseInfoDataCandWiseExcel')}}/{{base64_encode($phaseid)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
 ...
 <div class="card-body">  
    <table class="table table-striped table-bordered table-hover" style="width:100%">
        ...
        @endphp
         @forelse ($EciPhaseInfoDataCandWise as $key=>$listdata)
