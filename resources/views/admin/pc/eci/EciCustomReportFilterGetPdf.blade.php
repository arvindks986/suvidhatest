    ...
    <body>
      ...
      <style type="text/css">
        ...
        <table style="width:100%; border: 1px solid #000;" border="0" align="center">  
			   ...
			   <tr>
                 <td colspan="2" align="center" style="border-top: 1px solid #000;">@if($state != '') <strong>State:</strong> {{$state}} @else  @endif  @if($phaseid != '')<strong>Phase:</strong> &nbsp; {{$phaseid}}</h4>  @else  @endif</td>
               </tr>
