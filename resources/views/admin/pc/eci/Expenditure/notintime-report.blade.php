...
<main role="main" class="inner cover mb-3">
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
                ...
                <div class=" row">
                 <div class="col"><h2 class="mr-auto">Not in Time </h2></div> 
...
<div class="card-body">  
  <div class="table-responsive">
      <table id="examplenotintime" class="table table-striped table-bordered table-hover" style="width:100%">
        <thead>
        <tr>
		  <th>State</th>
        <th>PC No & Name</th>
...
$(document).ready(function() {
    var table = $('#examplenotintime').DataTable({   
     dom: 'lBfrtip', 
