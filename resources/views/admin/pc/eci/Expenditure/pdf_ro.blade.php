 ...
 <tr>
  ...
  <tr>
   <td @if(!empty($scrutinyReportData->candidate_lodged_acct) &&  $scrutinyReportData->candidate_lodged_acct=="No") style="border: 1px solid #5d5f61; padding: 12px;" @endif>4</td>     
            ...
            @if(!empty($scrutinyReportData->candidate_lodged_acct) && $scrutinyReportData->candidate_lodged_acct=="Yes")
            <tr>     
...
@if(!empty($scrutinyReportData->rp_act) && $scrutinyReportData->rp_act=="No")
            <tr>
