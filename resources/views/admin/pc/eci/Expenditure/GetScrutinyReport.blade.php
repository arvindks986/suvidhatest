                   ...
                   $htmlData .="</tbody>    
                    ...
                    $htmlData .="<br><br><div class='col'><center><h5>Comment By ECI/CEO/DEO/RO </h5></center></div><Br>
                                ...
                                <div class='row mis_gap'>
                                 ...
                                 <tr><td><textarea name='comment_by_eci' id='comments' rows='4' cols='130' value='{$scrutinyReportData[0]->comment_by_eci}'>{$scrutinyReportData[0]->comment_by_eci}</textarea></td></tr> 
