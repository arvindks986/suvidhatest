...
<div class="container-fluid">
  ...
  <div class="col-sm-12"><h4><b>ELECTION EXPENDITURE MONITORING SYSTEM GENERAL PC ELECTION-2019</b></h4></div>
              ...
              <form method="post" action="{{url('/eci-expenditure/mis-officer')}}" id="EcidashboardFilter">           
  ...
  <div class="card text-left mt-3" style="width:100%;">
      ...
      <div class=" row d-flex align-items-center">
            <div class="col"><h4></h4></div> 
			 ...
			 <div class="row" style="width:100%;"><h4> MIS Of A/C Cases Of GENERAL ELECTION To Lok Sabha- 2019</h4></div> 
      </div>
		...
		if($finalbyDEO >=  0 && $pendingatECI >=0 && $finalcompletedcount >=0){
         ...
         @endphp
          <tr>
			...
			<td align="right"> @if(empty($finalbyDEO) || $finalbyDEO <1)     0  @else  <a href="{{url('/')}}/eci-expenditure/EcifinalbyDEO/{{base64_encode($listdata->st_code)}}/{{base64_encode($cons_no)}}" > <b>{{  $finalbyDEO }}</b> @endif </a></td>
			
           <!-- <td align="right" > @if(empty($pendingatRO) || $pendingatRO <1)     0  @else  <a href="{{url('/')}}/eci-expenditure/pendingatro/{{base64_encode($listdata->st_code)}}/{{base64_encode($cons_no)}}" title="toalcandidate-Finalised By DEO"><b>{{  $pendingatRO }}</b> @endif </a></td>
            ...
            <td align="right">@if(empty($pendingatECI) || $pendingatECI<1)     0  @else  <a href="{{url('/')}}/eci-expenditure/pendingateci/{{base64_encode($listdata->st_code)}}/{{base64_encode($cons_no)}}" > <b>{{  $pendingatECI }}</b> @endif</a></td>
         
     	   <td align="right">@if(empty($finalcompletedcount) || $finalcompletedcount<1)     0  @else <a href="{{url('/')}}/eci-expenditure/finalbyeci/{{base64_encode($listdata->st_code)}}/{{base64_encode($cons_no)}}" > <b>{{  $finalcompletedcount }}</b> @endif</a></td>
		   
		   <td align="right"> @if(empty($noticeatCEOCount) || $noticeatCEOCount<1 )     0  @else  <a href="{{url('/')}}/eci-expenditure/noticeatceo/{{base64_encode($listdata->st_code)}}/{{base64_encode($cons_no)}}" > <b>{{  $noticeatCEOCount }}</b> @endif</a></td>
			
			<td align="right">@if(empty($disqualifiedcount) || $disqualifiedcount<1)     0  @else <a href="{{url('/')}}/eci-expenditure/disqualifiedbyeci/{{base64_encode($listdata->st_code)}}/{{base64_encode($cons_no)}}" > <b>{{  $disqualifiedcount }}</b> @endif</a></td>
