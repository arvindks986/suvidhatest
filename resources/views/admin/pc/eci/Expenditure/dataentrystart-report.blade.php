...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col"><h2 class="mr-auto">Data Entry Start</h2></div> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card text-left" style="width:100%;">
                        ...
                        <div class="card-body" id="demo" class="collapse show">  
                            <table id="exampledatastart" class="table table-striped table-bordered table-hover" style="width:100%">
        <thead>
        <tr>
		   <th>State</th>
          <th>PC No & Name</th>
...
$(document).ready(function() {
    var table = $('#exampledatastart').DataTable({   
     dom: 'lBfrtip', 
