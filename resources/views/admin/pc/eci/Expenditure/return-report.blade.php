...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col"><h2 class="mr-auto">Return Data List</h2></div> 
            ...
            <a href="{{url('/eci-expenditure/return')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}?pc={{$pc}}&state={{$st_code}}&exl=yes" class="btn btn-info" role="button">State Wise Excel Report</a>&nbsp;&nbsp;
                        <b></b> <button type="button" id="Cancel" class="btn btn-primary" onclick="window.history.back();">Back</button>

                    </p></div>
            </div> <!-- end row -->
			<p class="mb-0 text-right"><a href="{{url('/eci-expenditure/return')}}/{{base64_encode('0')}}/{{base64_encode('0')}}?pc={{'0'}}&state={{'0'}}&exl=yes" class="btn btn-info" role="button">All India Excel Report</a> </p>
        </div>
