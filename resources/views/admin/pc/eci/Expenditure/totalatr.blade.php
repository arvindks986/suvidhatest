...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col-md-5 mt-2 mb-2"><h5 class="mr-auto">Total ATR: {{$count}}</h5></div> 
...
<?php $j=0;  ?>
    @if(!empty($totalATR))
    @foreach($totalATR as $candDetails)  
      <?php
       //dd($candDetails);
...
<td>@if(!empty($candDetails->final_action)) {{$candDetails->final_action}} @endif</td>
