...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col"><h2 class="mr-auto">Pending At ECI : {{$count}}</h2></div> 
                    ...
                    <div class="card text-left" style="width:100%;">
                        ...
                        <div class="card-body" id="demo" class="collapse show">  
                            <table id="example1" class="table table-striped table-bordered table-hover" style="width:100%">
                                ...
                                <?php $j = 0; ?>
                                @if(!empty($finalbyeciCandList))
                                @foreach($finalbyeciCandList as $candDetails)  
                                <?php
...
<script type="text/javascript">
    ...
    function drawChart() {
        ...
        $.ajax({
            type: "get",
            url: "{{url('/')}}/eci-expenditure/candidateListByfinalizeDatagraph",
            dataType: "json",
