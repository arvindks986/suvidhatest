        ...
        <div class="container-fluid">
            <div class=" row">
                ...
                <div class="col-md-7 mt-2 mb-2 text-right"><p class="mb-0">
                        ...
                        <a href="{{url('/eci-expenditure/EcifinalbyDEOMISPDF2014')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
                        <a href="{{url('/eci-expenditure/EcifinalbyDEOMISEXL2014')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
...
<td>@if(!empty($lodgingDate) && $lodgingDate !='30-11--0001' && $lodgingDate > '05-12-2019') {{ $lodgingDate}} @else {{ 'N/A'}} @endif</td>
