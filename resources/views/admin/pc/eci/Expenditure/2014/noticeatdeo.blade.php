...
@php
  ...
  $last_date_prescribed_acct_lodge = !empty($noticeatDEO[0]->last_date_prescribed_acct_lodge) && strtotime($noticeatDEO[0]->last_date_prescribed_acct_lodge) > 0 ?date('d-m-Y', strtotime($noticeatDEO[0]->last_date_prescribed_acct_lodge)) : "22-06-2019";
@endphp
        ...
        <div class="container-fluid">
            <div class=" row">
                ...
                <div class="col-md-7 mt-2 mb-2 text-right"><p class="mb-0">
                      ...
                      <a href="{{url('/eci-expenditure/noticeatdeoPDF2014')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
                        <a href="{{url('/eci-expenditure/noticeatdeoEXL2014')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
...
<td>@if(!empty($candDetails->finalized_date) && $candDetails->finalized_date !='0000-00-00') {{ date('d-m-Y',strtotime($candDetails->finalized_date))}}  @else {{ 'N/A'}} @endif</td>
<td>@if(!empty($candDetails->date_orginal_acct) && $candDetails->date_orginal_acct !='0000-00-00') {{ date('d-m-Y',strtotime($candDetails->date_orginal_acct))}} @else {{ 'N/A'}} @endif</td>
