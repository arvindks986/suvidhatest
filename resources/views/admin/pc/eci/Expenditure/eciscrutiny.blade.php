                            ...
                            <div class="col-sm-2 mt-2">
                                <p class="mt-4 text-left">
                                    ...
                                    <input type="submit" value="Filter" id="Filter" class="btn btn-primary">
                                     <a href="{{url('/eci-expenditure/eciallscrutiny')}}"><input type="button" value="Clear Filter" id="Filter" class="btn btn-primary"></a>
                                </p>
                            </div>
                        </div>
  ...
  <div class="table-responsive">
      ...
      <table id="example2" class="display" cellspacing="0" width="100%">
          ...
          <thead>
									...
									$datedisqualify = new DateTime($candDetails->date_of_disqualified);
                                    $sts = getstatebystatecode($candDetails->st_code);
                                    //echo $date->format('d.m.Y'); // 31.07.2012
                                    $lodgingDate = $date->format('d-m-Y'); // 31-07-2012
                                    // dd($candDetails);
									
									$date_of_disqualified = $datedisqualify->format('d-m-Y');
                                    $j++;
...
<td>@if(!empty($candDetails->date_of_disqualified) && strtotime($candDetails->date_of_disqualified)>0) {{$date_of_disqualified}} @endif</td>
                                        <td>
