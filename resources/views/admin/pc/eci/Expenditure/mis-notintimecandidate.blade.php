...
$backurl= ($routesegment[0] !='notintime ') ? 'eci-expenditure/mis-candidate' : 'eci-expenditure/EciExpdashboard';
...
<main role="main" class="inner cover mb-3">
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
                ...
                <div class=" row">
                 <div class="col-md-5"><h2 class="mr-auto">Not In Time Candidate List</h2></div> 
                   <div class="col-md-7 text-right"><p class="mb-0">
												<b>State Name:</b> 
												<span class="badge badge-info">{{$stateName}}</span> &nbsp;&nbsp; 
												<b></b><span class="badge badge-info"></span>&nbsp;&nbsp; 
												<b>PC:</b> <span class="badge badge-info">{{ $pcName }}</span>
                        <a href="{{url('/eci-expenditure/EcinotintimeCandidateMISPDF')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
                        <a href="{{url('/eci-expenditure/EcinotintimeCandidateMISEXL')}}/{{base64_encode($st_code)}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
