...
<main role="main" class="inner cover mb-1">     
    <section class="breadcrumb-section">
        <div class="container-fluid">
            <div class=" row">
                <div class="col"><h2 class="mr-auto">Default Account List: {{$count}}</h2></div> 
    ...
    <section class="mt-5">
        ...
        <tr>
          ...
          <th>Party Name</th>
          <th>Date Of Lodging of Scrutiny Report</th>
          <th>Action</th>
        </tr>
        </thead>
<?php $j=0;  ?>
...
<td>  @if(!empty($candDetails->constituency_no))
