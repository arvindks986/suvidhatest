...
<section>
  ...
  <div class="card text-left mt-3" style="width:100%;">
      ...
      <div class=" row d-flex align-items-center">
            <div class="col"><h4>ECI Poll Turn Out PC Wise</h4></div> 

              

              <div class="col"><p class="mb-0 text-right"><b>Name:</b> <span class="badge badge-info">{{$user_data->placename}}</span> &nbsp;&nbsp; <b></b> 
              <span class="badge badge-info"></span>&nbsp;&nbsp;
              <a href="{{url('/eci/EciPollTurnOutPcWiseExcel')}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover" style="width:100%">
        ...
        @endphp
         @forelse ($EciPollTurnOutPcWise as $key=>$listdata)
