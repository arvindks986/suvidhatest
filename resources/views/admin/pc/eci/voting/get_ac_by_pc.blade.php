...
<button type="button" onclick="referesh_page()" class="btn btn-primary pull-right" style="font-size: 30px; padding: 15px 10px;">Refresh Page</button>
  ...
  <div class="row text-center">
                 ...
                 <span class="badge badge-light">{{$female_percentage}}%</span>
                 </span>  
                 
                 <span type="text" class="btn btn-outline-dark outlinDark">Male 
                 <span class="badge badge-light">{{$male_percentage}}%</span>
                 </span>  <span type="text" class="btn btn-outline-dark outlinDark">Others 
                 <span class="badge badge-light">{{$other_percentage}}%</span>
                 </span>  
