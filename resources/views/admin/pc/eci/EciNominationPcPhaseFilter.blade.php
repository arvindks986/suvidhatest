...
<main role="main" class="inner cover mb-3">
 ...
 <div class=" card-header">
      <div class=" row">
            ...
            <div class="col">
              @if($stcode != '') <h4> State @php $statelist = getstatebystatecode($stcode); @endphp {{$statelist->ST_NAME}} &nbsp;&nbsp; @else  @endif 
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4> List Of Nominations</h4></div> 
              ...
              <span class="badge badge-info"></span>&nbsp;&nbsp; <a href="{{url('/eci/EciNominationPcPhaseFilterPdf')}}/{{base64_encode($stcode)}}/{{base64_encode($phase)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
              <a href="{{url('/eci/EciNominationPcPhaseFilterExcel')}}/{{base64_encode($stcode)}}/{{base64_encode($phase)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
 ...
 <div class="card-body">  
    <table class="table table-striped table-bordered table-hover" style="width:100%">
        ...
        <tbody>
         ...
         @forelse ($EciNominationPcPhaseFilter as $key=>$listdata)
