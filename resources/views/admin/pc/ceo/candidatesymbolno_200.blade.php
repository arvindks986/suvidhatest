...
<section>
  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4>Candidate List Symbol Not Alloted</h4></div> 
              <div class="col"><p class="mb-0 text-right"><b>State Name:</b> <span class="badge badge-info">{{$st->ST_NAME}}</span> &nbsp;&nbsp; <b></b> 
              <span class="badge badge-info"></span>&nbsp;&nbsp; 
              <a href="{{url('pcceo/ceo-symbol-no-200-pdf')}}" class="btn btn-info" role="button">Export PDF</a>&nbsp;&nbsp; 
              <a href="{{url('pcceo/ceo-symbol-no-200-excel')}}" class="btn btn-info" role="button">Export Excel</a></p>
              </div>
            </div>
      </div>
 ...
 <div class="card-body">  
    <table   class="table table-striped table-bordered" style="width:100%">
        ...
        <tbody>
        <?php $count = 1; 
       //echo  count($independentCandList);die;
