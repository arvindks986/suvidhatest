...
<div class="sidebar__inner">
             ...
             <div class="card-body getpermission">
                      ...
                      <form class="form-horizontal" method="POST" action="{{url('/pcceo/addauthoritydata')}}">
                          {{csrf_field()}}
                       		
			<div class="form-group row">
                          <label class="col-sm-4 form-control-label">Authority Type <sup>*</sup></label>
                          <div class="col-sm-8">
                           <input type="text" class="form-control" placeholder="Enter Authority Type" name="name" value="{{ old('name') }}">
