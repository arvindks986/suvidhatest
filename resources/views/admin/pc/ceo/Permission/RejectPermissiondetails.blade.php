        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h5 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action Taken By RO</a></h5><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i class="fa fa-angle-down"></i></a>
                        </div>
                        ...
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label">Approved Status</label>
                                    @if($RO->approved_status == 3)
                                    <div class="col-sm-7">
                                        <p class="text-warning">{{'Reject'}}</p>
                                    </div>
                                    @else
                                    <div class="col-sm-7">
                                        <p class="text-warning">{{'pending'}}</p>
