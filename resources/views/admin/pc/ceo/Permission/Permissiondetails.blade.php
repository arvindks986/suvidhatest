                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        ...
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            ...
                            <div class="card-footer">
                                <form class="form-horizontal" id="formid{{$i}}" method="post" action="{{url('/pcceo/uploadnodaldoc')}}" enctype="multipart/form-data">
                                    {{csrf_field()}}
...
<!--                                    <div class="file-upload col-sm-8">
                ...
                <div class="col-lg-12 p-0">
                    ...
                    <div class="form-group row text-center">
                        <div class="col">
                            <button type="submit" class="btn btn-primary btn-lg"><a href="{{url('/pcceo/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}" style="color: white">Print</a></button>
                        </div>
                    </div>
                </div>
                @endif
