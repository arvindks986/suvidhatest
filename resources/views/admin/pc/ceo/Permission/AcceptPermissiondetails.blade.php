...
@endif
    ...
    @if(!empty($getRodetails))
                ...
                <div class="col-lg-12 pr-0">
                    ...
                    <div id="new-updates" class="card updates recent-updated">
                        <div id="updates-header" class="card-header d-flex justify-content-between align-items-center">
                            <h2 class="h5 display"><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class="">Action Taken By CEO</a></h2><a data-toggle="collapse" data-parent="#new-updates" href="#updates-box" aria-expanded="true" aria-controls="updates-box" class=""><i class="fa fa-angle-down"></i></a>
                        </div>
                        <div id="updates-box" role="tabpanel" class="collapse show" style="">
                            @if($RO->cancel_status ==0)
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label">CEO Comment</label>
                                    <div class="col-sm-7">
                                        @if(!empty($RO->comment))
                                        <p>{{$RO->comment}}</p>
                                        @else
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-5 form-control-label">Document Uploded by CEO</label>
                ...
                <div class="col-lg-12 pl-0 pr-0">
                    ...
                    <div class="card mb-3">        
                        <div class="card-header d-flex align-items-center">
                            <h5 class="mr-auto">Action Taken By CEO</h5> 
                        </div>	
                        <form class="form-horizontal" method="POST" action="{{url('/pcceo/updateaction')}}" enctype="multipart/form-data">
                            {{csrf_field()}}
...
<!--                                            <div class="file-select-name" id="noFile">No file chosen...</div> -->
                                            <input type="file" class="default-file-input form-control mr-auto" id="customFile" name="rofile"  accept=".pdf" style="height: 45px !important;"/>
...
<!--                                            <button class="btn btn-success float-right text-white" value="Accept" name="accept" id="accept">Accept</button>
                ...
                <div class="col-lg-12 p-0">
                    ...
                    <div class="form-group row text-center">
                        <div class="col">
                            <button type="submit" class="btn btn-primary"><a href="{{url('/pcceo/generate-pdf')}}/{{$result->permission_id}}{{'&'}}{{$result->location_id}}" style="color: white">Print</a></button>
                        </div>
                    </div>
                </div>
                @endif
