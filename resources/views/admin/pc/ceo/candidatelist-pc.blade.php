  ...
  <div class="card text-left" style="width:100%; margin:0 auto;">
      ...
      <div class=" row">
            <div class="col"><h4>Candidate List PC Wise</h4></div> 
              ...
              <a href="{{url('pcceo/nominated-candidatelist-excel/'.$pc_no.'/')}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
        ...
        // print_r( $candidatedetails);
         ?>
          <tr>
            ...
            <td ><a href="{{url('/pcceo/ViewNominationDetails/'.$candListbyPCData->nom_id.'/')}}">{{ $candidatedetails->cand_name}}</a></td>
