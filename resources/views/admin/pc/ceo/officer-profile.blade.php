...
<section>	 
	 <form enctype="multipart/form-data" id="election_form" method="POST"  action="{{url('pcceo/updateuser') }}" >
	  {{ csrf_field() }}
  <div class="container">
  <div class="row">
  <div class="card text-left" style="width:100%; margin:0 auto;">
                ...
                <div class="col">
                	<p class="mb-0 text-right"><b>State Name:</b> <span class="badge badge-info">{{$st->ST_NAME}}</span></p>
                </div>
                </div> <!--End row-->
                </div><!--End card-header-->
								@if ($errors->any())
