...
<?php  
    $totrej=\app(App\adminmodel\CandidateNomination::class)->where(['st_code' =>$user_data->st_code])->where(['application_status' =>'4'])->get()->count();
    $totalwith= \app(App\adminmodel\CandidateNomination::class)->where(['st_code' =>$user_data->st_code])->where(['application_status' =>'5'])->get()->count() ;
    
    $totaccepted=\app(App\adminmodel\CandidateNomination::class)->where(['st_code' =>$user_data->st_code])->where(['application_status' =>'6'])->where('party_id', '!=' ,'1180')->get()->count();
...
<section class="statistics color-grey pt-0 pb-5" style="border-bottom:1px solid #eee;">
        <div class="container-fluid">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="close" data-dismiss="NotiModal">&times;</button>
      </div>
...
var msgfile = APP_URL+'/firebase/firebase-messaging-sw.js';
 var stcode = "<?php echo $user_data->st_code; ?>";
  ...
  // Initialize Firebase
   ...
   const messaging = firebase.messaging();
           messaging.onMessage(function(payload) {
               ...
               //alert('Notification Successfully Subscribed');

           });

   navigator.serviceWorker.register(msgfile)
           .then((registration) => {
                                   ...
                                   if (currentToken) {
                                     ...
                                     $.ajax({
                                      headers: {
                                          ...
                                          url: APP_URL +'/notificationCurl/',
                                          type: 'POST',
                                        //  data: 'stcode='+stcode+'&currentToken='+currentToken,
                                          //data: '{"stcode":"' + stcode+'"}',
                                          data: {stcode: stcode, currentToken: currentToken},
                                          success: function () {
