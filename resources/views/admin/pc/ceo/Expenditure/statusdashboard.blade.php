    ...
    <div class="card-header pt-3" id="expenditure_section">
        <div class="container-fluid">
            <div class="row text-center pt-2 pb-1">
              ...
              <form method="post" action="{{url('/pcceo/statusExpdashboard')}}" id="ceodashboardFilter">           
...
<section class="statistics color-grey pt-2 pb-5">
          ...
          <div class="row d-flex mb-2">
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/pcceo/pendingdataentry/{{base64_encode($cons_no)}}" target="">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			      	<a href="{{url('/')}}/pcceo/filedData/{{base64_encode($cons_no)}}" target="">
			    	<div class="feature">
            ...
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			         <a href="{{url('/')}}/pcceo/defaulter/{{base64_encode($cons_no)}}" target="">
           ...
           <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			      	<a href="{{url('/')}}/pcceo/partiallypending/{{base64_encode($cons_no)}}" target="">
    ...
    <!-- End of EEMS box Row 1 -->
     ...
     <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <!-- Income-->
              <div class="card cardNew income reportBox text-center mt-5">
				<a href="{{url('/')}}/pcceo/finalbyceo/{{base64_encode($cons_no)}}" target="">
				<div class="feature">
 ...
 <!-- RO Not Agreee start--
            <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			        	<a href="{{url('/')}}/pcceo/finalbyeci/{{base64_encode($cons_no)}}" target="">
          ...
          <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			        	<a href="{{url('/')}}/pcceo/noticeatceo/{{base64_encode($cons_no)}}" target="">
			        	<div class="feature"><img src="{{ asset('admintheme/img/icon/expUnder-s.png') }}" alt="" /></div>
            ...
            <!----Data entry defects end--->
              <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			        	<a href="{{url('/')}}/pcceo/return/{{base64_encode($cons_no)}}" target="">
			        	<div class="feature"><img src="{{ asset('admintheme/img/icon/expUnder-s.png') }}" alt="" /></div>
    ...
    <!-- End of EEMS box Row 2 -->
	 ...
	 <!--- Data non return -->
          <div class="col-lg-3 col-md-4 col-sm-3 mt-5">
              <div class="card cardNew income reportBox text-center mt-5">
			        	<a href="{{url('/')}}/pcceo/non-return/{{base64_encode($cons_no)}}" target="">
			        	<div class="feature"><img src="{{ asset('admintheme/img/icon/expUnder-s.png') }}" alt="" /></div>
