                ...
                <div class=" row">
                 <div class="col-md-5"><h2 class="mr-auto">Started Data List</h2></div> 
                   <div class="col-md-7"><p class="mb-0 text-right">
                        ...
                        <a href="{{url('/pcceo/expstartedcandidatePDF')}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
                        <a href="{{url('/pcceo/expstartedcandidateEXL')}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
