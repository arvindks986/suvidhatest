                ...
                <div class=" row">
                 <div class="col-md-5"><h2 class="mr-auto">Not In Time Candidate List</h2></div> 
                   <div class="col-md-7 text-right"><p class="mb-0">
					...
					<a href="{{url('/pcceo/expnotintimeCandidateMISPDF')}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
					<a href="{{url('/pcceo/expnotintimeCandidateMISEXL')}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
...
<td> @if($candDetails->final_by_ro=='1')
                <a href="{{url('/')}}/pcceo/printScrutinyReport/{{base64_encode($candDetails->candidate_id)}}" class="btn btn-primary btn-sm width-75" target="_blank"> Srcutiny Report</a> 
