        ...
        <div class="container-fluid">
            <div class=" row">
                ...
                <div class="col-md-7 mt-2 mb-2 text-right"><p class="mb-0">
                        ...
                        <a href="{{url('/pcceo/exppendingatroPDF')}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">PDF Download</a> &nbsp;&nbsp;
                        <a href="{{url('/pcceo/exppendingatroEXL')}}/{{base64_encode($cons_no)}}" class="btn btn-info" role="button">Export Excel</a> &nbsp;&nbsp;
