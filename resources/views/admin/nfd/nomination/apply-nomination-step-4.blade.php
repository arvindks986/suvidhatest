  ...
  <div class="row">
   <div class="col-md-12 mt-3">
     <ul style="text-align:center;margin-bottom:40px;" class="arrow-steps clearfix">
       ...
       <li class="step step2 current">Part III<span></span></li>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
             ...
             @endforeach
                              ...
                              <li>(e) that to the best of my knowledge and belief, I am qualified and not also disqualified for being chosen to fill the seat in the House of the People.</li>
             ...
             @endforeach
                            ...
                            <div class="nomination-signature">
                              <p class="nomination-date left" style="background-color:transparent;">Date <input type="text" name="part3_date" id="part3_date" class="form-control nomination-field-2" value="{{$part3_date}}" readonly="readonly"></p>
                            </div>
<hr class="mt-5" />
          ...
          <div class="form-group row ">
            ...
            <div class="col ">
              ...
              <button type="submit" class="btn btn-primary save_next">Next</button>
            </div>
            </div>
            </div>
         </div>
