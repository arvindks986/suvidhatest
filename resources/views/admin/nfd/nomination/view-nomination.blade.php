...
<main role="main" class="inner cover mb-3">
  ...
  <section>
   ...
   <div class="col-md-12">
    <div class="card">
      <div class="card-header d-flex align-items-center"><h4>{!! $heading_title !!}</h4></div>
    <div class="card-body">
 ...
 <div class="nomination-parts box recognized fullwidth">
                              ...
                              <div class="fullwidth">
                                ...
                                <div class="nomination-detail">
                                  <p>I nominate as a candidate for election to the Legislative Assembly from the 
                                    <strong><u>{{strtoupper(getacbyacno($st_code,$legislative_assembly)->AC_NAME)}}</u></strong> Assembly Constituency.</p>
                                    ...
                                    of the electoral roll for <strong><u>{{strtoupper(getacbyacno($st_code,$proposer_assembly)->AC_NAME)}}  </u></strong> Assembly constituency. 
                                  </div>
                                ...
                                <div class="nomination-parts box not-recognized fullwidth">
                                  ...
                                  <div class="nomination-form-heading">
                                   ...
                                   <div class="nomination-detail">
                                   <p>We hereby nominate as candidate for election to the Legislative Assembly from the <strong><u>{{strtoupper(getacbyacno($st_code,$legislative_assembly)->AC_NAME)}}</u></strong>Assembly Constituency</p>
    ...
    <p>We declare that we are electors of this Assembly constituency and our names are entered in the electoral roll for this Assembly constituency as indicated below and we append our signatures below in token of subscribing to this nomination: - 
    </p>  
