        ...
        <div class="card card-shadow">
          ...
          <div class="col-md-12 float-right">
            <ul class="list-inline float-right">
                ...
                <li class="list-inline-item text-right"><a
                        href="{!! $href_download_application !!}" class="btn btn-primary"
                        target="_blank">{{ __('election_details.down') }}</a></li>
                <li class="list-inline-item text-right"><a style="background: #D04A8A;"
                        href="{{url()->previous()}}" class="btn btn-primary">Back</a></li>
            </ul>
        </div>
          @endif
        </div>
        ...
        <td>
            <table style="width: 100%; margin: 1.5rem 0;">
                <tbody>
                    <tr>
                        <td>
                            <?php if(!empty($affidavit) && $affidavit!='NA') { ?>
                            <fieldset class="fullwidth">
                                <div id="affidavit-preview" class="affidavit-preview">
                                    <embed src="<?php echo $affidavit; ?>" width='100%'
                                        height='500px' />
                                </div>
                            </fieldset>
                            <?php } ?>
...
<div class="form-group">
    <div class="col">
        <a href="{{url()->previous()}}"
            class="btn btn-secondary float-left font-big">Back</a>
    </div>
  <br>
  <br>
