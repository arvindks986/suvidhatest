   ...
   <div class="row">
     <div class="col pr-0 pl-0">
                 <ul class="steps mb-0" id="progressbar">
                  ...
                  <li class="step active">Part III<span></span></li>
                            ...
                            <div class="nomination-options strikeout">
                              ...
                              <div class="checkbox recognised" style="">
                               (c) (i) that I am set up at this election by the 
                                  <select name="party_id" class="form-control nomination-field-3" style="width:300px;">
             ...
             @endforeach
                                ...
                                <div class="checkbox not-recognized">
                                  (c) (ii) that I am set up at this election by the 
                                   <select name="party_id" class="form-control nomination-field-2">
                                    <option value="">-- Select Party --</option>
                                    @foreach($parties as $iterate_party)
									@if($party_id == $iterate_party['party_id'])
									<option value="{{ $iterate_party['party_id'] }}" selected="selected">{{ $iterate_party['name'] }}</option>
                            ...
                            <li>
                              *I further declare that I am a member of the <select name="category" class="form-control nomination-field-2">
                                  ...
                                  @foreach($categories as $iterate_category)
                                   ...
                                   @endif
                                   @endforeach
                                </select>**Caste/tribe which is a scheduled **caste/tribe of the State of
                                <select name="part3_cast_state" class="form-control nomination-field-3" id="part3_cast_state">
