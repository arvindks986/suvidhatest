   ...
   <div class="row">
     <div class="col pr-0 pl-0">
                 <ul class="steps mb-0" id="progressbar">
                  ...
                  <li class="step active">Part I/II</li>
          ...
          <div class="card-body">
              ...
              <div class="checkbox">
                <label style="display:inline;">
                  ...
                  <input type="radio" class="parts-opt recognized_party" name="recognized_party" value="recognized" checked="checked">
                  @else
                  <input type="radio" class="parts-opt recognized_party" name="recognized_party" value="recognized">
                  @endif
                      Candidate set up by recognised political party</label>
              </div>
              <div class="checkbox">
                 <label style="display:inline;">
                  @if($recognized_party == 'not-recognized')
                  <input type="radio" class="parts-opt recognized_party" name="recognized_party" value="not-recognized" checked="checked">
                  @else
                  <input type="radio" class="parts-opt recognized_party" name="recognized_party" value="not-recognized">
                  @endif
              ...
              <div class="form-group float-right">
                ...
                <div class="nomination-detail">
                  I nominate as a candidate for election to the Legislative Assembly from the 
                    ...
                    Candidate's name 
                                  <input type="text" name="name" id="name" class="form-control nomination-field-2" placeholder="Candidate Name" value="{{$name}}"> 
                    Father's/mother's/husband's name 
                                  <input type="text" name="father_name" id="father_name" placeholder="Father's/Mother's/Husband name" value="{!! $father_name !!}" class="form-control nomination-field-3">

                    His postal address 
                                <input type="text" name="address" id="address" placeholder="Address" value="{!! $address !!}" class="form-control nomination-field-12"> 

                    His name is entered at Sl.No <input type="text" name="serial_no" id="serial_no" class="form-control nomination-field-1" placeholder="S.No." value="{{$serial_no}}">

                    in part no <input type="text" name="part_no" id="part_no" placeholder="Part No" class="form-control nomination-field-1" value="{{$part_no}}">

                    of the electoral roll for 
                    <select name="resident_ac_no" id="resident_ac_no" class="form-control nomination-field-1">
            ...
            <div class="card">
              <div class="card-body">
                <div class="nomination-parts box  fullwidth">
                  ...
                  <input type="hidden" name="nomination_id" value="{{$nomination_id}}">
                  <div class="fullwidth">
                    <div class="text-right fullwidth">
                  ...
                  <div class="nomination-detail-02">
                    <div class="form-inline nomination-detail">
                        ...
                        <p>We hereby nominate as candidate for election to the Legislative Assembly from the
                        <select name="legislative_assembly" id="legislative_assembly" class="form-control nomination-field-2 ac_no" readonly="readonly">
                      ...
                      <tbody>
                        ...
                        foreach($non_recognized_proposers as $iterate_proposer){ ?>
                          <tr class="non_recognized_proposers_row">
                           ...
                           <!--  <td> --><input type="hidden" class="form-control particulars-field-12 recognized_date" name="non_recognized_proposers[{{$key}}][date]" value="{{$iterate_proposer['date']}}" readonly="readonly"><!-- </td> -->
                          </tr>
                          <?php $key++; } ?>
                        </tbody>
                      </table>
