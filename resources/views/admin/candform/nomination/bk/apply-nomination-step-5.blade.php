   ...
   <div class="col-md-12 mt-3">
     <ul style="text-align:center;margin-bottom:40px;" class="arrow-steps clearfix">
      ...
      <li class="step step2 ">Election Details</li>
       ...
       <li class="step step5 current first">Part IIIA<span></span></li>
						...
						<div class="askQue mt-2 mb-3">
							<div class="row">
								...
								<div class="col pl-5"><label class="case marked">Yes
													  ...
													  <input type="radio" class="have_police_case form-control" name="have_police_case" value="yes" checked="checked">
													  @else
													  <input type="radio" class="have_police_case form-control" name="have_police_case" value="yes" >
													  @endif
													  <span class="checkmark"></span>
													</label></div>
								<div class="col pl-5"> <label class="case marked">No
													  @if($have_police_case=='no')
													  <input type="radio" class="have_police_case form-control" name="have_police_case" value="no" checked="checked">
													  @else
													  <input type="radio" class="have_police_case form-control" name="have_police_case" value="no">
													  @endif
													  <span class="checkmark"></span>
													</label></div>
								 ...
								 <legend><h5>Case <?php echo $case_heading; ?></h5></legend>
                                    ...
                                    <ol type="i">
                                      ...
                                      <li>(ii) Police station(s)<input type="text" name="police_case[{{$i}}][police_station]" class="form-control nomination-field-2" value="{{$iterate_police_case['police_station']}}"><br>
                                        State(s) 
                                        <select name="police_case[{{$i}}][state]" class="form-control nomination-field-2" onchange="load_district(this.value, <?php echo $i ?>)">
                                          <option value="">-- Select States --</option>
                                          @foreach($states as $iterate_state)
                                          @if($iterate_state['st_code'] == $iterate_police_case['state'])
                                        ...
                                        District(s) 
                                        <select name="police_case[{{$i}}][district]" class=" form-control nomination-field-2 district_<?php echo $i ?>">
                                          <option value="">-- Select Ditricts --</option>
                                          @foreach($districts as $iterate_district)
                                          @if($iterate_district['st_code'] == $iterate_police_case['state'])

                                          @if($iterate_district['st_code'] == $iterate_police_case['state'] && $iterate_district['district_no'] == $iterate_police_case['district'])
...
<script>
  $(document).ready(function(){  
   ...
   $('.add_police_case').click(function(e){
    ...
    html += "State(s) ";
    html += "<select name='police_case["+i+"][state]' class='form-control' onchange='load_district(this.value, "+i+")'>";
    ...
    html += "</select>";
    html += "District(s) ";
    html += "<select name='police_case["+i+"][district]' class='form-control district_"+i+"'>";
