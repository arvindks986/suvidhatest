...
<div class="row">
  <div class="col">
    <ul id="breadcrumb" class="pt-2 mr-auto">
      <!-- <li><a href="{{url('/officer-login')}}"><span class="icon icon-home"> </span></a></li> -->
   ...
   <ul class="float-right">
        <li>
        LoginId:- {{$user_data->officername}} </li>
      </ul>
    <input type="hidden" value="{{ (isset($_SERVER["SERVER_ADDR"])) ? $_SERVER["SERVER_ADDR"] : '' }}" readonly>
      </ul>
	  <input type="hidden" value="{{isset($_SERVER['SERVER_ADDR']) ? $_SERVER['SERVER_ADDR'] : ''}}" readonly>
</div>
  </div>
