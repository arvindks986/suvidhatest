...
<header class="header">
 ...
 ?>
        <ul class="float-right">
          ...
          <li class="active"><a href="{{url('/roac/dashboard')}}">Counting Dashboard</a></li>
          ...
          <ul class="dropdown">
           ...
           <?php /*<li><a href="javascript:void(0)" >Permission<span class="arrow-down"></span></a>
              <ul class="dropdown">
