								 ...
								 <legend><h5>Case <?php echo $case_heading; ?></h5></legend>
                                    ...
                                    <ol type="i">
                                      ...
                                      <li>(viii)Was/were any appeal(s)/revision(s) filed against above conviction(s)  
                                        <select  id="revision_against_conviction<?php echo $i ?>" name="police_case[{{$i}}][revision_against_conviction]" class="form-control nomination-field-2 against_conviction">
                                          @foreach($yes_no_lists as $iterate_lis)

                                          @if($iterate_police_case['revision_against_conviction']==$iterate_lis['id'])
...
<script>
  $(document).ready(function(){  
   ...
   $('.add_police_case').click(function(e){
    ...
    html += "<select id='revision_against_conviction"+i+"' name='police_case["+i+"][revision_against_conviction]' class='form-control nomination-field-2 against_conviction'>";
