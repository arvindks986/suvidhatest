...
<div class="container-fluid">
   <div class="col-md-12 mt-3">
     <ul style="text-align:center;margin-bottom:40px;" class="arrow-steps clearfix">
      <li class="step step1 current first">Personal Details</li>
  ...
  <div class="container p-0">
    ...
    <div class="line"></div>
            ...
            <div class="form-group row">
               ...
               <div class="col">
                 <label>in Hindi<sup>*</sup></label>
                 <input type="text" name="father_hname" class="form-control" value="{{$father_hname}}"> 
               ...
               <div class="col">
                <label>in Vernacular </label>
                <input type="text" name="father_vname" class="form-control" value="{{$father_vname}}"> 
     ...
     <div class="form-group row">
       ...
       <div class="col">
        <label>in Hindi<sup>*</sup></label>
         <input type="text" name="haddress" class="form-control" value="{{$haddress}}" placeholder="Address Line 1(Hindi)"> 
        ...
        success: function(json) {   
          if(json['success'] == false){
            ...
            if(json['basic'].name_v1 != '' && json['basic'].name_v1 != null){ 
              $("input[name=hname]").val(json['basic'].name_v1);
            }
            ...
            if(json['basic'].rln_name_v1 != '' && json['basic'].rln_name_v1 != null){
              $("input[name=father_hname]").val(json['basic'].rln_name_v1);
            }
            ...
            if(json['address'].Address_V1 != '' && json['address'].Address_V1 != null){
              $("input[name=haddress]").val(json['address'].Address_V1);
            }
