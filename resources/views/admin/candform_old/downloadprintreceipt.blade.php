...
<html lang="en">
            ...
            <table style="width:100%;" border="0" align="center" cellpadding="5">
               <thead>
                ...
                <tr>
                 ...
                 <tr>
                   <th  style="width: 100%; text-align: center;font-weight: bold;font-size:12px;" colspan="2"> State: <b>{!! $st_name !!}</b> Parliament constituency: {{$pc_no}}-{{$pc_name}}</td>
    ...
    <table class="table-strip" style="width: 100%;" border="0" align="center" cellpadding="10">
      <tr>
        <th  style="width: 100%; text-align:justify;font-size:12px; line-height:30px;">
                ...
                Serial No. of nomination paper <b><u>{{$caddata->nomination_papersrno}} </u></b> The nomination paper of <strong><u>{{strtoupper($caddata->cand_name)}} </u></strong>   a candidate for election from the 
                 
                @if(!empty($ac)) <strong> <strong><u>{{strtoupper($ac->AC_NAME) }}</u> </strong>  </strong> Assembly constituency @endif
 ...
 <table style="width: 100%; margin-bottom: 5px; margin-top:30px;">
     <tr>   <td>Date:- {{$caddata->fdate}}</td> 
            <td align="right">Returning Officer <br><br> {{$pc_no}}-{{$pc_name}}</td>
    </tr>
</table>
