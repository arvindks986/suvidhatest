...
<div class="container-fluid">
  ...
  <br>
      ...
      @foreach($results as $result)
       ...
       @php 
        ...
        @endphp
          ...
          <td><a href="<?php echo $result['href'] ?>"><span>{!! $result['label'] !!}</span></a></td> 
          <td><a href="<?php echo $result['href'] ?>">{{$result['total_const']  }}</a></td>
          <td><a href="<?php echo $result['href'] ?>">{{$result['const_finalised'] }}</a></td>
          </tr>
      ...
      @endforeach
       ...
       <tr style="background: #f0587e;color: #fff;"><td><b>Total</b></td><td><b>{{ $TotalConst }}</b></td><td><b>{{ $TotalFinaliseConst }}</b></td></tr>
