    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-3  pull-right text-right">
                <span class="report-btn" id="export-csv-btn"><a class="btn btn-primary" href="{{url('ropc/schedule-report-excel')}}/{{$urlexcel}}" title="Download Excel" target="_blank">Export Excel</a></span>
                <span class="report-btn" id="export-pdf-btn"><a class="btn btn-primary" href="{{url('ropc/schedule-report-pdf')}}/{{$urlpdf}}" title="Download PDF" target="_blank">Export PDF</a></span>
            </div>
...
<section class="dashboard-header section-padding">
    <div class="container-fluid">
        <form  action="{{url('ropc/schedule-report')}}" class="row" method="POST" >
		{{csrf_field()}}
		<input type="hidden" name="state_code" id="state_code" value="<?php echo $state; ?>">
		<input type="hidden" name="ac_no" id="ac_no" value="<?php echo $ac_no; ?>">
            <div class="form-group col-md-3">
                <label>Select AC <span style="color:red">*</span></label>
                <select name="ac_no" id="ac_no" class="form-control" required  onchange="getACList(this.value);">
