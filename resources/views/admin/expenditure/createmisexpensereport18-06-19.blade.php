                ...
                <div class="card text-left" style="width:100%;">
                    ...
                    <div class=" card-header">
                        <div class=" row d-flex align-items-center">
                            ...
                            <div class="col"><h4> District Electoral Officer (RO/DEO)</h4></div>
                            @endif

                            @if($user_data->role_id=='4')
                            <div class="col"><h4> Central Electoral Officer (CEO)</h4></div>
                            @endif
                        ...
                        <form method="post" action="{{url($namePrefix.'/StoreMisExpenseReport')}}" id="StoreMisExpenseReport">
                            ...
                            <div class=" row">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date" class="form-control" name="date_of_declaration" value="2019-05-23" placeholder="Date &amp; time"  readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <select name="return_status" id="return_status" class="form-control" required="required" <?php if($namePrefix=="/eci" || $namePrefix=="/pcceo"){ echo "readonly disabled";}?>>
                                        <option value="">Select Type</option>
                                        <option value="Returned" <?php
                                        if (!empty($ReportSingleData['return_status']) && $ReportSingleData['return_status'] == "Returned") {
                                            echo "selected";
                                        }
                                        ?> >Returned</option>
                                        <option value="Non-Returned" <?php
                                        if (!empty($ReportSingleData['return_status']) && $ReportSingleData['return_status'] == "Non-Returned") {
                                            echo "selected";
                                        }
                                        ?> >Non-Returned</option>
                                    </select>
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    <label for="ScheduleList">Nature of Default in A/C</label>
                                    <select name="nature_of_default_ac" id="nature_of_default_ac" class="form-control" <?php if($namePrefix=="/eci" || $namePrefix=="/pcceo"){ echo "readonly disabled";}?>>
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    <a href="#" data-toggle="tooltip" title="Date of sending DEO'S Scrutiny Report to the ECI through the CEO within 45 days of declaration of results" style="color: #212529;"><label for="ScheduleList">Date of Sending DEO'S Scrutiny Report to ECI through the CEO</label></a>
                                    <input type="date"  min="2019-05-23" name="date_of_sending_deo" id="date_of_sending_deo" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_sending_deo'])?$ReportSingleData['date_of_sending_deo']:''}}" required="required">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_sending_ceo" id="date_of_sending_ceo" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_sending_ceo']) ? $ReportSingleData['date_of_sending_ceo']:''}}">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_receipt" id="date_of_receipt" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_receipt'])?$ReportSingleData['date_of_receipt']:''}}" readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_receipt" id="date_of_receipt" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_receipt'])?$ReportSingleData['date_of_receipt']:''}}">
                                    @if ($errors->has('date_of_receipt'))
                                    <span class="help-block">
                                        <strong class="user">{{ $errors->first('date_of_receipt') }}</strong>
                                    </span>
...
<div class="col-sm-6" id="form_new_mis">
                                    <label for="ScheduleList">Whether acknowledge from the candidate is attached with supplementary report</label></a>
											<select name="acknowldge_from_the_candidate_eci" id="acknowldge_from_the_candidate_eci" class="form-control" required="required">
                                        <option value="">Select Type</option>
                                  ...
                                  <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"   min="2019-05-23" name="date_of_sending_additional_info_eci" id="date_of_sending_additional_info_eci" class="form-control" placeholder="Date &amp; time"  value="{{!empty($ReportSingleData['date_of_sending_additional_info_eci'])?$ReportSingleData['date_of_sending_additional_info_eci']:''}}" required="required">
								...
								<div class="col-sm-6" id="form_new_mis">
                                    <label for="ScheduleList">Date of Reciept of DEO's scrutiny report from the CEO/DEO</label></a>
                                    <input type="date"  min="2019-05-23" name="date_of_receipt_eci" id="date_of_receipt_eci" class="form-control" placeholder="Date &amp; time"  value="{{!empty($ReportSingleData['date_of_receipt_eci'])?$ReportSingleData['date_of_receipt_eci']:''}}">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" min="2019-7-07" name="date_of_issuance_notice" id="date_of_issuance_notice"  class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_issuance_notice'])?$ReportSingleData['date_of_issuance_notice']:''}}" readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_sending_additional_info" id="date_of_sending_additional_info"  class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_sending_additional_info'])?$ReportSingleData['date_of_sending_additional_info']:''}}" readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_sending_ack_eci" id="date_of_sending_ack_eci" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_sending_ack_eci'])?$ReportSingleData['date_of_sending_ack_eci']:''}}" readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_receipt_represetation" id="date_of_receipt_represetation" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_receipt_represetation'])?$ReportSingleData['date_of_receipt_represetation']:''}}" readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    <a href="#" data-toggle="tooltip" title="Date of Sending Supplementary Report on ECI Notice if any ,together of acknowledge from the RO/DEO" style="color: #212529;"><label for="ScheduleList">Date of Sending Supplementary Report on ECI Notice if any ,together of acknowledge from the RO/DEO</label></a>
                                    <input type="date"  min="2019-05-23" name="date_sending_supplimentary" id="date_sending_supplimentary" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_sending_supplimentary'])?$ReportSingleData['date_sending_supplimentary']:''}}" readonly="readonly">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_sending_supplimentary_eci" id="date_sending_supplimentary_eci" class="form-control" placeholder="Date &amp; time"  value="{{!empty($ReportSingleData['date_sending_supplimentary_eci'])?$ReportSingleData['date_sending_supplimentary_eci']:''}}">
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_receipt_notice_service" id="date_of_receipt_notice_service" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_receipt_notice_service'])?$ReportSingleData['date_of_receipt_notice_service']:''}}">
                                    @if ($errors->has('date_of_receipt_notice_service'))
                                    <span class="help-block">
                                        <strong class="user">{{ $errors->first('date_of_receipt_notice_service') }}</strong>
                                    </span>
                                    @endif         
                                </div>
                                @endif       
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <input type="date"  min="2019-05-23" name="date_of_issuance_notice" id="date_of_issuance_notice" class="form-control" placeholder="Date &amp; time" value="{{!empty($ReportSingleData['date_of_issuance_notice'])?$ReportSingleData['date_of_issuance_notice']:''}}">
                                    @if ($errors->has('date_of_issuance_notice'))
                                    <span class="help-block">
                                        <strong class="user">{{ $errors->first('date_of_issuance_notice') }}</strong>
                                    </span>
                                ...
                                <div class="col-sm-6" id="form_new_mis">
                                    ...
                                    <select name="final_action" id="final_action" class="form-control" required="required">
 ...
 <textarea class="form-control" rows="4" name="comment_by_eci" id="sending_additional_info_sought"  <?php if($ReportSingleData['final_by_eci']=="1"){ echo  "readonly"; } ?>>{{$ReportSingleData['comment_by_eci']}}</textarea> 
                                </div>
                                @endif
                                ...
                                <div class="col-md-12 soughtCom" id="form_new_mis" >
                                    <label for="ScheduleList">Comment</label>  
  <textarea class="form-control" rows="4" name="comment_by_ceo" id="sending_additional_info_sought"  <?php if($ReportSingleData['final_by_ceo']=="1"){ echo  "readonly"; } ?>>{{$ReportSingleData['comment_by_ceo']}}</textarea> 
                                </div>
                                @endif
		...
		<!--RETURN LIST DROPDOWN STARTS-->
                                ...
                                <div class="col-md-12 soughtCom" id="form_new_mis" >
                                    <label for="ScheduleList">Comment</label>  
<textarea class="form-control" rows="4" name="comment_by_ro" id="sending_additional_info_sought" <?php if($ReportSingleData['final_by_ro']=="1"){ echo  "readonly"; } ?>>{{$ReportSingleData['comment_by_ro']}}</textarea> 
                                </div>
                                @endif
                                ...
                                if ($namePrefix == "/ropc") {
                                    if ($ReportSingleData['final_by_ro'] != "1" && !empty($ReportSingleData['date_of_sending_deo'])) {
                                        ...
                                        <div class="col-md-6 soughtCom" >
                                            <label for="">Upload Signed Candidate Scrutiny Report<span class="redClr font-weight-bold h6">*</span></label>  
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        ...
                                        <a href="#" class="final_action_btn signedfile" id="{{!empty($candidate_data['candidate_id'])?$candidate_data['candidate_id']:'0'}}" >Do you want to finalize?</a>
...
//********************ECI FILTER FORM VALIDATION ENDS********************//
                                ...
                                $('select[name="state"]').on('change', function () {
                                    ...
                                    if (stateID) {
                                        $.ajax({
                                            url: "{{url('/')}}/eci/ajax-district/" + encodeURI(stateID),
                                            type: "GET",
                                            dataType: "json",
...
// end election type
    ...
    $('select[name="ac_pc"]').on('change', function () {
        ...
        if (stateID && districtId && electionType) {
            $.ajax({
                url: "{{url('/')}}/eci/getcontestingCandiate",
                type: "get",
                data: {"stateID": stateID,
                    "districtId": districtId,
                    "ac_pc": ac_pc},
        ...
        // if (answer) {
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    {
					  if(namePrefix == "/eci"){
							window.location.href="{{url('/eci/eciallscrutiny')}}";
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    @if($user_data->role_id=='4')
                    <div class="col"><center><h4> Central Electoral Officer (CEO)</h4></center></div>
                    @endif
