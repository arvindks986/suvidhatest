<html>
  ...
  <div class="bordertestreport">
    ...
    <table class="border">
      <tr>
        <td style="text-align: left;">
          <p style="font-size: 15px;"><b>Booth App - State Wise Poll Turnout Report</b></p>
        </td>
      </tr>
      <tr>
  ...
  <table align="center" class="table table-bordered  poll-table">
					<thead class="sticky">
				<tr class="turnoutbg">
					<td colspan="5" style="">Poll day Turn out Details</td>
					<td colspan="6" style="" align="right"><span id="poll_turnout_percentage">{{$data['poll_turnout_percentage']}}</span>%</td>
				</tr>
