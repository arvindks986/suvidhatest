    ...
    <div class="child-area">
      ...
      <div class="page-contant card">
        <div class="random-area card-body">
          ...
          <div class="col-sm-12">
            <button class="btn btn-success pull-right mb-3" type="button" id="add_new_so">Select Poling Station for Exemption</button>
          </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered list-table-remove" id="my-list-table"> 
              ...
              <tbody> 
                ...
                <tr class="">
                  <td>{{$result['ps_no']}}</td>
                  <td class="level1"><p>{{$result['ps_name']}}</p>
                  </td>
                  <td>{{$result['reason']}}</td>
                </tr>
                <?php $i++ ?>
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" method="post" action="{!! $action !!}">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Polling Stations</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>

        </div>
        <div class="modal-body">

          <div class="form-group mb-1 fullwidth">
            <label class="col-md-3  pull-left">Polling Station</label>
            <div class="pull-left col-md-9" id="ps_no_div">
              <div class="row">
                <select class="sumoselect form-control ps_no" name="ps_no" id="ps_no">
          ...
          <div class="form-group mb-1 fullwidth">
            <label class="col-md-3  pull-left">Reason</label>
            <div class="pull-left col-md-9" id="reason_div">
              <div class="row">
