         ...
         <div class="table-responsive">
          <table class="table table-bordered " id="my-list-table">
           <thead>
            <tr> 
              <th>State/UT Name</th>
              <!--<th>Total PS Location</th> -->
              <th>Total PS</th>
             <!-- <th>BLO Assigned</th>  
              <th>BLO <br>Not Activated</th>    -->          
              <th>PO Assigned</th>
              <th>PO <br>Not Activated</th>
              <!--<th>PRO Assigned</th>
              <th>PRO <br>Not Activated</th>
              <th>SM Assigned</th>
              <th>SM <br>Not Activated</th> -->
              <th>Total<br> Officers</th>
              <th>Total<br> Not Activated</th>
              <th>Non Activated(%)</th>
            </tr>
          </thead>
          <tbody>
           ...
           <!-- <td>
            ...
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['blo_not_activated'] !!}</span></a>
            </td>  -->
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_po'] !!}</span></a>
            </td> 
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['po_not_activated'] !!}</span></a>
            </td> 
           <!-- <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_pro'] !!}</span></a>
            </td> 
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['pro_not_activated'] !!}</span></a>
            </td> 
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_sm'] !!}</span></a>
            </td>
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['sm_not_activated'] !!}</span></a>
            </td> -->
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_activated'] !!} </span></a>
            </td>
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_not_activated'] !!} </span></a>
            </td>
            
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['percentage'] !!}% </span></a>
            </td>
