        ...
        <tbody>
         ...
         @forelse ($results as $key=>$listdata)
          ...
          <tr>
            ...
            <button type="button" class="btn btn-primary PsWiseDetailspopup" data-toggle="modal" data-target="#myModal" data-psname="{{$listdata['ps_name']}}" data-emale="{{$listdata['male_electors']}}" data-efemale="{{$listdata['female_electors']}}" data-eother="{{$listdata['other_electors']}}"  data-vmale="{{$listdata['male_turnout']}}" data-vfemale="{{$listdata['female_turnout']}}" data-vother="{{$listdata['other_turnout']}}" data-psno="{{$listdata['ps_no']}}">Edit</button>
           
            
            </td>
			
			<td>{{$listdata['last_sync']}}</td>
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
      ...
      <div class="modal-body">
       <form class="form-horizontal" method="POST" action="{{url('roac/booth-app-revamp/update_turnout_pswise')}}" id="RoPsWiseDetailsUpdate">
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-8">
           <input type="text" id="PS_NAME_EN" class="form-control" name="PS_NAME_EN" value="" readonly>
         ...
         <div class="form-group row">
          ...
          <div class="col-sm-8">
           <input type="text" id="electors_male"  maxsize="6" minsize="1" class="form-control" name="electors_male" 
		   value="" readonly>
           <span class="text-danger"></span>
          </div>
        </div>
          ...
          <div class="col-sm-8">
          <input type="text" id="electors_female"  maxsize="6" minsize="1" class="form-control" name="electors_female" 
		  value="" readonly>
          <span class="text-danger"></span>
          </div>
        </div>
    ...
    <div class="form-group row">
          ...
          <div class="col-sm-8">
           <input type="text" id="electors_other"  maxsize="6" minsize="1" class="form-control" name="electors_other" 
		   value="" readonly>
           <span class="text-danger"></span>
          </div>
        </div>  
...
$(document).on("click", ".PsWiseDetailspopup", function () {
   ...
   document.getElementById("electors_male").readOnly = true;
   document.getElementById("electors_female").readOnly = true;
   document.getElementById("electors_other").readOnly = true;
   document.getElementById("PS_NAME_EN").readOnly = true;
