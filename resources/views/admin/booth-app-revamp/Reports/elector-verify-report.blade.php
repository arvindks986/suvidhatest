...
@section('bradcome', 'Booth App - Mapped Location Report')
@section('content')
<style type="text/css">
  .loader {
   position: fixed;
       ...
       <div class="random-area">
         ...
         <div class="table-responsive">
          ...
          <tbody>
            ...
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_verify'] !!} </span></a>
            </td>
            <td>
              <a href="<?php echo $result['href'] ?>"><span>{!! $result['total_unverify'] !!}</span></a>
            </td>  
            </tr>
			@php
			$i++;
