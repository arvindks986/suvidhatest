<html>
  ...
  <table align="center" class="table table-bordered  poll-table">
				...
				<tr class="turnoutbg">
					...
					<td colspan="6" style="" align="right"><span id="poll_turnout_percentage">{{$poll_turnout_percentage}}</span>%</td>
				</tr>
					...
					<tr>
						...
						<td>{{$result['other']}}</td>
						<td>{{$result['total']}}</td>
						<!--<td align="center">{{$result['total_in_queue']}}</td>-->
