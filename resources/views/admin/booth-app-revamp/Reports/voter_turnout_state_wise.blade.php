  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-9 pull-left">
       <h4>Booth App - State Wise Poll Turnout Report</h4>
     </div>
         ...
         <div class="table-responsive">
			<table align="center" class="table table-bordered  poll-table" id="list-table" data-page-length='50'>
				...
				<tr class="turnoutbg">
					...
					<td colspan="6" style="border-color: #49a8a4;" align="right"><span id="poll_turnout_percentage">{{$data['poll_turnout_percentage']}}</span>%</td>
				</tr>
					...
					@foreach($data['voter_turnouts'] as $iterate_turnout)
					<tr>
