       ...
       <div class="random-area">
        ...
        $count = 1;
            ...
            <tr>
			  ...
			  <td>@if($result['is_cleraed'] >0)<span style="color:green;">Yes</span>@else <span style="color:red;">No</span> @endif</td>
			  <td>@if($result['is_cleraed'] > 0 && $result['cleraed_date'] <>''){{date('d-m-Y h:i A', strtotime($result['cleraed_date']))}}@endif</td>
