				...
				<div class="random-area">
					...
					<div class="table-responsive">
						<table align="center" class="table table-bordered  poll-table" data-page-length='50' id="list-table">
							<thead class="sticky">
								<tr class="turnoutbg">
									<td colspan="4" style="border-color: #49a8a4;">{!! $heading_title !!}</td>
									<td colspan="4" style="border-color: #49a8a4;" align="right"><span id="poll_turnout_percentage">{{$poll_turnout_percentage}}</span>%</td>
								</tr>
