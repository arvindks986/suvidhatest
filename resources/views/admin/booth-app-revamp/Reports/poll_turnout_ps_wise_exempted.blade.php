			...
			<div class="page-contant">
				<div class="random-area">
					...
					<div class="table-responsive">
						<table align="center" class="table table-bordered  poll-table" id="my-list-table" data-page-length='50'>
							<thead class="sticky">
								<tr class="turnoutbg">
								...
								<tr>
									...
									<th rowspan="2" style="background:#6ccac6;">Last Updated Time</th>
							...
							<tbody id="voter_turnouts">
								...
								<tr>
									<td width="40%"><a href="<?php echo $result['href'] ?>"><span>{{$result['ps_name_and_no']}}</span></a></td>
						...
						<td align="center"><a href="<?php echo $result['href'] ?>"><span>{{$result['last_sync']}}</span></a></td>
