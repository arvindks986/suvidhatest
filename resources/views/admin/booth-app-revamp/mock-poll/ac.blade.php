        ...
        <div class="table-responsive">
          ...
          <tbody>   
            ...
            <tr>
              ...
              <td><a href="{{$result['href']}}">{{$result['poll_start']}}</a></td>
              <td><a href="{{$result['href']}}">{{$result['poll_result_shown']}}</a></td>
              <td><a href="{{$result['href']}}">{{$result['button_clear']}}</a></td>
              <td><a href="{{$result['href']}}">{{$result['slip_remove']}}</a></td>
            </tr>
            @endforeach
