  ...
  <section class="main-box">
   ...
   <div class="col-md-6 login-page "> 
    <figure class="evm-logo">
      <span style="margin: auto;"><img style="max-width: 300px;" src="{{ asset('theme/img/logo/eci-logo.png') }}"> <p>Election Commission of India</p> 
      </span>
    </figure> 
  </div>
      ...
      <span class="help-block"><strong>{{ Session::get('opterror') }} </strong></span>
       ...
       <!--OTP FIELD STARTS-->
        ...
        <div class="form-inline">
          ...
          &nbsp;&nbsp;&nbsp;<a href="{{url('/login')}}" class="btn btn-primary mt-3">Back </a>
        </div>
