...
<div class="container">
  ...
  <table class="table" border="1" cellpadding="0" cellspacing="0" width="100%" align="center" style="font-size:14px; ">
    ...
    @endforeach
 <!--    <tr><td colspan="5"> (ii) Candidates of registered political parties (other than recognized national and state political parties)</td></tr>
    ...
    @endforeach
    <tr><td colspan="5"> (iii) Other candidates. </td></tr>
