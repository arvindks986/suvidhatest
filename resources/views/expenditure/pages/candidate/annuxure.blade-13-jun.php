                          ...
                          <thead class="text-center">
                            ...
                            <tbody>
                             ...
                             @if(!empty($getSch2))
	                            @foreach($getSch2 as $getExpSch2)
	                            	<tr>
		                                ...
		                                <td><input type="text" class="form-control " name="@php echo $getExpSch2->id @endphp['starcampaigner'][meetingdate]" placeholder="" value="@php echo $getExpSch2->meetingdate @endphp"></td>
	                         ...
	                         @else
	                         	<tr>
	                                <td>1</td>
	                                <td><input type="date" class="form-control " name="1['starcampaigner'][meetingdate]" placeholder="" id=""></td>
	                                <td><input type="text" class="form-control" name="1['starcampaigner'][venue]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control" name="1['starcampaigner'][name_of_start_and_party]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="1['starcampaigner'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="1['starcampaigner'][src_amt_by_pp]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="1['starcampaigner'][src_amt_by_other]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control"  name="1['starcampaigner'][remarks]" placeholder="" maxlength="100"></td>
	                            </tr>
	                            <tr>
	                                <td>2</td>
	                                <td><input type="date" class="form-control " name="2['starcampaigner'][meetingdate]" placeholder="" id=""></td>
	                                <td><input type="text" class="form-control" name="2['starcampaigner'][venue]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control" name="2['starcampaigner'][name_of_start_and_party]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="2['starcampaigner'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="2['starcampaigner'][src_amt_by_pp]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="2['starcampaigner'][src_amt_by_other]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control" name="2['starcampaigner'][remarks]" placeholder="" maxlength="100"></td>
	                            </tr>
	                            <tr>
	                                <td>3</td>
	                                <td><input type="date" class="form-control " name="3['starcampaigner'][meetingdate]" placeholder="" id=""></td>
	                                <td><input type="text" class="form-control" name="3['starcampaigner'][venue]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control" name="3['starcampaigner'][name_of_start_and_party]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="3['starcampaigner'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="3['starcampaigner'][src_amt_by_pp]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="3['starcampaigner'][src_amt_by_other]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control" name="3['starcampaigner'][remarks]" placeholder=""  maxlength="100"></td>
	                            </tr>
	                            <tr>
	                                <td>4</td>
	                                <td><input type="date" class="form-control " name="4['starcampaigner'][meetingdate]" placeholder="" id=""></td>
	                                <td><input type="text" class="form-control" name="4['starcampaigner'][venue]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control" name="4['starcampaigner'][name_of_start_and_party]" placeholder="" maxlength="100"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="4['starcampaigner'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="4['starcampaigner'][src_amt_by_pp]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control ackSch1input" pattern="^[0–9]$" name="4['starcampaigner'][src_amt_by_other]" placeholder="" maxlength="7"></td>
	                                <td><input type="text" class="form-control" name="4['starcampaigner'][remarks]" placeholder="" maxlength="100"></td>
	                            </tr>
                            @endif
                            <tfoot>
                                <tr>
					   ...
					   <h6 class="fs-title text-center pb-2"><strong>Details of Elections Funds and Expenditure of Candidate</strong></h6>
                        <table class="table table-bordered" id="aknolwdgeForm-sch3">
                          <thead class="text-center">
                            ...
                            <tr>
                                <td>1</td>
                                <td><input type="text" class="form-control" name="1['campaigmaterial'][nature_of_expense]" placeholder="" maxlength="100"></td>
                                ...
                                <td><input type="text" class="form-control" name="1['campaigmaterial'][remarks]" placeholder=""  maxlength="100"></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><input type="text" class="form-control" name="2['campaigmaterial'][nature_of_expense]" placeholder=""  maxlength="100"></td>
                                ...
                                <td><input type="text" class="form-control" name="2['campaigmaterial'][remarks]" placeholder=""  maxlength="100"></td>
                            </tr>
                             <tr>
                                <td>3</td>
                                <td><input type="text" class="form-control" name="3['campaigmaterial'][nature_of_expense]" placeholder="" maxlength="100"></td>
                                ...
                                <td><input type="text" class="form-control" name="3['campaigmaterial'][remarks]" placeholder=""  maxlength="100"></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td><input type="text" class="form-control" name="4['campaigmaterial'][nature_of_expense]" placeholder="" maxlength="100"></td>
                                ...
                                <td><input type="text" class="form-control" name="4['campaigmaterial'][remarks]" placeholder=""  maxlength="100"></td>
                            </tr>
                            @endif
                            <tr>
                          ...
                          <thead class="text-center">
                           ...
                           @if(!empty($getSch4))
		                    ...
		                    <tr>
                                ...
                                <td><input type="text" class="form-control" name="1['expdetails'][name_of_media]"placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="1['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input" name="1['expdetails'][price_of_the_media]"placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control priceofmedia" name="1['expdetails'][name_address_of_agency]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="1['expdetails'][commission_of_agency]" maxlength="7"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="2['expdetails'][name_of_media]"placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="2['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input" name="2['expdetails'][price_of_the_media]"placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control  priceofmedia" name="2['expdetails'][name_address_of_agency]"   placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" maxlength="7" name="2['expdetails'][commission_of_agency]"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="3['expdetails'][name_of_media]"placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="3['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="3['expdetails'][price_of_the_media]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control  priceofmedia" name="3['expdetails'][name_address_of_agency]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="3['expdetails'][commission_of_agency]" maxlength="7"></td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="4['expdetails'][name_of_media]"placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="4['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input" name="4['expdetails'][price_of_the_media]"placeholder=""  maxlength="7"></td>
                                <td><input type="text" class="form-control  priceofmedia" name="4['expdetails'][name_address_of_agency]" placeholder=""  maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="4['expdetails'][commission_of_agency]" maxlength="7"></td>
                          ...
                          <thead class="text-center">
                            ...
                            <tr>
                                ...
                                <select class="form-control" name="1['expdetails'][nature_of_media]">
                                 ...
                                 <td><input type="text" class="form-control" name="1['expdetails'][name_of_media]" placeholder="" maxlength="100"></td>
                                 <td><input type="text" class="form-control" name="1['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input priceofmedia" name="1['expdetails'][price_of_the_media]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control" name="1['expdetails'][name_address_of_agency]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="1['expdetails'][commission_of_agency]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input subtotal4a" name="1['expdetails'][total_amt]" placeholder=""  readonly="readonly"></td>
                                <td><input type="text" class="form-control ackSch1input" name="1['expdetails'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" name="1['expdetails'][src_amt_by_pp]" placeholder=""  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" name="1['expdetails'][src_amt_by_other]" placeholder="" maxlength="7"></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td>
                                ...
                                <td><input type="text" class="form-control" name="2['expdetails'][name_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="2['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input priceofmedia" name="2['expdetails'][price_of_the_media]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control" name="2['expdetails'][name_address_of_agency]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="2['expdetails'][commission_of_agency]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input subtotal4a" name="2['expdetails'][total_amt]" placeholder="" readonly="readonly"></td>
                                <td><input type="text" class="form-control  ackSch1input" name="2['expdetails'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" name="2['expdetails'][src_amt_by_pp]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" name="2['expdetails'][src_amt_by_other]" placeholder=""  maxlength="7"></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td>
                                ...
                                <td><input type="text" class="form-control" name="3['expdetails'][name_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="3['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input priceofmedia" name="3['expdetails'][price_of_the_media]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control" name="3['expdetails'][name_address_of_agency]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="3['expdetails'][commission_of_agency]" maxlength="7"></td>
                                <td><input type="text" class="form-control subtotal4a" name="3['expdetails'][total_amt]" placeholder="" readonly="readonly"></td>
                                <td><input type="text" class="form-control ackSch1input" name="3['expdetails'][src_amt_by_cand]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" name="3['expdetails'][src_amt_by_pp]" placeholder="" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" name="3['expdetails'][src_amt_by_other]" placeholder="" maxlength="7"></td>
                            </tr>
                            <tr>
                                <td>1</td>
                                <td>
                                ...
                                <td><input type="text" class="form-control" name="4['expdetails'][name_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="4['expdetails'][address_of_media]" placeholder="" maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input priceofmedia" name="4['expdetails'][price_of_the_media]" maxlength="7" placeholder=""></td>
                                <td><input type="text" class="form-control" name="4['expdetails'][name_address_of_agency]" placeholder=""  maxlength="100"></td>
                                <td><input type="text" class="form-control ackSch1input commissionofmedia" name="4['expdetails'][commission_of_agency]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input subtotal4a" name="4['expdetails'][total_amt]" placeholder="" readonly="readonly"></td>
                                <td><input type="text" class="form-control ackSch1input" name="4['expdetails'][src_amt_by_cand]" maxlength="7" placeholder=""></td>
                                <td><input type="text" class="form-control ackSch1input" name="4['expdetails'][src_amt_by_pp]" maxlength="7" placeholder=""></td>
                                <td><input type="text" class="form-control ackSch1input" name="4['expdetails'][src_amt_by_other]" maxlength="7" placeholder=""></td>
                            </tr>
                            @endif
                             <tr>
				 ...
				 <h6 class="fs-title text-center pb-2"><strong>Details of Elections Funds and Expenditure of Candidate</strong></h6>
                        <table class="table table-bordered">
                          <thead class="text-center">
                            ...
                            <tr>
                                <td>1</td>
                                <td><input type="text" class="form-control" placeholder="" name="1['expdetails'][regn_no_of_vehicle]" maxlength="20"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][hir_rate_for_vehicle]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][hir_fuel_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][hir_driver_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][no_of_days]"  maxlength="7"></td>
                            ...
                            <tr>
                                <td>2</td>
                                <td><input type="text" class="form-control" placeholder="" name="2['expdetails'][regn_no_of_vehicle]" maxlength="20"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][hir_rate_for_vehicle]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][hir_fuel_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][hir_driver_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][no_of_days]" maxlength="7"></td>
                            ...
                            <tr>
                                <td>3</td>
                                <td><input type="text" class="form-control" placeholder="" name="3['expdetails'][regn_no_of_vehicle]" maxlength="20"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][hir_rate_for_vehicle]" maxlength="7"></td>
                                <td><input type="text" class="form-control  ackSch1input" placeholder="" name="3['expdetails'][hir_fuel_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][hir_driver_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][no_of_days]" maxlength="7"></td>
                            ...
                            <tr>
                                <td>4</td>
                                <td><input type="text" class="form-control" placeholder="" name="4['expdetails'][regn_no_of_vehicle]" maxlength="20"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][hir_rate_for_vehicle]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][hir_fuel_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][hir_driver_charges]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][no_of_days]" maxlength="7"></td>
				 ...
				 <h6 class="fs-title text-center pb-2"><strong>Details of Elections Funds and Expenditure of Candidate</strong></h6>
                        <table class="table table-bordered">
                          <thead class="text-center">
                            ...
                            <tr>
                                <td>1</td>
                                <td><input type="date" class="form-control" placeholder="" name="1['expdetails'][venu_date]" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="1['expdetails'][venu_details]"  maxlength="100"></td>
                                <td>Candidate's booths (Kiosks) set up for distribution of voter's slips
                                	<input type="hidden" name="1['expdetails'][expense_nature]" value="Candidate booths (Kiosks) set up for distribution of voters slips">
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][expense_nature_rate]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][worker_agents_count]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][total_amnt]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][source_amnt_by_cand]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][source_amnt_by_polparty]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][source_amnt_by_others]" maxlength="7"></td>
                            </tr>
                            <tr>
                                <td>2</td>
                               <td><input type="date" class="form-control" placeholder="" name="2['expdetails'][venu_date]" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="2['expdetails'][venu_details]" maxlength="100"></td>
                                ...
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][expense_nature_rate]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][worker_agents_count]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][total_amnt]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][source_amnt_by_cand]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][source_amnt_by_polparty]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][source_amnt_by_others]" maxlength="7"></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td><input type="date" class="form-control" placeholder="" name="3['expdetails'][venu_date]" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="3['expdetails'][venu_details]" maxlength="100"></td>
                                <td>Boarding
                                	<input type="hidden" name="3['expdetails'][expense_nature]" value="Boarding">
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][expense_nature_rate]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][worker_agents_count]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][total_amnt]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][source_amnt_by_cand]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][source_amnt_by_polparty]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][source_amnt_by_others]" maxlength="7"></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td><input type="date" class="form-control" placeholder="" name="4['expdetails'][venu_date]" maxlength="100"></td>
                                <td><input type="text" class="form-control" name="4['expdetails'][venu_details]" maxlength="100"></td>
                                <td>Lodging
                                	<input type="hidden" name="4['expdetails'][expense_nature]" value="Lodging">
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][expense_nature_rate]" maxlength="7"></td>
                                <td><input type="text" class="form-control  ackSch1input" placeholder="" name="4['expdetails'][worker_agents_count]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][total_amnt]" maxlength="7"></td>
                                <td><input type="text" class="form-control  ackSch1input" placeholder="" name="4['expdetails'][source_amnt_by_cand]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][source_amnt_by_polparty]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][source_amnt_by_others]" maxlength="7"></td>
                            </tr>
                             <tr>
                                <td>5</td>
                                <td><input type="date" class="form-control" placeholder="" name="5['expdetails'][venu_date]" ></td>
                                <td><input type="text" class="form-control" name="5['expdetails'][venu_details]" maxlength="100"></td>
                                <td>Others
                                	<input type="hidden" name="5['expdetails'][expense_nature]" value="Others"/>
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="5['expdetails'][expense_nature_rate]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="5['expdetails'][worker_agents_count]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="5['expdetails'][total_amnt]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="5['expdetails'][source_amnt_by_cand]"  maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="5['expdetails'][source_amnt_by_polparty]" maxlength="7"></td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="5['expdetails'][source_amnt_by_others]" maxlength="7"></td>
                            </tr>
                            @endif
                            <tr>
				  ...
				  <h6 class="fs-title text-center pb-2"><strong>Details of Elections Funds and Expenditure of Candidate</strong></h6>
                        <table class="table table-bordered" id="aknolwdgeForm-sch8">
                          <thead class="text-center">
                            ...
                            <tr>
                                <td>1</td>
                                <td><input type="date" class="form-control" placeholder="" name="1['expdetails'][submit_date]"></td>
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype1" style="margin-top: 20px; display: none;">
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="date" name="1['expdetails'][cheque_date]" class="form-control" placeholder=""></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="1['expdetails'][cheque_bank]" class="form-control" placeholder="" maxlength="50"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="1['expdetails'][cheque_ifsc]" class="form-control" placeholder="" maxlength="10"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="1['expdetails'][cheque_number]" class="form-control" placeholder="" maxlength="16"></div>
                                	</div>
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="1['expdetails'][amount]" maxlength="7"></td>
                                <td><input type="text" class="form-control" placeholder="" name="1['expdetails'][remarks]" maxlength="100"></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><input type="date" class="form-control" placeholder="" name="2['expdetails'][submit_date]"></td>
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype2" style="margin-top: 20px; display: none;">
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="date" name="2['expdetails'][cheque_date]" class="form-control" placeholder="" ></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="2['expdetails'][cheque_bank]" class="form-control" placeholder="" maxlength="50"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="2['expdetails'][cheque_ifsc]" class="form-control" placeholder="" maxlength="10"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="2['expdetails'][cheque_number]" class="form-control" placeholder="" maxlength="16"></div>
                                	</div>
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="2['expdetails'][amount]" maxlength="7"></td>
                                <td><input type="text" class="form-control" placeholder="" name="2['expdetails'][remarks]" maxlength="100"></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td><input type="date" class="form-control" placeholder="" name="3['expdetails'][submit_date]"></td>
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype3" style="margin-top: 20px; display: none;">
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="date" name="3['expdetails'][cheque_date]" class="form-control" placeholder=""></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="3['expdetails'][cheque_bank]" class="form-control" placeholder="" maxlength="50"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="3['expdetails'][cheque_ifsc]" class="form-control" placeholder="" maxlength="10"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="3['expdetails'][cheque_number]" class="form-control" placeholder="" maxlength="16"></div>
                                	</div>
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="3['expdetails'][amount]" maxlength="7"></td>
                                <td><input type="text" class="form-control" placeholder="" name="3['expdetails'][remarks]" maxlength="100"></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                <td><input type="date" class="form-control" placeholder="" name="4['expdetails'][submit_date]"></td>
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype4" style="margin-top: 20px; display: none;">
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="date" name="4['expdetails'][cheque_date]" class="form-control" placeholder=""></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="4['expdetails'][cheque_bank]" class="form-control" placeholder="" maxlength="50"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="4['expdetails'][cheque_ifsc]" class="form-control" placeholder="" maxlength="10"></div>
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="4['expdetails'][cheque_number]" class="form-control" placeholder="" maxlength="16"></div>
                                	</div>
                                </td>
                                <td><input type="text" class="form-control ackSch1input" placeholder="" name="4['expdetails'][amount]" maxlength="7"></td>
                                <td><input type="text" class="form-control" placeholder="" name="4['expdetails'][remarks]" maxlength="100"></td>
                            </tr>
                            @endif
                            <tr>
                                <td colspan="2">Total</td>
                        ...
                        <table class="table table-bordered" id="aknolwdgeForm-sch9">
                          <thead class="text-center">
                            ...
                            <tr>
                                ...
                                <td><input type="date" class="form-control" placeholder="" name="1['expdetails'][submit_date]" value="@php echo !empty($getExp8->submit_date)? $getExp8->submit_date:""; @endphp"></td>
                                ...
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype1" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="50" name="1['expdetails'][cheque_bank]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="10" name="1['expdetails'][cheque_ifsc]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="1['expdetails'][cheque_number]" class="form-control" placeholder=""></div>
                                	</div>
                                </td>
                                <td><input type="text" class="ackSch1input form-control" placeholder="" name="1['expdetails'][amount]"></td>
                            ...
                            <tr>
                                ...
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype2" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="50" name="2['expdetails'][cheque_bank]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="10" name="2['expdetails'][cheque_ifsc]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="2['expdetails'][cheque_number]" class="form-control" placeholder=""></div>
                                	</div>
                                </td>
                                <td><input type="text" class="ackSch1input form-control" maxlength="7" placeholder="" name="2['expdetails'][amount]"></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="2['expdetails'][remarks]"></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                ...
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype3" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="50" name="3['expdetails'][cheque_bank]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="10" name="3['expdetails'][cheque_ifsc]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="3['expdetails'][cheque_number]" class="form-control" placeholder=""></div>
                                	</div>
                                </td>
                                <td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="3['expdetails'][amount]"></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="3['expdetails'][remarks]"></td>
                            </tr>
                            <tr>
                                <td>4</td>
                                ...
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype4" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="60" name="4['expdetails'][cheque_bank]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="10" name="4['expdetails'][cheque_ifsc]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="4['expdetails'][cheque_number]" class="form-control" placeholder=""></div>
                                	</div>
                                </td>
                                <td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="4['expdetails'][amount]"></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="4['expdetails'][remarks]"></td>
                            </tr>
                            @endif
                            <tr>
                                <td>&nbsp;</td>
                        ...
                        <table class="table table-bordered" id="aknolwdgeForm-sch10">
                          <thead class="text-center">
                            ...
                            <tr>
                                ...
                                <td><input type="text" maxlength="60" class="form-control" placeholder="" name="1['expdetails'][name]"></td>

                                <td><input type="text"  maxlength="100" class="form-control" placeholder="" name="1['expdetails'][address]"></td>
                                ...
                                <td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="1['expdetails'][amount]" ></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="1['expdetails'][remarks]"></td>
                            </tr>
                             <tr>
                                <td>2</td>

                                <td><input type="text" maxlength="50" class="form-control" placeholder="" name="2['expdetails'][name]" ></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="2['expdetails'][address]"></td>
                                ...
                                <td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="2['expdetails'][amount]" ></td>
                             ...
                             <tr>
                                ...
                                <td><input type="text" maxlength="50" class="form-control" placeholder="" name="3['expdetails'][name]"></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="3['expdetails'][address]"></td>
                             ...
                             <tr>
                                ...
                                <td><input type="text" maxlength="50" class="form-control" placeholder="" name="4['expdetails'][name]"></td>

                                <td><input type="text" maxlength="100" class="form-control" placeholder="" name="4['expdetails'][address]"></td>
                                ...
                                <td>
                                	...
                                	<div class="col-md-12 paymenttype4" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="50" name="4['expdetails'][cheque_bank]" class="form-control" placeholder=""></div>
				 ...
				 <h6 class="fs-title text-center pb-2"><strong>Details of Elections Funds and Expenditure of Candidate</strong></h6>
						<table class="table table-bordered" id="aknolwdgeForm-sch11">											 
						  ...
						  <tbody>
                            		...
                            		<tr>
										...
										<td>
											...
											<div class="col-md-12 paymenttype@php echo $getExp10->id @endphp"                @if($getExp10->payment_type == "cash") style="margin-top: 20px; display: none;" @elseif($getExp10->payment_type == "dd") style="margin-top: 20px; display: block;" @elseif($getExp10->payment_type == "cheque") style="margin-top: 20px; display: block;" @endif>
												...
												<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="@php echo $getExp10->id @endphp['expdetails'][cheque_ifsc]" class="form-control" placeholder="" value="@php echo !empty($getExp10->cheque_ifsc)? $getExp10->cheque_ifsc:""; @endphp"></div>

												<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" name="@php echo $getExp10->id @endphp['expdetails'][cheque_number]" class="form-control" placeholder="" value="@php echo $getExp10->cheque_number; @endphp"></div>
											</div>
										</td>													
									</tr>
                            	@endforeach
							...
							<tr>
								<td>1</td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="1['expdetails'][newspaper_name]"></td>
								<td><input type="date" class="form-control" placeholder="" name="1['expdetails'][news_publishing_date]"></td>
								<td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="1['expdetails'][expense_on_news]"></td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="1['expdetails'][channel_name]"></td>
								<td><input type="datetime-local" class="form-control" placeholder="" name="1['expdetails'][telecost_dateTime]"></td>
								<td><input type="text" class="ackSch1input form-control" maxlength="7" placeholder="" name="1['expdetails'][expense_on_channel]"></td>
								<td>
									<select name="1['expdetails'][payment_type]" class="form-control paymenttype" id="paymenttype1">
                                		<option>--Select Payment Type--</option>
                                		<option value="cash">Cash</option>
                                	...
                                	<div class="col-md-12 paymenttype1" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="1['expdetails'][cheque_no]" class="form-control" placeholder=""></div>
                                	</div>
								</td>													
							</tr>
							<tr>
								<td>2</td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="2['expdetails'][newspaper_name]"></td>
								<td><input type="date" class="form-control" placeholder="" name="2['expdetails'][news_publishing_date]"></td>
								<td><input type="text" class="ackSch1input form-control" maxlength="7" placeholder="" name="2['expdetails'][expense_on_news]"></td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="2['expdetails'][channel_name]"></td>
								<td><input type="datetime-local" class="form-control" placeholder="" name="2['expdetails'][telecost_dateTime]"></td>
								<td><input type="text" class="ackSch1input form-control" maxlength="7" placeholder="" name="2['expdetails'][expense_on_channel]"></td>
								<td>
									<select name="2['expdetails'][payment_type]" class="form-control paymenttype" id="paymenttype2">
                                		<option>--Select Payment Type--</option>
                                		<option value="cash">Cash</option>
                                	...
                                	<div class="col-md-12 paymenttype2" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="2['expdetails'][cheque_no]" class="form-control" placeholder=""></div>
                                	</div>
								</td>							
							</tr>
							<tr>
								<td>3</td>
								<td><input type="text" maxlength="60" class="form-control" placeholder="" name="3['expdetails'][newspaper_name]"></td>
								<td><input type="date" class="form-control" placeholder="" name="3['expdetails'][news_publishing_date]"></td>
								<td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="3['expdetails'][expense_on_news]"></td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="3['expdetails'][channel_name]"></td>
								<td><input type="datetime-local" class="form-control" placeholder="" name="3['expdetails'][telecost_dateTime]"></td>
								<td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="3['expdetails'][expense_on_channel]"></td>
								<td>
									<select name="3['expdetails'][payment_type]" class="form-control paymenttype" id="paymenttype3">
                                		<option>--Select Payment Type--</option>
                                		<option value="cash">Cash</option>
                                	...
                                	<div class="col-md-12 paymenttype3" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="3['expdetails'][cheque_no]" class="form-control" placeholder=""></div>
                                	</div>
								</td>								
							</tr>
							<tr>
								<td>4</td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="4['expdetails'][newspaper_name]"></td>
								<td><input type="date" class="form-control" placeholder="" name="4['expdetails'][news_publishing_date]"></td>
								<td><input type="text" class="ackSch1input form-control" maxlength="7" placeholder="" name="4['expdetails'][expense_on_news]"></td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="4['expdetails'][channel_name]"></td>
								<td><input type="datetime-local"  class="form-control" placeholder="" name="4['expdetails'][telecost_dateTime]"></td>
								<td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="4['expdetails'][expense_on_channel]"></td>
								<td>
									<select name="4['expdetails'][payment_type]" class="form-control paymenttype" id="paymenttype4">
                                		<option>--Select Payment Type--</option>
                                		<option value="cash">Cash</option>
                                	...
                                	<div class="col-md-12 paymenttype4" style="margin-top: 20px; display: none;">
                                		...
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="4['expdetails'][cheque_no]" class="form-control" placeholder=""></div>
                                	</div>
								</td>							
							</tr>
							<tr>
								<td>5</td>
								<td><input type="text" maxlength="50" class="form-control" placeholder="" name="5['expdetails'][newspaper_name]"></td>
								<td><input type="date"  class="form-control" placeholder="" name="5['expdetails'][news_publishing_date]"></td>
								<td><input type="text" class="ackSch1input form-control" maxlength="7" placeholder="" name="5['expdetails'][expense_on_news]"></td>
								<td><input type="text" maxlength="60" class="form-control" placeholder="" name="5['expdetails'][channel_name]"></td>
								<td><input type="datetime-local" class="form-control" placeholder="" name="5['expdetails'][telecost_dateTime]"></td>
								<td><input type="text" maxlength="7" class="ackSch1input form-control" placeholder="" name="5['expdetails'][expense_on_channel]"></td>
								<td>
                                	...
                                	<div class="col-md-12 paymenttype5" style="margin-top: 20px; display: none;">
                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="date" name="5['expdetails'][cheque_date]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="50" name="5['expdetails'][cheque_bank]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="10" name="5['expdetails'][cheque_ifsc]" class="form-control" placeholder=""></div>

                                		<div style="float: left; width: 20%; margin-left: 2%;"><input type="text" maxlength="16" name="5['expdetails'][cheque_no]" class="form-control" placeholder=""></div>
                                	</div>
								</td>	
							</tr>
							@endif										
