                        ...
                        @foreach($data as $dp)
                            ...
                            <tbody>                                                
                                ...
                                <tr id="deposit{{$dp->relation_type_code}}">
                                    <td>
                                        <textarea col="10" row="5" name="bank_name{{$dp->relation_type_code}}" id="bank_name{{$dp->relation_type_code}}" class="form-control" required="required"></textarea>
                                    </td>
                                    <td>
                                        <textarea col="10" row="5" class="form-control" name="branch_address{{$dp->relation_type_code}}" id="branch_address{{$dp->relation_type_code}}" required="required">  
                                        </textarea>
                                    </td>
                                    <td width="160">
                        ...
                        @foreach($data as $insco)
                            ...
                            <tbody>
                                ...
                                <tr id="company_form{{$insco->relation_type_code}}">
                                    <td>
                                        <textarea col="10" row="5" class="form-control" name="company_name{{$insco->relation_type_code}}" id="company_name{{$insco->relation_type_code}}" required="required"></textarea>
                                    </td>
                                    <td width="290">
                        ...
                        @foreach($data as $save)
                            ...
                            <tbody>
                                ...
                                <tr id="nss_form{{$save->relation_type_code}}">
                                    <td>
                                        <textarea col="10" row="5" class="form-control" name="saving_name{{$save->relation_type_code}}" id="saving_name{{$save->relation_type_code}}" required="required"></textarea>
                                    </td>
                                    <td>
                                        ...
                                        <div id="saving_type_div{{$save->relation_type_code}}" style="display: none;">
                                            ...
                                            <textarea col="10" row="5" class="form-control" name="saving_type_other{{$save->relation_type_code}}" id="saving_type_other{{$save->relation_type_code}}">
                                            </textarea>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        @foreach($data as $loan)
                            ...
                            <tbody>
                                ...
                                <tr id="loan_form{{$loan->relation_type_code}}">   
                                    ...
                                    <td>
                                        <input type="text" name="nature_of_loan{{$loan->relation_type_code}}" id="nature_of_loan{{$loan->relation_type_code}}" class="form-control"  required="required">
                                    </td>
                                    <td>
                        ...
                        @foreach($data as $veh)
                            ...
                            <tbody>
                                ...
                                <tr id="vehicle_form{{$veh->relation_type_code}}">
                                    ...
                                    <td>
                                        <textarea col="10" row="5" class="form-control" name="make{{$veh->relation_type_code}}" id="make{{$veh->relation_type_code}}"  required="required"></textarea>
                                    </td>                                                    
                                    <td>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea col="10" row="5" name="modal_bank_name" id="modal_bank_name" required="required"></textarea>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">{{Lang::get('affidavit.branch_address') }}:</label>
                    <textarea col="10" row="5" name="modal_branch_address" id="modal_branch_address"  required="required"></textarea>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input  class="form-control" type="text" name="modal_nature_of_loan" id="modal_nature_of_loan" required="required" >
                </div>
            </div>           
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <textarea  class="form-control" col="10" row="5" name="modal_make" id="modal_make" required="required"></textarea>
                </div>
            </div>           
        </div>
        <div class="row">
