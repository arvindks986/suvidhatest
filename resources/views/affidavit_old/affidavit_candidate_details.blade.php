                  ...
                  <!--  <div class="form-group">
                        ...
                        <fieldset class="py-4 px-5 mb-4 mt-5">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="lbl-mandry">{{Lang::get('affidavit.for_district') }}</label>
                                        <input value="@if(@$session_data->st_code)<?php $dist_name = App\Http\Controllers\Affidavit\CommanFunctionController::getDistName(@$session_data->st_code,@$session_data->pc_no); ?>{{ @$dist_name[0]->DIST_NAME_EN }}@endif" readonly="" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group mt-2 mb-2">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        ...
                                        <textarea name="postal_address" id="postal_address" onkeypress="return blockSpecialChar_address(event)" placeholder="Please enter your adddress" class="form-control">{{ $user_profile_data->address }}, {{ getdistrictbydistrictno($user_profile_data->state,$user_profile_data->district)->DIST_NAME }}, {{ getstatebystatecode($user_profile_data->state)->ST_NAME }}</textarea>
                        ...
                        <fieldset class="py-4 px-5 mt-2 mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="">{{Lang::get('affidavit.district')}}:</label>
                                        @if(Session::get('dist_no_by_epic')!="")
                                            <input readonly="readonly" type="text" name="district_name_epic" id="district_name_epic" class="form-control" value="{{ Session::get('dist_name_by_epic') }}">
                                            <input type="hidden" id="district_code_from_epic" name="district_code_from_epic" value="{{ Session::get('dist_no_by_epic') }}">
                                        @else
                                            <input readonly="readonly" type="text" name="district_name_epic" id="district_name_epic" class="form-control" value="{{ getdistrictbydistrictno($user_profile_data->state,$user_profile_data->district)->DIST_NAME }}">
                                            <input type="hidden" id="district_code_from_epic" name="district_code_from_epic" value="{{ $user_profile_data->district }}">
                                        @endif
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        ...
                                        @else
                                            <input readonly="readonly" type="text" name="ac_name_epic" id="ac_name_epic" class="form-control" value="{{ getpcbypcno($user_profile_data->state,$user_profile_data->pc_no)->PC_NAME }}">

                                            <input type="hidden" id="ac_code_from_epic" name="ac_code_from_epic" value="{{ $user_profile_data->ac }}">
                                        @endif                                    
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group mt-2 mb-2">
                                        ...
                                        <input maxlength="10" type="text" value="<?php if(!empty($session_data->phoneno_1)){ ?>{{$session_data->phoneno_1}}<?php }else{ ?>{{ $user_profile_data->mobile }} <?php }?>" name="mobile_number" class="form-control removespecialcharacter" placeholder="Enter mobile number" id="mobile_number_check">
                                        ...
                                        <table class="table table-info table-bordered purpleTable" id="socialMediaTable">
                                            ...
                                            <tbody> 
                                                ...
                                                <input type="text" id="other_social_media_account" name="other_social_media_account" class="form-control" style="display: none;">
                                                  ...
                                                  <td><input type="text" name="social_account" id="social_account" class="form-control">
                ...
                <table class="table table-info table-bordered table-striped purpleTable " id="userTablePAN">
                    <thead>
                        ...
                        <tr>
                          ...
                          <th>{{Lang::get('affidavit.financial_year')}} 2016-2017</th>
                        </tr>
                   </thead>
        ...
        <div class="row">
          ...
          <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="text" name="financial_year" onkeypress="return blockSpecialChar_Financial_Year(event)"  class="form-control" id="financial_year" placeholder="2020-2021" maxlength="9">
                </div>
          ...
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation">{{Lang::get('affidavit.total_income_shown_for_financial_year')}}(2016-2017)</label>
...
function updatePANDetail(){
    ...
    if($('#financialyr1').val() == ''){
        $(".error_5_pan").html('<label class="text-danger">Please enter financial year(2020-2021).</label>');
        flag = true;
    } else {
        $(".error_5_pan").html('');
    }
    ...
    if($('#financialyr2').val() == ''){
        $(".error_6_pan").html('<label class="text-danger">Please enter financial year(2019-2020).</label>');
        flag = true;
    } else {
        $(".error_6_pan").html('');
    }
    ...
    if($('#financialyr3').val() == ''){
        $(".error_7_pan").html('<label class="text-danger">Please enter financial year(2018-2019).</label>');
        flag = true;
    } else {
        $(".error_7_pan").html('');
    }
    ...
    if($('#financialyr4').val() == ''){
        $(".error_8_pan").html('<label class="text-danger">Please enter financial year(2017-2018).</label>');
        flag = true;
    } else {
        $(".error_8_pan").html('');
    }
    ...
    if($('#financialyr5').val() == ''){
        $(".error_9_pan").html('<label class="text-danger">Please enter financial year(2016-2017).</label>');
        flag = true;
    } else {
        $(".error_9_pan").html('');
    }
            ...
            if(response.status == 200){
                ...
                var len = response.result.length;
                  if(response['result'] != null){
                        ...
                        var tr_str = "<tr id='media_accounts" + id +"' >" + "<td id='media_account" + id +"' >" + social_media_name + "</td>" +"<td id='other_account_name" + id +"' >" + social_account + "</td>" + "<td><input type='button' value='{{Lang::get('affidavit.edit')}}' class='editrecord btn btn-success btn-sm mt-1 mr-1' data-id='"+id+"' data-social_media_code='"+social_media_code+"' data-other_account_name='"+social_account+"'  data-media_account='"+social_media+"'></td>"+ "</tr>";
...
function getAClist($dist_code) {
    ...
    $.ajax({
        ...
        beforeSend: function(){
            ...
            var items="";
                items += "<option value=''>--{{Lang::get('affidavit.select_pc_name')}}--</option>";
            $.each(response.result,function(index, item) {
