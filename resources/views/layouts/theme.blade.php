 ...
 <head>
  ...
  <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet">
   ...
   <!--  <link rel="stylesheet" href="{{ asset('theme/css/grasp_mobile_progress_circle-1.0.0.min.css') }}"> -->
    ...
    <!-- Favicon-->
	 <link rel="stylesheet" href="{{ asset('admintheme/css/footable.bootstrap.css') }}"> 
...
<!-- JavaScript files-->
 ...
 <script src="{{ asset('admintheme/js/footable.js') }}"  type="text/JavaScript"></script>
 <script src="{{ asset('admintheme/js/bootstrap-datetimepicker.js') }}"  type="text/JavaScript"></script> 
  <script src="{{ asset('theme/js/jquery.slicknav.js') }}"  type="text/JavaScript"></script>
