                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mt-2 mb-2">
                                        ...
                                        <input type="text" readonly="" value="@if(@$session_data->st_code){{ getacbyacno(@$session_data->st_code,@$session_data->pc_no)->PC_NAME }}@endif" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        ...
                                        @else
                                            <input readonly="readonly" type="text" name="ac_name_epic" id="ac_name_epic" class="form-control" value="{{ getacbyacno($user_profile_data->state,$user_profile_data->pc)->PC_NAME }}">

                                            <input type="hidden" id="ac_code_from_epic" name="ac_code_from_epic" value="{{ $user_profile_data->pc }}">
                                        @endif                                    
                                    </div>
                                </div>
