                        ...
                        @foreach($data as $self_spouse)                                            
                            ...
                            <tbody>
                                ...
                                <tr id="self_spouse_form{{$self_spouse->relation_type_code}}">
                                    <td>
                                       <input type="text" class="form-control" name="occupation{{$self_spouse->relation_type_code}}" id="occupation{{$self_spouse->relation_type_code}}"  class="form-control" maxlength="200" required="required" onkeypress="return blockSpecialChar_name(event)">
                        ...
                        @foreach($data as $dependant)    
                            ...
                            <tbody>
                                ...
                                <tr id="depen_income_form{{$dependant->relation_type_code}}">
                                    <td>
                                       <input type="text" name="source_of_income{{$dependant->relation_type_code}}" id="source_of_income{{$dependant->relation_type_code}}"  class="form-control" maxlength="200" required="required" onkeypress="return blockSpecialChar_name(event)">
                                    </td>
                                    <td> 
                        ...
                        <tbody>
                            ...
                            <form>
								<tr id="govt_public{{$dependant->relation_type_code}}">    
									<td>
									   <input type="text" name="govt_public_company{{$dependant->relation_type_code}}" id="govt_public_company{{$dependant->relation_type_code}}"  class="form-control" maxlength="200" required="required" onkeypress="return blockSpecialChar_name(event)">
									</td>
									<td>
									   <textarea col="10" row="5" class="form-control" name="govt_public_details{{$dependant->relation_type_code}}" id="govt_public_details{{$dependant->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)">
									   </textarea>
									</td>
									<td nowrap="nowrap"> 
                        ...
                        <tbody>
                            ...
                            <form>
								<tr id="huf{{$dependant->relation_type_code}}">         
									...
									<td>
									   <textarea col="10" row="5" class="form-control" name="huf_details{{$dependant->relation_type_code}}" id="huf_details{{$dependant->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)">
											</textarea>
									</td>
									<td nowrap="nowrap"> 
                        ...
                        <tbody>
                            ...
                            <form>
								<tr id="partner{{$dependant->relation_type_code}}">     
									<td>
									   <input type="text" name="name_partnership_firm{{$dependant->relation_type_code}}" id="name_partnership_firm{{$dependant->relation_type_code}}"  class="form-control" maxlength="200" required="required" onkeypress="return blockSpecialChar_name(event)">
									</td>
									<td>
									   <textarea col="10" row="5" class="form-control" name="partner_details{{$dependant->relation_type_code}}" id="partner_details{{$dependant->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)">
											</textarea>
									</td>
									<td nowrap="nowrap"> 
                        ...
                        <tbody>
                            ...
                            <form>
								<tr id="private{{$dependant->relation_type_code}}">     
									<td>
									   <input type="text" name="name_private_company{{$dependant->relation_type_code}}" id="name_private_company{{$dependant->relation_type_code}}"  class="form-control" maxlength="200" required="required" onkeypress="return blockSpecialChar_name(event)">
									</td>
									<td>
									   <textarea col="10" row="5" class="form-control" name="private_details{{$dependant->relation_type_code}}" id="private_details{{$dependant->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
									</td>
									<td nowrap="nowrap"> 
