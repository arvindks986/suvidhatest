                                ...
                                <tr id="loan_form{{$loan->relation_type_code}}">    
                                    ...
                                    <td>
                                        ...
                                        <div id="loan_type_div{{$loan->relation_type_code}}" style="display: none;">
                                            ...
                                            <textarea col="10" row="5" class="form-control" name="loan_type_other{{$loan->relation_type_code}}" id="loan_type_other{{$loan->relation_type_code}}" onkeypress="return blockSpecialChar_name(event)">
                                            </textarea>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        @foreach($data as $indi_loan)
                            ...
                            <tbody>
                                ...
                                <tr id="indi_loan_form{{$indi_loan->relation_type_code}}">
                                    <td>
                                        <textarea col="10" row="5" class="form-control" name="indi_loan_to{{$indi_loan->relation_type_code}}" id="indi_loan_to{{$indi_loan->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                                    </td>                                                  
                                    <td>
                                ...
                                <tr id="govt_dues_form{{$govt_row->relation_type_code}}">
                                    ...
                                    <td>
                                        <div id="govt_dept_due_details_div{{$govt_row->relation_type_code}}">
                                            <textarea col="10" row="5" class="form-control" class="form-control" name="due_details{{$govt_row->relation_type_code}}" id="due_details{{$govt_row->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                                        </div>
                        ...
                        @foreach($data as $other_dis)
                            ...
                            <tbody>
                                ...
                                <tr id="other_form_dis{{$other_dis->relation_type_code}}">
                                    <td>
                                        <textarea col="10" row="5" class="form-control" name="asset_type_dis{{$other_dis->relation_type_code}}" id="asset_type_dis{{$other_dis->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)">
                                        </textarea>
                                    </td>
                                    <td>
