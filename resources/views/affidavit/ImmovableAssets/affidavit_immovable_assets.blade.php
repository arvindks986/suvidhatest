               ...
               @endforeach                                                        
                   ...
                   <form id="form{{$dp->relation_type_code}}">
                      <tr id="agricultural{{$dp->relation_type_code}}">
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="location{{$dp->relation_type_code}}" id="location{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="survey_number{{$dp->relation_type_code}}" id="survey_number{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td>
                ...
                <tbody>
                   ...
                   <form id="form{{$dp->relation_type_code}}">
                      <tr id="nonagricultural{{$dp->relation_type_code}}">
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="location{{$dp->relation_type_code}}" id="location2{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)" ></textarea>
                         </td>
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="survey_number{{$dp->relation_type_code}}" id="survey_number2{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td>
                ...
                <tbody>
                   ...
                   <form id="form{{$dp->relation_type_code}}">
                      <tr id="commercial{{$dp->relation_type_code}}">
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="location{{$dp->relation_type_code}}" id="location3{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="survey_number{{$dp->relation_type_code}}" id="survey_number3{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td>
                ...
                <tbody>
                   ...
                   <form id="form{{$dp->relation_type_code}}">
                      <tr id="residential{{$dp->relation_type_code}}">
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="location{{$dp->relation_type_code}}" id="location4{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td width="120">
							<textarea col="10" row="5" class="form-control" name="survey_number{{$dp->relation_type_code}}" id="survey_number4{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)"></textarea>
                         </td>
                         <td>
                ...
                <tbody>
                   ...
                   <form id="form{{$dp->relation_type_code}}">
                      <tr id="other{{$dp->relation_type_code}}">
                         <td>
                            <input type="text" class="form-control" name="brief_details{{$dp->relation_type_code}}" id="brief_details{{$dp->relation_type_code}}" required="required" onkeypress="return blockSpecialChar_name(event)">
                         </td>
                         <td> 
                            <input type="text"  class="form-control" name="amount{{$dp->relation_type_code}}" id="amount{{$dp->relation_type_code}}"  onkeydown="return NumbersOnly(event,this)" maxlength="12" required="required" onkeypress="return blockSpecialChar_name(event)">
                         </td>
                         <td nowrap="nowrap"> 
