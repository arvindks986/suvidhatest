	...
	<table width="100%" bgcolor="#fff" border="0">
		...
		<?php if(session()->get('locale') == 'hi') { ?>
			...
			<th  class="justify">			
				...
				{{getacbyacno(@$data['cand_details']->st_code,@$data['cand_details']->pc_no)->PC_NAME}} @endif</u> (निर्वाचन क्षेत्र का नाम)   निर्वाचन-क्षेत्र  से   <u class="inputLine"><span style="width:350px;">{{Lang::get('affidavit.general_election_to_legislative_assembly')}}</span></u> (सदन का नाम) के निर्वाचन के लिए रिटर्निंग आफिसर के समक्ष अभ्‍यर्थी द्वारा नाम-निर्देशन पत्र के साथ प्रस्‍तुत किया जाने वाला शपथ पत्र 
				</p>
			</th>
			</tr>
		<?php } else { ?>
