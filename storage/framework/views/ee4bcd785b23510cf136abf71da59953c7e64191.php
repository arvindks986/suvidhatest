 ...
 width: 50%;
  ...
  <body>
   <main class="pt-3 pb-5 pl-5 pr-5">
	...
	<?php if($is_appoinment_scheduled_for_one==1): ?>
		<?php 
		$disp='none';
		$disp2='block';
		?>
	...
	<?php endif; ?>
	 ...
	 <div class="container-fluid" style="display:<?php echo e($disp); ?>" id="call">
	   <div class="card">
		 <div class="card-header">
		   <div class="row">
			<div class="col-md-6 col-12"><h4><?php echo e(__('messages.Preference')); ?></h4> </div> 
			...
			<?php if($nomiantaion_end_date!=0): ?>
			<?php echo e(__('messages.lastdate')); ?> 
			<?php echo e(date("D d, M Y", strtotime($nomiantaion_end_date))); ?>  
			<?php endif; ?>
			</span>	
		   <?php if($is_appoinment_scheduled_for_one==1): ?>
		   <span style="float: right; margin-top: 16px; font-size: 13px; color: gray;cursor:pointer;" onclick="return showhide2();"><?php echo e(__('messages.Preference_Details')); ?></span>	 
		   <?php endif; ?>	
		 </div> 
		 <div class="card-body">
		   <div class="row">
			<div class="col-md-4 col-12 pr-2">
			  ...
			  <?php 
				...
				<div class="appnt-detail list-detail">
					<h4 class="text-center d-flex justify-content-between"><b><?php echo e($d); ?></b><?php echo e($NOMNO); ?></h4>
					<ul style="line-height: 1;">
					<li><strong> <?php echo e(__('nomination.Name')); ?></strong> <span><?php echo e($candidate_name); ?></span></li>
					<li><strong><?php echo e(__('nomination.ac')); ?> &amp; <?php echo e(__('nomination.Name')); ?></strong> <span><?php echo e($ACNO); ?> - <?php echo e($ACname); ?></span></li>
					<!--<li><strong><?php echo e(__('nomination.Status')); ?></strong> <span><?php echo e(__('csa.Pre_Scurtiny_Done')); ?></span></li>-->
					<li><strong><?php echo e(__('nomination.State')); ?></strong> <span><?php echo e($state); ?></span></li>
					<li><strong><?php echo e(__('nomination.Election')); ?></strong> <span><?php echo e($election_name_one); ?></span></li>
					<li><strong><?php echo e(__('nomination.Party')); ?></strong> <span><?php echo e($party); ?></span></li>
					<li><strong><?php echo e(__('step1.Category')); ?></strong> <span> <?php echo e(strtoupper($cat)); ?> </span></li>
				  </ul> 
					<div class="row m-0 p-3">
					  <div class="col-md-4 col-12 p-0"><strong><?php echo e(__('nomination.Nomination')); ?></strong></div>  
					  <div class="col-md-8 col-12 p-0 text-right">
						 <div class="apt-btn">
						  <a href="<?php echo e($udurl); ?>?acs=<?php echo encrypt_String($ACNO); ?>&std=<?php echo encrypt_String($std); ?>" class="btn sm-btn dark-pink-btn"><?php echo e(__('nomination.View')); ?></a>  
						  <a href="<?php echo e($dwdulr); ?>" class="btn sm-btn dark-purple-btn"><?php echo e(__('nomination.Download')); ?></a>  
						</div> 
					  </div>  
					</div>
			   ...
			   <div class="appnt-calndr">
				   <div class="caldr-wrap frst-week m-3">
					   ...
					   <div class="help-arrow">	 
						 ...
						 <span><?php echo e(__('messages.click')); ?></span>
					   </div>	 
		...
		?>	
		 ...
		 <div class="card-footer">
		    <div class="text-left col-md-3 col-3 pl-3" style="height:1px;">
			  <a href="<?php echo e('nominations?acs='.$acnno.'&std='.$stno); ?>" class="btn btn-lg font-big dark-pink-btn" style="color: white;"><?php echo e(__('step1.Back')); ?></a>  
			</div> 		
			<?php if($is_appoinment_scheduled_for_one==1): ?>
		   <div style="font-size: 13px; color: gray; cursor: pointer; position: absolute; margin-top: 35px; margin-left: 50em;" onclick="return showhide2();"><?php echo e(__('messages.Preference_Details')); ?></div>	 
		   <?php endif; ?>	
		   <div class="apt-btn text-right">
			  <?php if($appoinment_status!='Cancel'): ?>
			  <!-- <a href="schedule-appointment" class="btn btn-lg font-big dark-pink-btn">CANCEL</a>  -->
			  <?php endif; ?>
			  <a href="#" class="btn btn-lg font-big dark-purple-btn" onclick="return submitScheduled();" id="scheduleButton"><?php echo e(__('messages.SCHEDULE_APPOINTMENT')); ?></a>  
			</div> 
		 </div>  
	   </div>
	 </div>
	  ...
	  <div class="container-fluid" style="display:<?php echo e($disp2); ?>" id="slip">
	   <div class="card">
		 <div class="card-header">
		   <div class="row">
			<div class="col-md-12 col-12"><h4><?php echo e(__('messages.predetails')); ?></h4> </div> 
		 ...
		 <div class="card-body">
		   <div class="row">
			<div class="col-md-4 col-12 pr-2">
			  ...
			  <?php 
				...
				<div class="appnt-detail list-detail">
					...
					<li><strong> <?php echo e(__('nomination.Name')); ?></strong> <span><?php echo e($candidate_name); ?></span></li>
					<li><strong><?php echo e(__('nomination.ac')); ?> &amp; <?php echo e(__('nomination.Name')); ?></strong> <span><?php echo e($ACNO); ?> - <?php echo e($ACname); ?></span></li>
					<!--<li><strong><?php echo e(__('nomination.Status')); ?></strong> <span><?php if($stst!='0'): ?><?php echo e($stst); ?><?php else: ?><?php echo e($appoinment_status); ?><?php endif; ?></span></li>-->
					<li><strong><?php echo e(__('nomination.State')); ?></strong> <span><?php echo e($state); ?></span></li>
					<li><strong><?php echo e(__('nomination.Election')); ?></strong> <span><?php echo e($election_name_one); ?></span></li>
					<li><strong><?php echo e(__('nomination.Party')); ?></strong> <span><?php echo e($party); ?></span></li>
					<li><strong><?php echo e(__('step1.Category')); ?></strong> <span> <?php echo e(strtoupper($cat)); ?></span></li>
					...
					<div class="row m-0 p-3">
					  ...
					  <div class="col-md-8 col-12 p-0 text-right">
						 <div class="apt-btn">
						  <a href="<?php echo e($udurl1); ?>?acs=<?php echo encrypt_String($ACNO); ?>&std=<?php echo encrypt_String($std); ?>" class="btn sm-btn dark-pink-btn"><?php echo e(__('nomination.View')); ?></a>  
						  <a href="<?php echo e($dwdulr2); ?>" class="btn sm-btn dark-purple-btn"><?php echo e(__('nomination.DownloadnPrint')); ?></a>  
						</div> 
					  </div>  
					</div>
					</div><!-- End Of appnt-detail Div --> 
			...
			//echo count($psta) .'--'. count($isChallanSubmitted).'----'.$std.'---'.$ACNO; die;?>
					...
					?>	
					<?php if(count($isAllFinalized)!=0): ?>				
					<div class="text-center py-3"><a href="#" class="btn btn-success btn-big" id="online_pay2" onclick="return finalizeNomination('online_pay2');"><?php echo e(__('messages.fn')); ?></a></div>	
			       <div class="animate-wrap" id="ttump">
					...
					<?php else: ?> 
					<div style="text-align: center; margin-top: 21px; background: #caede3;" class="text-center" id="online_pay3"><?php echo e(__('messages.nmf')); ?></div>		
				   <?php endif; ?>
				   <?php endif; ?>
		   <div style="text-align: center; margin-top: 21px; background: #caede3;display:none;"  id="NeedToShowSucceess" ><?php echo e(__('messages.nmf')); ?></div>
			</div> 
                       ...
                       <div class="booked-appoint">
						  ...
						  <div class="d-flex justify-content-between">
							<div>
							  <ul class="list-inline" style="background: #caede3; margin-right: 40px; width: 328%; height: 50px; margin-bottom: 36px; padding-bottom: 6px; margin-left: -17px; margin-top: -16px;">
								<li class="list-inline-item mr-4" style="margin-left: 30px; margin-top: -8px;">&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <br><?php echo e(__('messages.predetails2')); ?></li> 
								</ul>
							...
							?>  
							 ...
							 <ul class="list-inline" style="font-size: 17px;margin-bottom:10px;width: 141%;margin-left: 20px;">
								<li class="list-inline-item" style="width: 250px;"><span class="list-bg"><b class="circle-icon"><i class="fa fa-calendar" aria-hidden="true"></i></b>&nbsp; <?php echo e(date("D d, M Y", strtotime($dataaad->appointment_date))); ?>   </span></li>
								<li class="list-inline-item"><span class="list-bg"><b class="circle-icon"><i class="fa fa-clock-o" aria-hidden="true"></i></b>&nbsp; <?php echo e($dataaad->appointment_time); ?> O'clock</span></li>
								<?php if($dataaad->is_ro_acccept=='1'): ?>
								<!--<li class="list-inline-item"><span class="list-bg" style="background:yellowgreen;"><b></b>&nbsp; <?php echo e(__('messages.roacc')); ?> </span></li>-->
								<?php endif; ?>
							...
							<div class="down-print-link">
							  <ul class="list-inline" style="background: #caede3; margin-right: 40px; width: 108%; margin-bottom: 36px; padding-bottom: 8px;">
								<li class="list-inline-item"><a href="download-scheduled?id=<?php echo $_REQUEST['id'];?>"><?php echo e(__('nomination.Download')); ?> <i class="fa fa-download" aria-hidden="true"></i></a></li>
						 ...
						 <div class="book-body p-3">
						   <div class="row">
							...
							$stndn= $str[15];
							?>
							 <div class="col-md-4 col-12"><label><?php echo e(__('csa.RO_Name')); ?>:</label> <?php echo e($ROname); ?> </div> 
							 <div class="col-md-4 col-12"><label><?php echo e(__('nomination.ac')); ?> </label> <?php echo e($ACNO); ?> - <?php echo e($ACname); ?></div> 
							 <!-- <div class="col-md-4 col-12"><label><?php echo e(__('csa.District')); ?>:</label> <?php echo e($DistName); ?></div>  -->
							 <!--<div class="col-md-12 col-12 pt-3"><label><?php echo e(__('csa.Address')); ?>:</label> <?php echo e($ROaddress1); ?> <?php echo e($ROaddress2); ?></div>
							 <div class="col-md-4 col-12"><label>Status:</label> <?php echo e($appoinment_status); ?></div> -->
							<?php } } //} ?>	
							</div>	 
						   </div> 
						    <?php 
							...
							<div class="info-text">
							  <?php if((count($psta)>0) or (count($challanCnt)>0)): ?>
								<span style="color:black;font-size:15px;"><b><?php echo e(__('messages.chnmesage')); ?></b></span>
								<br><br>
								<?php if(count($psta)>0): ?>
								<?php if($psta[0]->bank_transaction_status=='2' ||  $psta[0]->bank_transaction_status=='' || $psta[0]->bank_transaction_status=='0'): ?> 
									<?php if($payState=='S03'): ?>
									...
									<?php if($payState=='S24'): ?>
									<form method="post" id="verification_up" name="verification_up" action="<?php echo e(url('payment-verification-up')); ?>">
											<input type="hidden" name="challan_ref_id" id="challan_ref_id" value="<?php echo e($psta[0]->challan_ref_id); ?>">
											<input type="hidden" name="amount" id="amount" value="<?php echo e($psta[0]->challan_amount); ?>">
											<input type="submit" class="btn btn-primary" id ="submit" name="submit_cin"  value="Check Payment Status" />
										</form>
									<?php endif; ?>
									...
									<?php if($payState=='S19'): ?>
										...
										<form method="post" id="verification_pun" name="verification_pun" action="<?php echo e(url('payment-verification-pun')); ?>">
											<input type="hidden" name="url" id="encrypt_pun" value="<?php echo e($url); ?>">
											<input type="hidden" name="encData" id="postData" value="<?php echo e($postData); ?>">
											<input type="submit" class="btn btn-primary" id ="submit" name="submit_cin"  value="Check Payment Status" />
										</form>
									...
									<?php if($payState=='S08'): ?>
										...
										<form method="post" id="verification_him" name="verification_him" action="<?php echo e($url); ?>">
											<input type="hidden" name="encdata" id="postData" value="<?php echo e($encdata); ?>">
											<input type="submit" class="btn btn-primary" id ="submit" name="submit_cin"  value="Check Payment Status" />
										</form>
								...
								<?php endif; ?>
								<?php if($psta[0]->bank_transaction_status=='1'): ?> 
									<?php if($payState=='S03'): ?>
								...
								<?php endif; ?>
								<?php endif; ?>
								<span style="color:black;font-size:13px;"><b><?php echo e(__('messages.challanPayment')); ?>:</b> 
								...
								?>
										 ...
										 <?php if((count($psta)>0)): ?>	
										   ...
										   <?php endif; ?>		
										   <?php if(count($challanCnt)>0): ?>
												   <?php if(!empty($challanCnt[0]->payByCash) && ($challanCnt[0]->payByCash > 0)): ?>
								...
								<span style="color:black;margin-left:50px;font-size:13px"><b><?php echo e(__('messages.challanDteTime')); ?>:</b> 
											
										   <?php if((count($psta)>0)): ?>	
												<?php if($mydated != '1970-01-01 05:30:00' && $mydated != '0000-00-00 00:00:00'): ?><?php echo e($mydated); ?> <?php else: ?> NA <?php endif; ?>
										   <?php endif; ?>		
										   <?php if(count($challanCnt)>0): ?>
												 <?php if(!empty($challanCnt[0]->payByCash) && ($challanCnt[0]->payByCash > 0)): ?>
												  	<?php if(!empty($challanCnt[0]->createdAt)): ?><?php echo e(date('d-m-Y h:i:s', strtotime($challanCnt[0]->createdAt))); ?><?php endif; ?>			
								...
								<span style="color:black;margin-left:50px;font-size:13px"><b><?php echo e(__('messages.Mode')); ?>:</b> 
											 <?php if((count($psta)>0)): ?>
									...
									<span style="color:black;margin-left:10px;font-size:13px"><b>GRN No:</b> 
											 <?php if((count($psta)>0)): ?>
												<span><?php echo e($psta[0]->challan_ref_id); ?></span>
											   <!--<span>Online</span>-->
											  <?php endif; ?>		
												</span>
								<br><br>
							...
							<?php if(count($psta)>0): ?>
								<?php if($psta[0]->bank_transaction_status=='3'): ?>	
								<div>	
									<strong class="pr-2 btn font-big blink-effect"> <?php echo e(__('csa.Pay_Security_Deposit_Online')); ?> </strong>
							...
							<?php endif; ?>								
							  ...
							  <!--<div onclick="return showBankDetails();" class="btn btn-primary"><?php echo e($bnk); ?> <?php echo e(__('csa.Bank_Details')); ?></div>-->
							</div>								   
                                        ...
                                        <div class="row" style="display:none;">
                                            ...
                                            <form name="frmPayment" id="frmPayment" action="" method="post">
                                                ...
                                                <tbody><tr>
                                                <td width="16%"><b><?php echo e(__('nomination.Name')); ?></b></td>
                                                <td width="30%"><spacer><?php echo e($candidate_name); ?>	</spacer></td>
                                                <td width="30%"><strong><?php echo e(__('nomination.Fee')); ?></strong> :&nbsp; <img src="https://rtionline.gov.in/images/rsSymbol.png" width="8" height="10" style="border:none;"><cite><?php echo e($dmt); ?></cite></td>
                                                <!--<td width="24%">&nbsp;</td>-->
                                                </tr>
                                                </tbody></table>
                                                <br class="clearfix">
							    ...
							    <?php if((count($psta)<=0) && (count($challanCnt)<=0)): ?>
								<div>	
									<strong class="pr-2 btn font-big blink-effect"> <?php echo e(__('csa.Pay_Security_Deposit_Online')); ?> </strong>
                                    <div  onclick="red();" style="float: right;cursor:pointer;" class="razorpay-payment-button">
										PAY
								...
								<?php elseif( (count($challanCnt) > 0)): ?>	
					<?php if($finalize_after_payment!=1): ?>				
				<!--	<div style="cursor:pointer;color:blue;" id="online_pay2" onclick="return finalizeNomination('online_pay2');"><?php echo e(__('messages.fn')); ?>-- pp</div>	-->
					<?php else: ?>
					<!--<div style="cursor:pointer;color:gray;" id="online_pay2" ><?php echo e(__('messages.nmf')); ?></div>	-->
					<?php endif; ?>	
								<!--<div><strong class="pr-2"><?php echo e(__('messages.Challan')); ?></strong>
							    <span style="color: blue; font-size: 13px; margin-right: 10px; cursor: pointer;" onclick="return showPaymentDetails();"><?php echo e(__('messages.Challan_Submitted')); ?> </span></div> -->
										...
										<div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
										  <div class="modal-content">
										   <div class="pop-header pt-3 pb-1">
											...
											<h5 class="modal-title"><?php echo e(__('messages.Challan')); ?></h5> 
											...
											<ul>
											<li><label><?php echo e(__('nomination.ac')); ?> &amp; <?php echo e(__('nomination.Name')); ?>:</label><span><?php echo $acnnod;  ?>-<?php echo $acnamed,', '.$stated; ?></span></li>
											
											<li><label><?php echo e(__('messages.ChallanNO')); ?></label><span> <?php echo e($challanCnt[0]->challan_no); ?></span></li> 
											
											<li><label><?php echo e(__('messages.ChallanDate')); ?></label><span> <?php echo e($challanCnt[0]->createdAt); ?></span></li>
											
											<li><label><?php echo e(__('messages.ViewChallan')); ?></label><span><a href="<?php echo url('/'); ?>/<?php echo e($challanCnt[0]->challan_receipt); ?>" target="_blank">View</a></span></li> 
											
											 </ul> 
											 
											  <p class="note-warn"><strong><i><?php echo e(__('csa.Instruction')); ?> <sup>*</sup></i></strong><?php echo e(__('step1.afterPayment')); ?></p>	
											 <p class="note-warn"><strong><i><?php echo e(__('csa.Instruction')); ?> <sup>*</sup></i></strong><?php echo e(__('messages.rosubject')); ?></p>	 
											 <p class="note-warn"><strong><i><?php echo e(__('csa.Instruction')); ?> <sup>*</sup></i></strong><?php echo e(__('csa.verification_doc')); ?> </p>	
											</div>
											<div class="confirm-footer">
											  <button type="button" class="btn dark-pink-btn font-big" data-dismiss="modal"><?php echo e(__('nomination.ok')); ?></button>
											</div>
										  </div>
										</div> 
								...
								<?php else: ?> 
					<?php if($finalize_after_payment!=1): ?>				
					<!--<div style="cursor:pointer;color:blue;" id="online_pay2" onclick="return finalizeNomination('online_pay2');"><?php echo e(__('messages.fn')); ?></div>	-->
					<?php else: ?>
					<!--<div style="cursor:pointer;color:gray;" id="online_pay2" ><?php echo e(__('messages.nmf')); ?></div>-->	
					<?php endif; ?>		
								<!--<div><strong class="pr-2"><?php echo e(__('csa.Paid')); ?> </strong>
							    <span style="color: blue; font-size: 13px; margin-right: 10px; cursor: pointer;" onclick="return showPaymentDetails();"><?php echo e(__('csa.Details')); ?> </span></div>-->
									<!-- Modal confirm schedule -->
									...
									<div class="modal fade modal-confirm" id="paymentPopUp">
										<div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
										  <div class="modal-content">
										   <div class="pop-header pt-3 pb-1">
											  <div class="animte-tick"><span>&#10003;</span></div>	
											<h5 class="modal-title"><?php echo e(__('csa.Receipt')); ?> </h5> 
											<div class="header-caption">
											</div>		
											</div>  
										<?php 
										...
										?>	
											<div class="modal-body">
											  <ul>
												<?php if($ost=='Success' || $ost=='Pending'): ?>
												<li><label>GRN No:</label><span><?php echo $psta[0]->challan_ref_id;  ?></span></li>
												<?php endif; ?>
												<li><label><?php echo e(__('nomination.ac')); ?> &amp; <?php echo e(__('nomination.Name')); ?>:</label><span><?php echo $psta[0]->ac_no;  ?>-<?php echo $acnamed,', '.$stated; ?></span></li>
												<!--<li><label><?php echo e(__('csa.Amount')); ?>:</label> <span>Rs. <?php //echo $psta[0]->amount1;  ?></span></li>
												<li><label><?php echo e(__('csa.Payment_Status')); ?>:</label> <span><?php echo e($ost); ?></span></li>-->
												<!--<li><label><?php echo e(__('csa.Amount')); ?>:</label> <span>INR <?php //echo $psta[0]->transaction_amount;  ?></span></li>-->
												
												<li><label><?php echo e(__('csa.Payment_Date')); ?>:</label><span><?php if(!empty($psta[0]->bank_transtimestamp) && $psta[0]->bank_transtimestamp != '0000-00-00 00:00:00'): ?><?php echo date('d-m-Y', strtotime($psta[0]->bank_transtimestamp));  ?><?php else: ?><?php echo e('NA'); ?><?php endif; ?></span></li>
												<li><label><?php echo e(__('csa.Payment_Time')); ?>:</label><span><?php echo $mydated;  ?></span></li>
												<?php if(isset(($psta[0]->challan_url)) && !empty($psta[0]->challan_url)): ?>
		...
		?>
		   ...
		   <div class="apt-btn text-right"> 
				<?php if($appoinment_status!='Cancel'): ?>
			  <a href="#" class="btn btn-lg font-big dark-pink-btn"  data-target="#basicExampleModal" data-toggle="modal"><?php echo e(__('step1.Cancel')); ?></a>  
			  <?php endif; ?>	
			  
			    <a href="#" class="btn btn-lg font-big dark-purple-btn pop-actn" onclick="return showhide();"> <?php echo e(__('messages.res')); ?></a>  
			</div> 
		 </div>  
	   </div>
	 </div>
	...
	<div class="modal fade" id="basicExampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	  aria-hidden="true">
	  <form name="cancel_form" id="cancel_form" method="POST"  action="<?php echo e(url('/nomination/cancel-nomination-prev')); ?>" autocomplete='off' enctype="x-www-urlencoded">
     <?php echo e(csrf_field()); ?>

	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('messages.canpre')); ?></h5>
          ...
          <ul>
          	<!--<li><label>Name:</label> <span> <?php echo e($candidate_name); ?>  </span></li>-->
			...
			$ACname=$str[3];
			?>
			<li><label>Nomination No.: </label> <span> <?php echo e($NOMNO); ?></span></li>
          	<!--<li><label>AC No. &amp; Name: </label> <span> <?php echo e($ACNO); ?> - <?php echo e($ACname); ?></span></li>-->
			<?php }}  ?>
			<li><label><?php echo e(__('nomination.Status')); ?>:</label> <span> <?php echo e($appoinment_status); ?></span></li>
		   </ul>
		</div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal" style="background:#f0587e; border: none;"><?php echo e(__('step1.Cancel')); ?></button>
			<button type="submit" class="btn btn-primary" onclick="return showLoader();" style="background: #bb4292; border: none;"><?php echo e(__('messages.Cancel_Preference')); ?></button>
		  </div>
	...
	<div class="modal fade" id="basicExampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	  aria-hidden="true">
	  <form name="appoinment_form" id="appoinment_form" method="POST"  action="<?php echo e(url('/nomination/prev/post')); ?>"  autocomplete='off' enctype="x-www-urlencoded">
     <?php echo e(csrf_field()); ?>

	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
		<!--	<h5 class="modal-title" id="areyu"><?php echo e(__('csa.Confirmation')); ?></h5>		-->	
		...
		<div class="modal-body" id="textmsg" style="border-bottom: 1px solid #e9ecef;">
			<div class="row">
							<div class="col-md-8 col-12">
							  <ul class="list-inline" style="width: 157%;">
							    <input type="hidden" name="nom_id" value="<?php echo e($nom_id); ?>">
		 ...
		 <!-- <div class="modal-body" style="margin-left:-37px;">
          <ul>
			...
			<li><label>Status:</label> <span> <?php echo e($appoinment_status); ?></span></li>
		   </ul>-->
		  <div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal" style="background:#f0587e; border: none;"><?php echo e(__('step1.Cancel')); ?></button>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
		  <div class="animte-tick"><span>&#10003;</span></div>	
          <h5 class="modal-title"><?php echo e($candidate_name); ?></h5>
		<div class="header-caption">
		  <p><?php //echo  __('messages.succpre');  ?>			
			<?php echo e(__('messages.confpre')); ?> 
		  </p>			  
		</div>		
        </div>
        <!-- Modal body -->
        <div class="modal-body">
          <ul>
			...
			$ACname=$str[3];
			?>
			<li><label><?php echo e(__('nomination.Nomination_No')); ?></label> <span><?php echo e($NOMNO); ?></span></li>
			<?php }} ?>
		 </ul>
		 <p class="note-warn"><strong><i><?php echo e(__('csa.Instruction')); ?> <sup>*</sup></i></strong><?php echo e(__('step1.afterPayment')); ?></p>	
		 <p class="note-warn"><strong><i><?php echo e(__('csa.Instruction')); ?> <sup>*</sup></i></strong><?php echo e(__('messages.rosubject')); ?></p>	
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
		  <div class="animte-tick"><span>&#10003;</span></div>
		<div class="header-caption">
		  <p><?php echo e(__('messages.pleasesel')); ?></p>	
		</div>		
        </div>
        <!-- Modal footer -->
        <div class="confirm-footer">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
		  <div class="animte-tick"><span>&#10003;</span></div>
		<div class="header-caption">
		  <p><?php echo e(__('messages.3max')); ?></p>	
		</div>		
        </div>
        <!-- Modal footer -->
        <div class="confirm-footer">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
	   ...
	   <div class="px-3">	
		<div style="padding: 0px; text-align: center; color:#f0587e; margin:1rem 0;">
          **<?php echo e(__('messages.rosubject')); ?>

		</div>
	  </div>	
		<?php if($isPaymentConfig=="YES"  && $payState != 'S06'): ?>
		<?php 
		if($payState){
		...
		<div class="modal-body p-0 text-center">
          <ul>
			<li><label>You will be redirected at <?php echo e($stname); ?> State Payment Gateway</label></li>
			<li><label><?php echo e(__('messages.sdepam')); ?> : RS. <?php echo e($amount); ?> </label></li>
		 </ul>
        ...
        <div class="confirm-footer p-0">  
			...
			<button type="button" class="btn dark-pink-btn" data-dismiss="modal" style="height: 30px; width: 12%;"  onclick="return redirectPayment();">
				<?php echo e(__('nomination.ok')); ?></button>
		  &nbsp; &nbsp; &nbsp;
		  
		  
          <div class="foot-highlight">  
		    <div class="orSparate" style="width: 50px;"><?php echo e(__('messages.OR')); ?></div>
			<i class="fa fa-check-square-o" aria-hidden="true"></i>
			  <?php echo e(__('messages.payBy')); ?> <span class="btn btn-outline-primary btn-sm" onclick="return showHidePay('1');">
			 <?php echo e(__('messages.SubBy')); ?> </span>
         </div>
        </div>
		 </div>
		 </div>
		...
		<div class="modal-body p-0 text-center">
          <ul>
			...
			<li><label><?php echo e(__('messages.sdepam')); ?> : RS. <?php echo e($Total_amount); ?> </label></li>
		 </ul>
		...
		?>
		 ...
		 <form name="submit_challan" id="submit_challan" method="POST"  action="<?php echo e(url('/nomination/challan/post')); ?>"  autocomplete='off' enctype="multipart/form-data"  style="margin-top:-26px;display:<?php echo e($strdtdtd); ?>;">
		  <?php echo e(csrf_field()); ?>

		 <div class="modal-body p-0">
          <!--<div style="text-align: center; font-size: 15px; font-weight: bold;"><?php echo e(__('messages.challanSubmit')); ?></div> -->
		  <!-- <?php if(!empty($state_payment_url)): ?> <?php //echo $state_payment_url; ?>
		    <div class="mx-5 mt-3 text-center"><?php echo e(__('messages.paylink')); ?><span><a href="http://<?php echo $state_payment_url; ?>" target="_blank">&nbsp; Payment Link</a></span></div>
		   <?php endif; ?>	-->
		  <br> 
		    <ul style="text-align: center; background: aliceblue; font-size: 16px; font-weight: bold;opacity: .8;"> Pay By Challan </ul>
		  <input type="hidden" name="st" value="<?php echo e($stndn); ?>">
		  <input type="hidden" name="ac" value="<?php echo e($acnnod); ?>">
		  <ul>
			<li><label><?php echo e(__('messages.chananNumber')); ?></label><label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="challan_number" id="challan_number" style="margin-left: 14px; width: 167px;"  maxlength="15"></label></li>
			<li><label><?php echo e(__('messages.challanDateSub')); ?></label>&nbsp;&nbsp;&nbsp;<label><input type="text" name="challan_date"  id="challan_date"  readonly style="width: 167px;margin-left: 5px;"></label></li>
			<li><label><?php echo e(__('messages.ChallanReceipt')); ?></label><label>&nbsp;&nbsp;&nbsp;<input type="file" name="file" id="challan_receipt" style="margin-left: 60px; width: 97px;" ></label></li> 
		 ...
		 <div style="text-align:center;display:none;" id="previewId">
		  ...
		  <?php echo e(__('messages.Submit')); ?> </button><br> <br>
		  &nbsp; &nbsp; &nbsp;	
	  ...
	  <div class="foot-highlight" style="background: white;"> 
		 ...
		 <ul style=" margin-top: 29px;">
			...
			<button type="submit" class="btn dark-pink-btn" style="height: 30px;" onclick="return payByCashSubmit();">  <?php echo e(__('messages.Submit')); ?></button>
		 </ul>
	  </div>
		...
		<div class="foot-highlight"> 
         <div class="orSparate" style="width: 50px;">  <?php echo e(__('messages.OR')); ?> </div>
		 <i class="fa fa-check-square-o" aria-hidden="true"></i>
		<?php echo e(__('messages.payByGateway')); ?>  <span class="btn btn-outline-primary btn-sm" onclick="return showHidePay('2');">
		 <?php echo e(__('messages.SubBy')); ?> </span>
		 </div>
		 <?php endif; ?>		  
		...
		<div class="foot-highlight"> 
         <div class="orSparate" style="width: 50px;">  <?php echo e(__('messages.OR')); ?> </div>
		 <i class="fa fa-check-square-o" aria-hidden="true"></i>
		<?php echo e(__('messages.payByGateway')); ?>  <span class="btn btn-outline-primary btn-sm" onclick="return showHidePay('3');">
		 <?php echo e(__('messages.SubBy')); ?> </span>
		 </div>
		 <?php endif; ?>		  
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
          ...
          <h5 class="modal-title"><?php echo e($candidate_name); ?></h5>
		<div class="header-caption">
		  <p><?php echo e(__('messages.Succcanpre')); ?></p>	
		</div>		
        </div>
        <!-- Modal body -->
        <div class="modal-body">
          <ul>
			...
			<!--<li><label><?php echo e(__('csa.Status')); ?>:</label> <span><?php echo e($appoinment_status); ?></span></li>-->
		 </ul>
  ...
  <!-- Bank Details-->
	<div class="modal fade" id="bankDetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	  aria-hidden="true">
	  <form name="cancel_form" id="cancel_form" method="POST"  action="<?php echo e(url('/nomination/save-bank-prev')); ?>" autocomplete='off' enctype="x-www-urlencoded">
     <?php echo e(csrf_field()); ?>

	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header pop-header">
			<h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('csa.Bank_Details')); ?></h5>
		  ...
		  <div class="modal-body">  
          <table>
          	<tr><td><?php echo e(__('csa.Name_as_account')); ?>:</td> <td><input type="text" name="candidate_name" id="candidate_name" value="<?php if(!empty($bank[0]->candidate_name)){ echo $bank[0]->candidate_name; }  ?>"></td></tr>
          	<tr><td><?php echo e(__('csa.Bank_Name')); ?>:</td> <td><input type="text" name="bank_name" id="bank_name" value="<?php if(!empty($bank[0]->bank_name)){ echo $bank[0]->bank_name; }  ?>"></td></tr> 
          	<tr><td><?php echo e(__('csa.Account_Number')); ?>:</td> <td><input type="number" name="account_number"  id="account_number" value="<?php if(!empty($bank[0]->account_number)){ echo $bank[0]->account_number; }  ?>" min="8"></td></tr>
          	<tr><td><?php echo e(__('csa.Confirm_Account_Number')); ?>:</td> <td><input type="number" name="confirm_account_number"  id="confirm_account_number"  value="<?php if(!empty($bank[0]->confirm_account_number)){ echo $bank[0]->confirm_account_number; }  ?>" min="8"></td></tr>
          	<tr><td><?php echo e(__('csa.IFSC')); ?>:</td> <td><input type="text" name="ifsc_code"  id="ifsc_code" value="<?php if(!empty($bank[0]->ifsc_code)){ echo $bank[0]->ifsc_code; }  ?>" min="5"></td></tr>
		  </table>	
		</div>
		  <div class="modal-footer">
			<button type="button" class="btn btn-secondary" data-dismiss="modal" style="background:#f0587e; border: none;"><?php echo e(__('step1.Cancel')); ?></button>
			<button type="submit" class="btn btn-primary" style="background: #bb4292; border: none;" onclick="return valBank();"><?php echo e(__('csa.Submit')); ?></button>
		  </div>
		</div>
	  </div>
	  </form>
...
//die;
			...
			?>
				...
				<form method="post" id="paymentred" name="paymentred" action="<?php echo e($url); ?>">
						<input type="hidden" name="demand" id="demand" value="<?php echo e($demand); ?>">
						<input type="hidden" name="encdata" value="<?php echo e($encdata); ?>">
					</form>
	...
	<form method="post" id="paymentred" name="paymentred" action="<?php echo e($url); ?>">
		<input type="hidden" name="encData" id="encrypt_pun" value="<?php echo e($enc_data_pun); ?>">
		<input type="hidden" name="clientId" value="<?php echo e($clientId); ?>">
		<input type="hidden" name="clientSecret" value="<?php echo e($clientSecret); ?>">
		<input type="hidden" name="integratingAgency" value="<?php echo e($integratingAgency); ?>">
		<input type="hidden" name="transactionID" value="<?php echo e($reff_no); ?>">
		<input type="hidden" name="ipAddress" value="<?php echo e($ip); ?>">
	</form>
...
<?php }else if($payState=='S08'){  // Himachal Pradesh
 ...
 ?>
	...
	<form method="post" id="paymentred" name="paymentred" action="<?php echo e($url); ?>">
		<input type="hidden" name="encdata" id="encrypt_him" value="<?php echo e($encdata); ?>">
		<input type="hidden" name="merchant_code" value="<?php echo e($merchant_code); ?>">
	</form>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
		  <?php if($payment_response=='Success'): ?>
		  <div class="animte-tick"><span>&#10003;</span></div>	
		  <?php elseif($payment_response=='Failed'): ?>
		  <div class="animte-tick failed-tick"><span>&#215;</span></div>
		  <?php elseif($payment_response=='Pending'): ?>
          ...
          <h5 class="modal-title"><?php echo e($candidate_name); ?>,</h5>
		<div class="header-caption">
		  <p id="challanMessage1"><?php echo e($pay_message); ?>.</p>	
		</div>		
        </div> 
		<br>
		<?php if($payment_response=='Success'): ?>
		<span style="text-align: center;" id="txtchalan1"><?php echo e(__('step1.nowFina')); ?></span> 
		<div class="text-center py-3"><a id="txt_final1" href="#" class="btn btn-success btn-big"  onclick="return moveLoader('<?php echo $stndn;  ?>','<?php echo $acnnod; ?>');"><?php echo e(__('messages.fn')); ?></a>
		&nbsp; &nbsp; &nbsp;
		
		<span class="confirm-footer">
		  <button type="button" class="btn dark-pink-btn" data-dismiss="modal"><?php echo e(__('step1.Cancel')); ?></button>
        </span>
		</div>
		<?php else: ?>
...
<!-- Modal confirm schedule -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
          ...
          <h5 class="modal-title"><?php echo e($candidate_name); ?>,</h5>
		<div class="header-caption">
		  <p style="color:red;font-size:20px;"><?php echo e(__('messages.pleasePDF')); ?></p>	
		</div>		
        </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
          ...
          <h5 class="modal-title"><?php echo e($candidate_name); ?>,</h5>
		<div class="header-caption">  
		  <p id="challanMessage3"><?php echo e(__('messages.payByCashSucc')); ?></p>	
		</div>		
        </div>
		<br>
		<span style="margin-left:60px;text-align:center;" id="txtchalan3"><?php echo e(__('step1.nowFina')); ?></span> 
		
		 <span style="text-align: center;display:none;margin-left: 9em;" id="L123">
			 <img src="<?php echo e(asset('appoinment/loader.gif')); ?>" height="70" width="70"></img> &nbsp; <?php echo e(__('nomination.Please_Wait')); ?>

		  </span>
		<div class="text-center py-3"><a id="txt_final3" href="#" class="btn btn-success btn-big"  onclick="return moveLoader('<?php echo $stndn;  ?>','<?php echo $acnnod; ?>');"><?php echo e(__('messages.fn')); ?></a>
		&nbsp; &nbsp; &nbsp;
		
		<span class="confirm-footer">
		  <button type="button" id="c123" class="btn dark-pink-btn" data-dismiss="modal"><?php echo e(__('step1.Cancel')); ?></button>
        </span>
 ...
 <!-- Modal confirm schedule -->
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
       <div class="pop-header pt-3 pb-1">
          ...
          <h5 class="modal-title"><?php echo e($candidate_name); ?>,</h5>
		<div class="header-caption">
		  <p id="challanMessage"><?php echo e(__('messages.challanSUcc')); ?></p>	
		</div>		
        </div>
		<br>
		<span style="margin-left:60px;text-align:center;" id="txtchalan"><?php echo e(__('step1.nowFina')); ?></span> 
		...
		<div class="text-center py-3"><a id="txt_final" href="#" class="btn btn-success btn-big"  onclick="return moveLoader('<?php echo $stndn;  ?>','<?php echo $acnnod; ?>');"><?php echo e(__('messages.fn')); ?></a>
		&nbsp; &nbsp; &nbsp;
		
		  <button type="button" id="c333" class="btn dark-pink-btn" data-dismiss="modal"><?php echo e(__('step1.Cancel')); ?></button>
		<span class="confirm-footer">
        </span>
	...
	<script src="<?php echo e(asset('appoinment/js/week-scheduale.php')); ?> " ></script>	
	 ...
	 <script type="text/javascript">  
		...
		$("#checkPdStatus").click(function(){
			...
			if(getGrn !=''){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo e(url('payment-verification-pd')); ?>",
					data: {
		...
		$("#checkTmStatus").click(function(){
			...
			if(getGrn !=''){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo e(url('payment-verification-tm')); ?>",
					data: {
		...
		$("#printPdChallan").click(function(){
			...
			if(getGrn !=''){
				...
				$.ajax({
					type: "POST",
					url: "<?php echo e(url('print-challan-pd')); ?>",
	   ...
	   j(document).ready(function() {
		...
		function submitChallan(){
		 ...
		 function redirect_gujrat(){
			...
			$.ajax({
				...
				data: {
					"_token": "<?php echo e(csrf_token()); ?>",
					"sId": "<?php echo e($Guj_state); ?>",
					"dist_code": "<?php echo e($dist_code); ?>",
					"ac":  "<?php echo e($Guj_AC); ?>",
					"amount1": "<?php echo e($Total_amount); ?>",
					"txn_amount": "<?php echo e($Total_amount); ?>",
					"reff_no": "<?php echo e($Transaction_id); ?>"
					},
				dataType: "html",
				success: function(msg){ 
				  if(msg==1){
		...
		function redirectPayment(){
			...
			$.ajax({
				...
				data: {
					"_token": "<?php echo e(csrf_token()); ?>",
					"sId": "<?php echo e($st_save); ?>",
					"dist_code": "<?php echo e($dist_code); ?>",
					"ac":  "<?php echo e($ac_save); ?>",
					"amount": "<?php echo e($amount); ?>",
					"txn_amount": "<?php echo e($amount); ?>",
					"reff_no": "<?php echo e($reff_no); ?>",
					"depositor_name": "<?php echo e($depositor_name); ?>",
					"depositor_address": "<?php echo e($address); ?>",
					"challanno": "<?php echo e($challanno); ?>"
					},
				dataType: "html",
				success: function(msg){			
					msg = JSON.parse(msg)
...
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/nomination/prev.blade.php ENDPATH**/ ?>