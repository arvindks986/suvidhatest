<?php $__env->startSection('title', 'Affidavit Education Details'); ?> <?php $__env->startSection('content'); ?>
<style type="text/css">
 ...
 <div class="container-fliud">
        <div class="step-wrap mt-4">
            <ul class="affidavit_nav">
                ...
                <li class="step-current"><b>&#10004;</b><span><a href="<?php echo e(url($menu_action.'education')); ?>"><?php echo e(Lang::get('affidavit.education')); ?></a></span></li>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-md-12">
                                <h4 class="main_heading"><?php echo e(Lang::get('affidavit.education')); ?></h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <!-- New design implement -->
                            <div class="accordion_head"><?php echo e(Lang::get('affidavit.education')); ?><span class="plusminus">+</span></div>
                                        ...
                                        <tbody>                                
                                             <?php if(!empty($education)): ?>
                                                ...
                                                <tr id="tr<?php echo e($row->id); ?>">
                                                    ...
                                                    <td><?php echo e($row->full_form_course); ?></td>     
                                                    <td><?php echo e($row->school_college); ?></td>     
                                                    <td><?php echo e($row->board_univ); ?></td>
                                                    <td><?php echo e($row->q_year); ?></td>     
                                                    <td nowrap="nowrap">
                                                        <a href="javascript:void(0)" class=" btn btn-info btn-sm" title="<?php echo e(Lang::get('affidavit.edit')); ?>" onclick="javascript:open_modal(<?php echo e($row->id); ?>)"
                                                        data-qualification="<?php echo e($row->qualification); ?>"
                                                        data-full_form_course="<?php echo e($row->full_form_course); ?>"
                                                        data-school_college="<?php echo e($row->school_college); ?>"
                                                        data-board_univ="<?php echo e($row->board_univ); ?>"
                                                        data-q_year="<?php echo e($row->q_year); ?>"
                                                        data-candidate_id="<?php echo e($row->candidate_id); ?>"
                                                        id="edit_education<?php echo e($row->id); ?>">
                                                    <i class="fa fa-edit"></i> <?php echo e(Lang::get('affidavit.edit')); ?>

                                                </a>
												<?php if(Auth::user()->role_id != '19'): ?>
                                                <a href="javascript:void(0)" class="btn btn-danger btn-sm" title="<?php echo e(Lang::get('affidavit.delete')); ?>" onclick="javascript:delete_education(<?php echo e($row->id); ?>)">
										  ...
										  <?php if(Auth::user()->role_id != '19'): ?>
                                            ...
                                            <tr id="education">
                                                ...
                                                <td>
                                                    <input type="text" name="qualification" id="qualification" class="form-control" required="required" onkeypress="return blockSpecialChar_name(event)">
                                                </td>
                                                
                                                <td>
                                                    <input type="text"  name="full_form_course" class="form-control" id="full_form_course" required="required" onkeypress="return blockSpecialChar_name(event)">
                                                </td>
                                                
                                                <td>
                                                    <input type="text" class="form-control"  name="school_college" id="school_college"required="required" onkeypress="return blockSpecialChar_name(event)">
                                                </td>   
                                                
                                                <td>
                                                    <input type="text" class="form-control" name="board_univ" id="board_univ" required="required" onkeypress="return blockSpecialChar_name(event)">
                                                </td>
                                                ...
                                                <td> 
                                                  <a href="javascript:void(0)" title="Edit" id="save" onclick="javascript:save_education()" >
                                                    <span class=" btn btn-info btn-sm"><i class="fa fa-check"></i> <?php echo e(Lang::get('affidavit.save')); ?></span>
                                                </a>
                                                </td>
                                            </tr>
                                        </form>
                        ...
                        <div class="card-footer footerSection">
                            <div class="row">                               
                                <div class="col-12">
                                    <a href="<?php echo e(url($menu_action.'Profession')); ?>" class="float-left backBtn"><?php echo e(Lang::get('affidavit.back')); ?></a>
                                    <a href="<?php echo e(url($menu_action.'preview')); ?>" type="submit" class="float-right nextBtn"><?php echo e(Lang::get('affidavit.save')); ?> &amp; <?php echo e(Lang::get('affidavit.next')); ?></a>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(Lang::get('affidavit.edit_educational_qualification_details')); ?></h5>
      ...
      <div class="modal-body">
        <form id="education_model">
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="Qualification"><?php echo e(Lang::get('affidavit.qualification')); ?>:</label>
                        <input type="text" class="form-control" name="modal_qualification" id="modal_qualification" required="required" onkeypress="return blockSpecialChar_name(event)">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        <label for="Full Form Certificate/Deploma/Degree/Course"><?php echo e(Lang::get('affidavit.full_form_certificate')); ?>:</label>
                        <input type="text" class="form-control" name="modal_full_form_course" id="modal_full_form_course" required="required" onkeypress="return blockSpecialChar_name(event)">
                    </div>
                </div>
            </div>
            <div class="row">
				...
				<div class="col-md-6">
                    <div class="form-group">
                        <label for=""><?php echo e(Lang::get('affidavit.school_college')); ?>:</label>
						<input type="text" class="form-control" name="modal_school_college" id="modal_school_college" required="required" onkeypress="return blockSpecialChar_name(event)">
                    </div>
                </div>
				
				<div class="col-md-6">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label"><?php echo e(Lang::get('affidavit.board_university')); ?>:</label>
						<input type="text" class="form-control" name="modal_board_univ" id="modal_board_univ" required="required" onkeypress="return blockSpecialChar_name(event)">
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="recipient-name" class="col-form-label"><?php echo e(Lang::get('affidavit.year_of_completion')); ?>:</label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="javascript:update_education()"><?php echo e(Lang::get('affidavit.update')); ?></button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade coustoModal" id="deleteAgriculturalLandModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><?php echo e(Lang::get('affidavit.delete_educational_qualification_details')); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" onclick="javascript:delete_education_entry()"><?php echo e(Lang::get('affidavit.yes')); ?></button>
      </div>
    </div>
  </div>
</div>
...
{	
	...
	$.ajax({
        url: "<?php echo e(url('save_education')); ?>",
        type: 'GET',
        data: { 
...
function update_education()
{
  ...
  if(validate("education_model")){
    $.ajax({
        url: "<?php echo e(url($menu_action.'update_education')); ?>",
        type: 'GET',
        data: { 
                id:id, 
                qualification:qualification, 
...
function delete_education_entry()
{
   ...
   {
        $.ajax({
            url: "<?php echo e(url('delete_education')); ?>",
            type: 'GET',
            data: {  id:id },            
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            success:function(data){
...
$(document).ready(function(){
    $('#full_form_course').on('keydown keyup change', function(){
        ...
        if(charLength < minLength){
			$('#full_form_course').after('<span class="err" id="span_full_form_course"><?php echo e(Lang::get("affidavit.length_is_short_minimum_required")); ?></span>');      
...
<?php echo $__env->make( (Auth::user()->role_id != '19') ? 'layouts.theme' : 'admin.layouts.ac.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/affidavit/affidavit_education.blade.php ENDPATH**/ ?>