                ...
                <div class="alert alert-danger">
                    <ul>
                        <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li><span style="color: #D04A8A;margin-right: 10px;"><?php echo e($index+1); ?></span><?php echo e($error); ?></li>
...
<?php if(Auth::user()->role_id == '19'){
 ...
 <div class="step-wrap mt-4">
            <ul class="affidavit_nav">
                ...
                <li class="step-current"><b>&#10004;</b><span><a href="<?php echo e(url($menu_action.'affidavit/candidatedetails')); ?>"><?php echo e(Lang::get('affidavit.candidate_details')); ?></a></span></li>
    ...
    <div class="card">
        <div class="card-header text-center bdr-0">
            ...
            <div class="">
                <h4><?php echo e(Lang::get('affidavit.form2b')); ?></h4>
                <div><?php echo e(Lang::get('affidavit.see_rule_4')); ?></div>
                <div class="mt-2"><?php echo e(Lang::get('affidavit.affidavit_to_be_furnished_by_the_candidate_alongwith')); ?></div>
            </div>
        </div>
        <form id="election_form" method="POST" onsubmit="return validateCandidate()" action="<?php echo e(url($action)); ?>" autocomplete="off" enctype="multipart/form-data" accept-charset="ISO-8859-1"><?php echo e(csrf_field()); ?>

        <input type="hidden" name="TblId" value="<?php echo e(Session::get('affidavit_id')); ?>" id="getTblId">
        <div class="card-body">
            <div class="accordion_head candidate_slide"><?php echo e(Lang::get('affidavit.candidate_details')); ?><span class="plusminus">+</span></div>
				...
				<div class="form-group ">                 
                    <div class="browse_image_outer">
                      <div class="avatar-upload btn file-frame">
                              <img src="<?php if(@$session_data->cimage): ?> <?php echo e(url($session_data->cimage)); ?> <?php elseif(@$nomination_data->image): ?> <?php echo e(url($nomination_data->image)); ?> <?php else: ?> <?php echo e(url('img/vendor/avtar.jpg')); ?> <?php endif; ?>" class="img-responsive">
                              <button class="file btn" type="button">Browse <i class="fa fa-upload"></i></button>
                              <input type="hidden" name="userImage" id="file" class="image" value="<?php if(@$session_data->cimage): ?> <?php echo e($session_data->cimage); ?> <?php elseif(@$nomination_data->image): ?>  <?php echo e(@$nomination_data->image); ?> <?php endif; ?>">
							  <?php if($errors->has('userImage')): ?>
								<span class="text-danger"><?php echo e($errors->first('userImage')); ?></span>
							  <?php endif; ?>
                  ...
                  <!--  <div class="form-group">
                            <div class="fullwidth float-right" style="width: 100%;">
                                <div class="browse_image_outer">
                                    <div class="avatar-upload btn file-frame">
                                        <img src="<?php if(@$session_data->cimage): ?> <?php echo e(asset('affidavit/uploads/').'/'.$session_data->cimage); ?> <?php endif; ?>" class="img-responsive" />
                                        <!-- <button class="file btn" type="button">Browse <i class="fa fa-upload"></i></button> -->
                                      <!--  <input type="file" name="userImage" value="" id="file" accept="image/*" class="file inputFile">
                                         <input type="hidden" name="image_has" class="image"  value="<?php if(@$session_data->cimage): ?><?php echo e($session_data->cimage); ?><?php endif; ?>" />
                                    </div>
                                    <?php if($errors->has('userImage')): ?>
                                    <span class="text-danger"><?php echo e($errors->first('userImage')); ?></span>
                                    <?php endif; ?>
                        ...
                        <fieldset class="py-4 px-5 mb-4 mt-5">
                            <legend><?php echo e(Lang::get('affidavit.election')); ?></legend>

                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="lbl-mandry"><?php echo e(Lang::get('affidavit.for_election_to')); ?></label>
                                        <input type="text" value="General Election to Legislative Assembly" class="form-control nomination-field-2" readonly="readonly" />
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="lbl-mandry"><?php echo e(Lang::get('affidavit.for_state')); ?></label>
                                        <input type="text" placeholder="" value="<?php if(@$session_data->st_code): ?><?php echo e(getstatebystatecode(@$session_data->st_code)->ST_NAME); ?> <?php endif; ?>" readonly="" class="form-control" />
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="lbl-mandry"><?php echo e(Lang::get('affidavit.form_name_of_the_consituency')); ?></label>
                                        <input type="text" readonly="" value="<?php if(@$session_data->st_code): ?><?php echo e(getpcbypcno(@$session_data->st_code,@$session_data->pc_no)->PC_NAME); ?><?php endif; ?>" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.name_of_the_candidate')); ?></label>
                                        <input readonly="" value="<?php echo e(@$session_data->cand_name); ?>"class="form-control nomination-field-2"/>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="">
                                            <span class="d-block">
											<input type="radio" name="relation_name" value="1" <?php if(@$session_data->relation_name == '1') echo 'checked="checked"'; ?> /> <?php echo e(Lang::get('affidavit.son_of')); ?> 
											<input type="radio" name="relation_name" value="2" <?php if(@$session_data->relation_name == '2') echo 'checked="checked"'; ?> /> <?php echo e(Lang::get('affidavit.daughter_of')); ?> 
											<input type="radio" name="relation_name" value="3" <?php if(@$session_data->relation_name == '3') echo 'checked="checked"'; ?> /> <?php echo e(Lang::get('affidavit.wife_of')); ?></span>
                                        </label>
                                        <input type="text" onkeypress="return blockSpecialChar_name(event)" name="son_daughter_wife_of" id="son_daughter_wife_of" class="form-control" value="<?php echo e($user_profile_data->father_name); ?>">
                                        <?php if($errors->has('son_daughter_wife_of')): ?>
                                          <span class="text-danger"><?php echo e($errors->first('son_daughter_wife_of')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><input type="radio" name="dateofborth_remember" id="rememberDOB1" class="dateofborth_remember" value="1"/> <?php echo e(Lang::get('affidavit.i_remember_my_date_of_birth')); ?></label>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="">
                                            <input type="radio" name="dateofborth_remember" value="2" class="dateofborth_remember" <?php if($user_profile_data->age!=""){ echo "checked"; } ?> /> <?php echo e(Lang::get('affidavit.i_do_not_remember_my_date_of_birth')); ?></label>
                                          
                                        <input type="text" name="age" id="age" placeholder="enter your Age" class="form-control removespecialcharacter" maxlength="2" value="<?php echo e($user_profile_data->age); ?>">
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.address_mention_full_postel_address')); ?></label>
                                        <textarea name="postal_address" id="postal_address" onkeypress="return blockSpecialChar_address(event)" placeholder="Please enter your adddress" class="form-control"><?php echo e($user_profile_data->address); ?>, 



                                         <?php echo e(getstatebystatecode($user_profile_data->state)->ST_NAME); ?></textarea>
                        ...
                        <fieldset class="py-4 px-5 mt-2 mb-4">
                            <legend><?php echo e(Lang::get('affidavit.party_information')); ?></legend>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label" for="exampleRadios1">
                                            <?php echo e(Lang::get('affidavit.i_am_candidate_setup_by_the_political_party')); ?>
                                ...
                                <div class="col-sm-6 ">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.select_party_type')); ?>:</label>
                                        <select class="form-control" onchange="getPoliticalParty(this.value)" name="party_type" id="party_type">
                                            <option value="">--<?php echo e(Lang::get('affidavit.select_party')); ?>--</option>
                                            <option value="N" <?php if((@$session_data->partytype == 'N') || (@$nomination_data['PARTYTYPE']->PARTYTYPE == 'N')) echo 'selected="selected"'; ?>><?php echo e(Lang::get('affidavit.national_party')); ?></option>
                                            <option value="S" <?php if((@$session_data->partytype == 'S') || (@$nomination_data['PARTYTYPE']->PARTYTYPE == 'S')) echo 'selected="selected"'; ?>><?php echo e(Lang::get('affidavit.state_party')); ?></option>
                                            <option value="U" <?php if((@$session_data->partytype == 'U') || (@$nomination_data['PARTYTYPE']->PARTYTYPE == 'U')) echo 'selected="selected"'; ?>><?php echo e(Lang::get('affidavit.unrecognized_party')); ?></option>
                                        </select>
                                        <?php if($errors->has('party_type')): ?>
                                          <span class="text-danger"><?php echo e($errors->first('party_type')); ?></span>
                                        <?php endif; ?>
                                        <span id="error_party_type_address"></span>
                                        <div id='political_party_loding' style='display: none;'>
                                            <img src="<?php echo e(asset('img/loading-img.gif')); ?>" width='60px' height='60px'>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.name_of_the_political_party')); ?>:</label>
                                        <select name="political_party" id="political_party" class="form-control">
											<?php if(isset($session_data['partyData']) && $session_data['partyData']): ?>
												<?php $__currentLoopData = $session_data['partyData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e($data->CCODE); ?>" <?php if(($session_data->partyabbre == $data->CCODE) || (@$nomination_data->party_id == $data->CCODE)) echo 'selected="selected"'; ?>><?php echo e($data->PARTYNAME); ?> - <?php echo e($data->PARTYHNAME); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											<?php elseif(isset($nomination_data['partyData']) && $nomination_data['partyData']): ?>
												<?php $__currentLoopData = $nomination_data['partyData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<option value="<?php echo e(@$data->CCODE); ?>" <?php if(@$nomination_data->party_id == @$data->CCODE) echo 'selected="selected"'; ?>><?php echo e(@$data->PARTYNAME); ?> - <?php echo e(@$data->PARTYHNAME); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											<?php else: ?>
												<option value="">-<?php echo e(Lang::get('affidavit.select_party_name')); ?>-</option>
											<?php endif; ?>
										
                                            
                                        </select>
                                        <span id="political_party_error"></span>
                                        <?php if($errors->has('political_party')): ?>
                                          <span class="text-danger"><?php echo e($errors->first('political_party')); ?></span>
                                        <?php endif; ?>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-check mt-3">
                                        ...
                                        <label class="form-check-label" for="exampleRadios2">
                                            <?php echo e(Lang::get('affidavit.i_am_candidate_contesting_as_an_independent_candidate')); ?>
                        ...
                        <fieldset class="py-4 px-5 mt-2 mb-4">
                            <legend><?php echo e(Lang::get('affidavit.my_name_is_enrolled_in')); ?></legend>
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.state')); ?>:</label>
                                        <?php if(Session::get('st_code_by_epic')!=""): ?>
                                            <input readonly="readonly" type="text" name="state_name_epic" id="state_name_epic" class="form-control" value="<?php echo e(Session::get('st_name_by_epic')); ?>">

                                            <input type="hidden" id="st_code_from_epic" name="st_code_from_epic" value="<?php echo e(Session::get('st_code_by_epic')); ?>">

                                        <?php else: ?>
                                            <input readonly="readonly" type="text" name="state_name_epic" id="state_name_epic" class="form-control" value="<?php echo e(getstatebystatecode($user_profile_data->state)->ST_NAME); ?>">

                                            <input type="hidden" id="st_code_from_epic" name="st_code_from_epic" value="<?php echo e($user_profile_data->state); ?>">
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.const')); ?>:</label>
                                        <?php if(Session::get('ac_no_by_epic')!=""): ?>
                                            <input readonly="readonly" value="<?php echo e(Session::get('ac_name_by_epic')); ?>" type="text" name="ac_name_epic" id="ac_name_epic" class="form-control">
                                            <input type="hidden" id="ac_code_from_epic" name="ac_code_from_epic" value="<?php echo e(Session::get('ac_no_by_epic')); ?>">
                                        <?php else: ?>
                                        
                                            <input readonly="readonly" type="text" name="ac_name_epic" id="ac_name_epic" class="form-control" value="<?php echo e(getpcbypcno($user_profile_data->state,$nomination_data->pc_no)->PC_NAME); ?>">

                                            <input type="Hidden" id="ac_code_from_epic" name="ac_code_from_epic" value="<?php echo e($nomination_data->pc_no); ?>">
                                        <?php endif; ?>                                    
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""> <?php echo e(Lang::get('affidavit.part_number')); ?>:</label>
                                        <?php if(Session::get('part_number_by_epic')!=""): ?>
                                            <input maxlength="10" type="text" value="<?php echo e(Session::get('part_number_by_epic')); ?>" class="form-control removespecialcharacter" id="part_number" name="part_number" readonly="readonly">
                                        <?php else: ?>
                                            <input maxlength="10" type="text" value="<?php echo e($user_profile_data->part_no); ?>" class="form-control removespecialcharacter" id="part_number" name="part_number" readonly="readonly">
                                        <?php endif; ?>    
                                    </div>
                                </div>
                                <div class="col-sm-6 col-12">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.serial_no')); ?>:</label>
                                        <?php if(Session::get('serial_no_by_epic')!=""): ?>
                                            <input maxlength="10" type="text" value="<?php echo e(Session::get('serial_no_by_epic')); ?>" class="form-control removespecialcharacter" id="serial_no" name="serial_no" readonly="readonly">
                                        <?php else: ?>
                                            <input maxlength="10" type="text" value="<?php echo e($user_profile_data->serial_no); ?>" class="form-control removespecialcharacter" id="serial_no" name="serial_no" readonly="readonly">
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset class="py-4 px-5 mt-2 mb-4">
                            <legend><?php echo e(Lang::get('affidavit.my_contact')); ?></legend>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class="lbl-mandry"><?php echo e(Lang::get('affidavit.mobile_number')); ?></label>

                                        <div class="clearfix"></div>

                                            <div class="inputLeftSide">
                                        <input maxlength="10" type="text" value="<?php echo e($user_profile_data->mobile); ?>" name="mobile_number" class="form-control removespecialcharacter" placeholder="Enter mobile number" id="mobile_number_check">
                                        ...
                                        <div id='checkbtn_loding' style='display: none;'>
                                            <img src="<?php echo e(asset('img/loading-img.gif')); ?>" width='70px' height='70px'>
                                        </div>
                                ...
                                <div class="inputRightSide">
                                     <button id="VerifyMobileNo" class="btn btn-sm btn-success" type="button"><?php echo e(Lang::get('affidavit.verify_mobile_no')); ?></button>
                                    <input type="hidden" name="hidden_mobile_no" id="hidden_mobile_no" value="<?php echo e($user_profile_data->mobile); ?>">
                                    </div>
                                </div>
                              <div class="col-sm-6">
                                    <div class="form-group mt-2 mb-2">
                                        <label for="" class=""><?php echo e(Lang::get('affidavit.landline_number')); ?></label>
                                        <div class="clearfix"></div>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-check mt-2 mb-2">
                                        ...
                                        <label class="form-check-label" for="exampleRadios3">
                                            <?php echo e(Lang::get('affidavit.i_have_an_e_mail_account')); ?>
                                    ...
                                    <div id="emailID" class="form-group mt-2 mb-2">
                                        <label for="" class="lbl-mandry"><?php echo e(Lang::get('affidavit.enter_e_mail_id')); ?></label>
                                        <div class="clearfix"></div>

                                     <div class="inputLeftSide">
                                        <input type="email" name="email_address" id="email_address" class="form-control" placeholder="enter emailid" value="<?php echo e($user_profile_data->email); ?>" />
                                    ...
                                    <div class="inputRightSide">
                                        <button id="VerifyEmailId" class="btn btn-success btn-sm" type="button"><?php echo e(Lang::get('affidavit.verify_e_mail_id')); ?></button>
                                        <input type="hidden" name="hidden_email_id" id="hidden_email_id" value="<?php echo e($user_profile_data->email); ?>">
                                    </div>
                                    <!-- email section -->
                                ...
                                <div class="col-sm-6">
                                    <div class="form-check mt-2 mb-2">
                                        ...
                                        <label class="form-check-label" for="exampleRadios4">
                                            <?php echo e(Lang::get('affidavit.i_do_not_have_an_e_mail_account')); ?>
                        ...
                        <fieldset class="py-4 px-5 mt-2 mb-4">
                            <legend><?php echo e(Lang::get('affidavit.self_spouse_dependent_huf_details')); ?></legend>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-info table-bordered purpleTable" id="userTableDependentDetails">
                                            ...
                                            <tbody>
                                                <tr id="lefttr">
                                                    <td><?php echo e(Lang::get('affidavit.self')); ?></td>
                                                    <td><?php echo e(Lang::get('affidavit.self')); ?></td>
                                                    <td><?php echo e(Session::get('cand_name')); ?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <?php if($get_candidate_detail_data): ?>
                                                    <?php $__currentLoopData = $get_candidate_detail_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pan_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr id="relation<?php echo e($pan_row->id); ?>">
                                                            <td><?php echo e($pan_row->relation_type); ?></td>
                                                            <td><?php echo e($pan_row->relation); ?></td>
                                                            <td><?php echo e($pan_row->name); ?></td>
                                                            <td><input type='button' value='Edit' class='editpersonalrecord btn btn-success btn-sm mt-1 mr-1' data-id='<?php echo e($pan_row->id); ?>' data-relation_type_code='<?php echo e($pan_row->relation_type_code); ?>' data-relation_code='<?php echo e($pan_row->relation_code); ?>'  data-name='<?php echo e($pan_row->name); ?>'>
															 <?php if(Auth::user()->role_id != '19'): ?>
															 <a href="javascript:void(0)" class="btn btn-info btn-danger btn-sm" title="<?php echo e(Lang::get('affidavit.delete')); ?>" onclick="javascript:delete_spouse(<?php echo e($pan_row->id); ?>)">
                                                ...
                                                <tr>
                                                  <td>
                                                    <select class="form-control" name="relation_type" id="relation_type">
                                                        ...
                                                        <?php $__empty_1 = true; $__currentLoopData = $get_relation_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relation_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <option value="<?php echo e($relation_type->relation_type_code); ?>"><?php echo e(ucfirst($relation_type->relation_type)); ?> - <?php echo e($relation_type->relation_type_hi); ?></option>
                                                  ...
                                                  <td>
                                                    <select class="form-control" name="relation" id="relation">
                                                        <option value="">-<?php echo e(Lang::get('affidavit.select')); ?>-</option>
                                                        <?php $__empty_1 = true; $__currentLoopData = $get_cand_relation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cand_relation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <option value="<?php echo e($cand_relation->relation_code); ?>"><?php echo e(ucfirst($cand_relation->relation)); ?> - <?php echo e($cand_relation->relation_hi); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                            <option><?php echo e(Lang::get('affidavit.no_record_found')); ?></option>
                                                        <?php endif; ?>
                                                    </select>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-success btn-sm mt-1 mr-1" id="add"><?php echo e(Lang::get('affidavit.save')); ?></button>
                                                    </td>
                                                </tr>
                        ...
                        <fieldset class="py-4 px-5 mt-2 mb-4">
                            <legend><?php echo e(Lang::get('affidavit.social_media_account')); ?>:</legend>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="table-responsive">
                                        <table class="table table-info table-bordered purpleTable" id="socialMediaTable">
                                            <thead>
                                                <tr class="table-info">
                                                    ...
                                                    <th><?php echo e(Lang::get('affidavit.social_media')); ?></th>
                                                    <th><?php echo e(Lang::get('affidavit.account')); ?></th>
                                                    <th><?php echo e(Lang::get('affidavit.edit')); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody> 
                                                
                                                <?php if($cand_social_account): ?>
                                                    <?php $__currentLoopData = $cand_social_account; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rows): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr id="media_accounts<?php echo e($rows->id); ?>">
                                                            <td id="media_account<?php echo e($rows->id); ?>"><?php echo e($rows->media_account); ?></td>
                                                            <td id="other_account_name<?php echo e($rows->id); ?>"><?php echo e($rows->other_account_name); ?></td>
                                                            <td><input type='button' value='<?php echo e(Lang::get('affidavit.edit')); ?>' class='editrecord btn btn-success btn-sm mt-1 mr-1' data-id='<?php echo e($rows->id); ?>' data-media_account='<?php echo e($rows->media_account); ?>' data-other_account_name='<?php echo e($rows->other_account_name); ?>' data-social_media_code='<?php echo e($rows->social_media_code); ?>'></td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?> 
												...
												<tr>
                                                 <!--  <td>1</td> -->
                                                  <td><select class="form-control" name="social_media" id="social_media">
                                                        <option value="">-<?php echo e(Lang::get('affidavit.please_select_social_media')); ?>-</option>
                                                        <?php $__empty_1 = true; $__currentLoopData = $get_social_media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                            <option value="<?php echo e(strtolower($social_media->social_media_code)); ?>"><?php echo e(ucfirst($social_media->social_media_name)); ?> - <?php echo e($social_media->social_media_name_hi); ?></option>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                            <option><?php echo e(Lang::get('affidavit.no_record_found')); ?></option>
                                                        <?php endif; ?>
                                                ...
                                                <input type="text" id="other_social_media_account" name="other_social_media_account" class="form-control" style="display: none;">
                                                  ...
                                                  <td>
                                                        <button type="button" class="btn btn-success btn-sm mt-1 mr-1" id="socila_media_add"><?php echo e(Lang::get('affidavit.save')); ?></button>
                                                    </td>
                                                </tr>
												<?php endif; ?>
            ...
            <!-- accrodion_body -->
            <!-- End Of part-1 Div -->
            <div class="accordion_head"><?php echo e(Lang::get('affidavit.pan_details')); ?> <span class="plusminus">+</span></div>
            <div class="accordion_body" style="display: none;">
                <table class="table table-info table-bordered table-striped purpleTable " id="userTablePAN">
                    <thead>
                        <tr>
                            <th colspan="12"><strong>(2) <?php echo e(Lang::get('affidavit.details_of_pan_and_status_of_filling_of_income_tax_return')); ?>:</strong></th>
                        </tr>
                        <tr class="table-info">
                          <th rowspan="2"><?php echo e(Lang::get('affidavit.name')); ?></th>
                          <th rowspan="2"><?php echo e(Lang::get('affidavit.relation')); ?></th>
                          <th rowspan="2"><?php echo e(Lang::get('affidavit.permanent_account_number')); ?></th>
                          <th rowspan="2"><?php echo e(Lang::get('affidavit.the_financial_year_which_the_last_income_tax_return_has_been_filed')); ?></th>
                          <th colspan="5" align="center" class="text-center"><?php echo e(Lang::get('affidavit.toal_income_shown_in_income_tax_retuen')); ?></th>          
                          <th rowspan="2"><?php echo e(Lang::get('affidavit.action')); ?></th>
                        </tr>
                        <tr>
                          <th><?php echo e(Lang::get('affidavit.financial_year')); ?> 2021-2022</th>
                          <th><?php echo e(Lang::get('affidavit.financial_year')); ?> 2020-2021</th>
                          <th><?php echo e(Lang::get('affidavit.financial_year')); ?> 2019-2020</th>
                          <th><?php echo e(Lang::get('affidavit.financial_year')); ?> 2018-2019</th>
                          <th><?php echo e(Lang::get('affidavit.financial_year')); ?> 2017-2018</th>
                        </tr>
                   </thead>

                    <?php if($getPANData): ?>
                        <?php $__currentLoopData = $getPANData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$pan_row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="pan_row_relation<?php echo e($pan_row->id); ?>">
                                <td><?php echo e($pan_row->name); ?></td>
                                <td><?php echo e($pan_row->relation); ?></td>
                                <td nowrap="nowrap"><input type="text" class="form-control" value="<?php echo e($pan_row->pan); ?>" disabled></td>    
                                   
                                <td width="145"><input type="text" value="<?php echo e($pan_row->financial_year); ?>" class="form-control removespecialcharacter" disabled></td>
                                <td><input type="text" value="<?php echo e($pan_row->financialyr1); ?>" class="form-control removespecialcharacter" disabled></td>
                                <td><input type="text" value="<?php echo e($pan_row->financialyr2); ?>" class="form-control removespecialcharacter" disabled></td>
                                <td><input type="text" value="<?php echo e($pan_row->financialyr3); ?>" class="form-control removespecialcharacter" disabled></td>
                                <td><input type="text" value="<?php echo e($pan_row->financialyr4); ?>" class="form-control removespecialcharacter" disabled></td> 
                                <td><input type="text" value="<?php echo e($pan_row->financialyr5); ?>" class="form-control" disabled></td>
                                <td><input type='button' value='<?php echo e(Lang::get('affidavit.edit')); ?>' class='editpanrecord btn btn-success btn-sm mt-1 mr-1' data-id='<?php echo e($pan_row->id); ?>' data-name='<?php echo e($pan_row->name); ?>' data-relation_type_code='<?php echo e($pan_row->relation_type_code); ?>' data-relation_code='<?php echo e($pan_row->relation_code); ?>'  data-pan='<?php echo e($pan_row->pan); ?>' data-financial_year='<?php echo e($pan_row->financial_year); ?>' data-financialyr1='<?php echo e($pan_row->financialyr1); ?>' data-financialyr2='<?php echo e($pan_row->financialyr2); ?>' data-financialyr3='<?php echo e($pan_row->financialyr3); ?>' data-financialyr4='<?php echo e($pan_row->financialyr4); ?>' data-financialyr5='<?php echo e($pan_row->financialyr5); ?>'></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php endif; ?>
                    </thead>
        ...
        <div class="card-footer">
                            <div class="row">
                                <div class="col-12">
                                    <a href="<?php echo e(url($menu_action.'affidavitdashboard')); ?>" class="float-left backBtn"><?php echo e(Lang::get('affidavit.back')); ?></a>
                               
                                        <!-- <a href="<?php echo e(url('affidavit/pending-criminal-cases')); ?>" type="submit" class="float-right nextBtn"><?php echo e(Lang::get('affidavit.save')); ?> &amp; <?php echo e(Lang::get('affidavit.next')); ?></a> -->
                                        ...
                                        <a href="<?php echo e(url($menu_action.'affidavitdashboard')); ?>" class="float-right cencelBtn mr-2"><?php echo e(Lang::get('affidavit.cancel')); ?></a>
                                        &nbsp; &nbsp; &nbsp;
  ...
  <div class="modal-dialog modal-md" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="PersonalEditModalLabel"><?php echo e(Lang::get('affidavit.update_personal_detail')); ?></h5>
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleInputname"><?php echo e(Lang::get('affidavit.relation_type')); ?></label>
                    <select class="form-control" name="relation_type_update" id="relation_type_update">
                        <option value="0">-<?php echo e(Lang::get('affidavit.select_relation_type')); ?>-</option>
                    <?php $__empty_1 = true; $__currentLoopData = $get_relation_type; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relation_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <option value="<?php echo e($relation_type->relation_type_code); ?>"><?php echo e($relation_type->relation_type); ?> - <?php echo e($relation_type->relation_type_hi); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <option><?php echo e(Lang::get('affidavit.no_record_found')); ?></option>
                    <?php endif; ?>
                    </select>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.relation')); ?></label>
                    <select class="form-control" name="relation_code_update" id="relation_code_update">
                        <option value="0">-<?php echo e(Lang::get('affidavit.select_relation')); ?>-</option>
                    <?php $__empty_1 = true; $__currentLoopData = $get_cand_relation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cand_relation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <option value="<?php echo e($cand_relation->relation_code); ?>"><?php echo e($cand_relation->relation); ?> - <?php echo e($cand_relation->relation_hi); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <option><?php echo e(Lang::get('affidavit.no_record_found')); ?></option>
                    <?php endif; ?> 
                    </select>
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.name')); ?></label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updatePerbtn" onclick="updatePeronalDetail()"><?php echo e(Lang::get('affidavit.update')); ?></button>
...
<div class="modal fade" id="PANEditModal" tabindex="-1" role="dialog" aria-labelledby="PANEditModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="PANEditModalLabel"><?php echo e(Lang::get('affidavit.update_pan_details')); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleInputname"><?php echo e(Lang::get('affidavit.name')); ?></label>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <select class="form-control" name="pan_relation_code" id="relation_code" disabled="disabled">
                        <?php $__empty_1 = true; $__currentLoopData = $get_cand_relation_self; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cand_relation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <option value="<?php echo e($cand_relation->relation_code); ?>"><?php echo e($cand_relation->relation); ?> - <?php echo e($cand_relation->relation_hi); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <option><?php echo e(Lang::get('affidavit.no_record_found')); ?></option>
                        <?php endif; ?>
          ...
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.permanent_account_number')); ?></label>
          ...
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.the_financial_year_for_which_the_last_income_tax_return_has_been_filed')); ?></label>
          ...
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.total_income_shown_for_financial_year')); ?>(2021-2022)</label>
                    <input type="text" name="financialyr1" class="form-control removespecialcharacter" id="financialyr1" placeholder="<?php echo e(Lang::get('affidavit.total_income_shown')); ?>">
                </div>
                <span class="error_5_pan"></span>
          </div>
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.total_income_shown_for_financial_year')); ?>(2020-2021)</label>
                    <input type="text" name="financialyr2" class="form-control removespecialcharacter" id="financialyr2" placeholder="<?php echo e(Lang::get('affidavit.total_income_shown')); ?>">
                </div>
                <span class="error_6_pan"></span>
          </div>
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.total_income_shown_for_financial_year')); ?>(2019-2020)</label>
                    <input type="text" name="financialyr3" class="form-control removespecialcharacter" id="financialyr3" placeholder="<?php echo e(Lang::get('affidavit.total_income_shown')); ?>">
                </div>
                <span class="error_7_pan"></span>
          </div>
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.total_income_shown_for_financial_year')); ?>(2018-2019)</label>
                    <input type="text" name="financialyr4" class="form-control removespecialcharacter" id="financialyr4" placeholder="<?php echo e(Lang::get('affidavit.total_income_shown')); ?>">
                </div>
                <span class="error_8_pan"></span>
          </div>
          <div class="col-sm-4">
                <div class="form-group">
                    <label for="exampleRelation"><?php echo e(Lang::get('affidavit.total_income_shown_for_financial_year')); ?>(2017-2018)</label>
                    <input type="text" name="financialyr5" class="form-control removespecialcharacter" id="financialyr5" placeholder="<?php echo e(Lang::get('affidavit.total_income_shown')); ?>">
                </div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updatePANbtn" onclick="updatePANDetail()"><?php echo e(Lang::get('affidavit.update')); ?></button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(Lang::get('affidavit.close')); ?></button>
      </div>
      </form>
    </div>
...
<div class="modal fade" id="socialMediaModal" tabindex="-1" role="dialog" aria-labelledby="socialMediaModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="socialMediaModalLabel"><?php echo e(Lang::get('affidavit.update_social_media')); ?></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="modal-body">
        <div class="modal-body">
            <label for="tagName"><?php echo e(Lang::get('affidavit.social_media')); ?>: </label>
            <select class="form-control update_media" id="media_account_accounts" name="social_media_update">
                <?php $__empty_1 = true; $__currentLoopData = $get_social_media; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social_media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <option value="<?php echo e(strtolower($social_media->social_media_code)); ?>"><?php echo e($social_media->social_media_name); ?> - <?php echo e($social_media->social_media_name_hi); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <option><?php echo e(Lang::get('affidavit.no_record_found')); ?></option>
                <?php endif; ?>
            </select>
        ...
        <div class="modal-body">
            <label for="otherAccountName"><?php echo e(Lang::get('affidavit.account')); ?>: </label>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" id="updateSocialbtn" onclick="updateSocialMedia()"><?php echo e(Lang::get('affidavit.update')); ?></button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal"><?php echo e(Lang::get('affidavit.close')); ?></button>
      </div>
      </form>
    </div>
   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" onclick="javascript:delete_spouse_entry()"><?php echo e(Lang::get('affidavit.yes')); ?></button>
         </div>
      </div>
   </div>
</div>
...
$("#VerifyMobileNo").click(function(){
   ...
   if(mobile_no == ""){
    $("#officer_id_js_error").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_mobile_number")); ?></label>');
    flag = true;
   } else if(mobile_no.length!=10){
    $("#officer_id_js_error").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.mobile_number_length_should_be")); ?></label>');
    flag = true;
   } else if(mobile_no=='0000000000'){
    $("#officer_id_js_error").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.invalid_formate")); ?></label>');
    flag = true;
   } else {
   ...
   if(flag){
        $("#VerifyMobileNo").html('<?php echo e(Lang::get("affidavit.verify_mobile_no")); ?>');
        return false;
    }

    $.ajax({
        url: "<?php echo e(route('check.mobile.no')); ?>",
        type: 'get',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
...
$("#verifyOTPEmail").click(function(){
   ...
   if(email_address == ""){
    $("#email_id_js_error").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_email_id")); ?></label>');
    flag = true;
   } else {
   ...
   if(flag){
        $("#verifyOTPEmail").val('<?php echo e(Lang::get("affidavit.verify_otp")); ?>');
        return false;
    }

    $.ajax({
        url: "<?php echo e(route('verify.otp.emailId')); ?>",
        type: 'get',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
        ...
        success: function(response) {
            if(response.status == 200 && response.error==false){
                $("#email_verify_img").html("<img src='<?php echo e(asset('img/logo/tick.png')); ?>' width='25'>");
...
$("#VerifyEmailId").click(function(e){
    ...
    if(email_address==""){
        $("#email_id_js_error").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.enter_a_valid_email_address")); ?></label>');
        $("#email_address").focus();
        flag = true;
    ...
    if(flag){
        $("#VerifyEmailId").html('<?php echo e(Lang::get("affidavit.verify_email_id")); ?>');
        return false;
    }

    var dataString = 'email_address='+ btoa(email_address) + '&getTblId='+ btoa(getTblId);
    $.ajax({
        url: "<?php echo e(route('check.email.address')); ?>",
        type: 'get',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
...
$("#verifyOTP").click(function(e){
  ...
  if(mobile_number == ""){
    $("#officer_id_js_error").html('<span class="text-danger"><?php echo e(Lang::get("affidavit.mobile_number_cannot_be_empty")); ?></span>');
    flag = true;
  } else {
    $("#officer_id_js_error").html('');
  }
  ...
  if(otpbtn == "" && otpbtn.length!=6){
    $("#otp_js_error").html('<span class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_your_otp")); ?></span>');
    flag = true;
  } else {
    $("#otp_js_error").html('');
  }
    ...
    if(flag){
        $("#verifyOTP").html('<?php echo e(Lang::get("affidavit.verify_otp")); ?>');
        return false;
    }
    ...
    $.ajax({
            ...
            beforeSend: function(){
                ...
                if(response.status == 200 && response.error==false){
                    ...
                    $("#verifyOTP").hide();
                    $("#otp").hide();
                    $("#verify_img").html("<img src='<?php echo e(asset('img/logo/tick.png')); ?>' width='25'>");
                    $("#VerifyMobileNo").hide();
                ...
                $("#verifyOTP").val('<?php echo e(Lang::get("affidavit.verify_otp")); ?>');
               }
    });
    return false;
});
...
function updatePeronalDetail(){
	...
	*/
    ...
    $.ajax({
        url: "<?php echo e(url($menu_action.'update-personal-details')); ?>",
        type: 'post',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
...
function updatePANDetail(){
    ...
    $.ajax({
        url: "<?php echo e(url($menu_action.'table/update-pan-details')); ?>",
        type: 'post',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
...
function updateSocialMedia(){
    ...
    $.ajax({
        url: "<?php echo e(url($menu_action.'table/update_social_media')); ?>",
        type: 'post',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
...
function getPoliticalParty(party_type){
    ...
    $.ajax({
        url: "<?php echo e(route('aff.political.party')); ?>",
        type: 'get',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
        ...
        success: function(response) {
            if(response.status == 200){
                var items="";
                items += "<option value=''>--<?php echo e(Lang::get('affidavit.select_political_party_name')); ?>--</option>";
...
$(document).on('click', '#socila_media_add', function(){
    ...
    if(social_media == ""){
        $(".error_4").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_select_social_media_account")); ?></label>');
        flag = true;
    } else {
        $(".error_4").html('');
    }
     ...
     if($('#social_account').val() == ''){
        $(".error_5").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_social_account_name")); ?></label>');
        flag = true;
    } else {
        $(".error_5").html('');
    } 
    ...
    if(flag){
        $("#socila_media_add").html('<?php echo e(Lang::get("affidavit.save")); ?>');
        return false;
    }
    ...
    $.ajax({
        url: "<?php echo e(route('social_media_add_data')); ?>",
        type: 'POST',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
            ...
            if(response.status == 200){
                ...
                var len = response.result.length;
                  if(response['result'] != null){
                        ...
                        var tr_str = "<tr>" + "<td>" + social_media_name + "</td>" +"<td>" + social_account + "</td>" + "<td><input type='button' value='<?php echo e(Lang::get('affidavit.edit')); ?>' class='editrecord btn btn-success btn-sm mt-1 mr-1' data-id='"+id+"' data-social_media_code='"+social_media_code+"' data-other_account_name='"+social_account+"'  data-media_account='"+social_media+"'></td>"+ "</tr>";
...
if(relation_type == ""){
    $(".error_1").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_select_relation_name")); ?></label>');
    flag = true;
}else {
    $(".error_1").html('');
}
...
if(relation == ""){
    $(".error_2").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_select_relation")); ?></label>');
    flag = true;
}else {
    $(".error_2").html('');
}
 ...
 if($('#name').val() == ''){
    $(".error_3").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_select_name")); ?></label>');
    flag = true;
}else {
    $(".error_3").html('');
} 
...
var dataString = 'relation_type='+ relation_type + '&relation='+ relation + '&name='+name;
    ...
    $.ajax({
        url: "<?php echo e(route('table.add_data')); ?>",
        type: 'POST',
        data: dataString,
        dataType: 'json', 
        beforeSend: function() {
...
function getDistrictList(val){
    ...
    $.ajax({
        ...
        beforeSend: function(){
            ...
            var items="";
                items += "<option value=''>--<?php echo e(Lang::get('affidavit.select_district_name')); ?>--</option>";
            $.each(response.result,function(index, item) {
...
if ($('#file').val()=="") {
    ...
    $("#img_error_img").html('<p class="text-danger"><?php echo e(Lang::get("affidavit.please_select_profile_image")); ?></p>');
    $("#file").focus();     
    flag = true;
  } else {
    $("#img_error_img").html('');
...
if ($("#rememberDOB2").prop("checked")) {
   if($("#age").val()==""){
	 $(".candidate_details_slide").show(); 
     $("#error_cand_age").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_your_age")); ?></label>');
...
if ($("#rememberDOB1").prop("checked")) {
   if($("#dateofbirth").val()==""){
	 $(".candidate_details_slide").show(); 
     $("#error_cand_dbo").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_date_of_birth")); ?></label>');
  ...
  var maxLength = 100;
   ...
   if($("#son_daughter_wife_of").val() == '') {
	  $(".candidate_details_slide").show(); 
      $("#error_cand_1").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_son_daughter")); ?></label>');
      $("#son_daughter_wife_of").focus();
      flag = true;
  } else if(son_daughter_wife_of_len < minLength){
	 $(".candidate_details_slide").show(); 
    $("#error_cand_1").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.length_is_short_minimum_required")); ?></label>');
    $("#son_daughter_wife_of").focus();
    flag = true;
   ...
   if($("#postal_address").val() == '') {
	   $(".candidate_details_slide").show(); 
      $("#error_cand_address").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_enter_address")); ?></label>');
      $("#postal_address").focus();
      flag = true;
  } else if($("#postal_address").val().length < minLength){
	  $(".candidate_details_slide").show(); 
    $("#error_cand_address").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.length_is_short_minimum_required")); ?></label>');
    $("#postal_address").focus();
    flag = true;
  ...
  if($(".candidate_setup_party").is(":checked")) {
    ...
    if(radioValue == 1){
      if($("#party_type").val() == ""){
		  $(".candidate_details_slide").show(); 
        $("#error_party_type_address").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_select_party_type")); ?></label>');
        flag = true;
      } else {
      ...
      if($("#political_party").val() == ""){
		  $(".candidate_details_slide").show(); 
        $("#political_party_error").html('<label class="text-danger"><?php echo e(Lang::get("affidavit.please_select_political_party")); ?></label>');
        flag = true;
      } else {
...
<script type="text/javascript">
   function delete_spouse_entry()
   {
      ...
      {
           $.ajax({
               url: "<?php echo e(url('delete_spouse')); ?>",
               type: 'GET',
               data: {  id:id },            
...
<?php echo $__env->make( (Auth::user()->role_id != '19') ? 'layouts.theme' : 'admin.layouts.pc.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/affidavit/affidavit_candidate_details.blade.php ENDPATH**/ ?>