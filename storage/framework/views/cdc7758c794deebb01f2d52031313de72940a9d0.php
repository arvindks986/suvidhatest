    ...
    <div class="container-fliud">
        <div class="step-wrap mt-4">
            <ul class="affidavit_nav">
                ...
                <li class="step-current"><b>&#10004;</b><span><a href="<?php echo e(url($menu_action.'preview')); ?>"><?php echo e(Lang::get('affidavit.preview_finalize')); ?></a></span></li>
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="card">
                    ...
                    <div class="col-sm-10">	
                    	<h3 class="term mt-3"><?php echo e(Lang::get('affidavit.preview_finalize')); ?></h3>
	                	<div class="form-check mt-3">
							  <input class="form-check-input" type="checkbox" value="1" id="defaultCheck1">
							  <label class="form-check-label" for="defaultCheck1">
							    <?php echo e(Lang::get('affidavit.i_accept_that_all_the_fields_that_i_have')); ?>

							  </label>
						</div>
						<button onclick="return previewForm();"  class="nextBtn mt-3 float-left"><?php echo e(Lang::get('affidavit.preview')); ?></button>
					</div>
				</div>
                <div class="card-body">	
		<!--<form method="post" name="preview" action="<?php echo e(url('/finalize')); ?>" enctype="multipart/form-data">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"><?php echo e(Lang::get('affidavit.preview')); ?></h5>
      ...
      <div class="modal-body">
		...
		<div class="col-sm-12">
			<p class="text-center"> <?php echo e(Lang::get('affidavit.cilck_on_finalize')); ?></p>			 
		</div>	
      <div class="modal-footer">	 	 
      	 <!-- <a href id="" class="backBtn float-left">Back</a>-->	 	
		 
		  <button  class="cencelBtn float-left mr-2" data-dismiss="modal" ><?php echo e(Lang::get('affidavit.cancel')); ?></button>
		  <?php if(Auth::user()->role_id != '19'): ?>
		  <button  class="nextBtn float-right" onclick="return finalize();"><?php echo e(Lang::get('affidavit.finalize')); ?></button>
		  <?php else: ?>
			  <a href="<?php echo e(url($menu_action.'part-a-detailed-report')); ?>" class="nextBtn float-right"><?php echo e(Lang::get('affidavit.next')); ?></a>
		  <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-zoom">
      <div class="modal-content">
        ...
        <div class="pop-header py-4">
          ...
          <h2 class="modal-title"><?php echo e(Lang::get('affidavit.confirmation')); ?></h2>
		<div class="header-caption px-4">
		  <p class="font-big"><?php echo e(Lang::get('affidavit.after_clicking_the_finalize_button')); ?></p>	
		</div>		
        </div>
        <!-- Modal footer -->
        <div class="confirm-footer">
			<form method="post" name="preview" action="<?php echo e(url($menu_action.'finalize')); ?>" enctype="multipart/form-data">
			<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
			<input type="hidden" name="id" value="<?php echo e(Auth::user()->id); ?>">


		  <button type="button" class="btn dark-pink-btn font-big mr-4" data-dismiss="modal"><?php echo e(Lang::get('affidavit.cancel')); ?></button>
          <button type="button" class="btn dark-purple-btn font-big" onclick="submitForm();"><?php echo e(Lang::get('affidavit.finalize')); ?></button>
		  </form>
        </div>
      </div>
    </div>
 ...
 <script> 
	function previewForm(){
		...
		if($('#defaultCheck1:checked').val()){
			...
			$('.form-check').after('<span class="err" id="span_"><?php echo e(Lang::get("affidavit.please_select_the_above_checkbox")); ?></span>');      
...
<?php echo $__env->make( (Auth::user()->role_id != '19') ? 'layouts.theme' : 'admin.layouts.ac.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/affidavit/preview.blade.php ENDPATH**/ ?>