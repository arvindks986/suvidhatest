...
<?php $__env->startSection('bradcome', 'Dashboard'); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
     ...
     <?php if(session('error_mes')): ?>
          <div class="alert alert-success"> <?php echo e(session('error_mes')); ?></div>
        <?php endif; ?>
    <?php
  ...
  <div class="col-md-6 pb-3">
                  ...
                  <div class="card income text-center mt-3">
                    <div class="d-flex justify-content-between">
                       <div class="icon"><img src="<?php echo e(asset('theme/img/icon/online-nomination-icon-002.png')); ?>" alt="" /></div>
                    <div><p>Applications</p><strong class="text-primary"><a href="<?php echo e(url('ropc/appointment_request')); ?>">Request for Appointment</a></strong></div>
                    <div class="number orange"><?php echo e($appointment_pend); ?></div>
              ...
              <div class="col-md-6 pb-3">
                  ...
                  <div class="card income text-center mt-3">
                    <div class="d-flex justify-content-between">
                       <div class="icon"><img src="<?php echo e(asset('theme/img/icon/online-nomination-icon-002.png')); ?>" alt="" /></div>
                       <div><p>Applications</p><strong class="text-primary"><a href="<?php echo e($phyical_verification); ?>">Pending Physical Verification</a></strong></div>
                    <div class="number orange"><?php echo e($total_pen_verification); ?></div>
                ...
                <div class="col-md-3">
                  ...
                  <div class="card income text-center">
                    ...
                    <div class="number yellow"><?php echo e($total); ?></div><p>Application<strong class="text-primary">Open</strong></p>
              ...
              <div class="row">
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Notification Date</strong><span><?php if(!empty($sched['DT_ISS_NOM'])): ?><?php echo e(date("d M Y",strtotime($sched['DT_ISS_NOM']))); ?>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Nomination LT DT</strong><span><?php if(!empty($sched['LDT_IS_NOM'])): ?><?php echo e(date("d M Y",strtotime($sched['LDT_IS_NOM']))); ?><?php endif; ?></span>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Scrutiny Date</strong><span><?php if(!empty($sched['DT_SCR_NOM'])): ?><?php echo e(date("d M Y",strtotime($sched['DT_SCR_NOM']))); ?><?php endif; ?></span>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Withdrawan Date</strong><span><?php if(!empty($sched['LDT_WD_CAN'])): ?><?php echo e(date("d M Y",strtotime($sched['LDT_WD_CAN']))); ?><?php endif; ?></span>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Poll Date</strong><span><?php if(!empty($sched['DATE_POLL'])): ?><?php echo e(date("d M Y",strtotime($sched['DATE_POLL']))); ?><?php endif; ?></span>
                ...
                <div class="col-xl-2 col-md-4 col-6">
                  <div class="wrapper count-title d-flex">
                    ...
                    <div class="name"><strong class="text-uppercase">Counting Date</strong><span><?php if(!empty($sched['DATE_COUNT'])): ?><?php echo e(date("d M Y",strtotime($sched['DATE_COUNT']))); ?><?php endif; ?></span>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/charts-home.js')); ?>"></script>
    
    <script type="text/javascript">
      // Set the date we're counting down to
        var po = "<?php if(!empty($sched->DATE_POLL)): ?><?php echo e(date("M d, Y 12:00:0",strtotime($sched->DATE_POLL))); ?><?php endif; ?>" ;
...
<?php echo $__env->make('admin.layouts.pc.dashboard-theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/admin/pc/ro/dashboard.blade.php ENDPATH**/ ?>