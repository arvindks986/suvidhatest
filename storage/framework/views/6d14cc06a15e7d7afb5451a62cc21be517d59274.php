<!DOCTYPE HTML>
 ...
 <head>
    ...
    <title>ECI Suvidha <?php echo $__env->yieldContent('title'); ?></title>
  ...
  <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet">
   ...
   <!--  <link rel="stylesheet" href="<?php echo e(asset('theme/css/grasp_mobile_progress_circle-1.0.0.min.css')); ?>"> -->
    ...
    <!-- Favicon-->
	 <link rel="stylesheet" href="<?php echo e(asset('admintheme/css/footable.bootstrap.css')); ?>"> 
 ...
 <link rel="stylesheet" href="<?php echo e(asset('theme/css/bootstrap-datetimepicker.css')); ?>"> 
  <link rel="stylesheet" href="<?php echo e(asset('theme/css/slicknav.css')); ?>">
<script>
...
<div class="main">
  ...
  <main>
    <!--bradcom start-->
      <?php echo $__env->make('includes.bradcom', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--bradcom end-->
...
<!-- JavaScript files-->
    ...
    <script src="<?php echo e(asset('theme/vendor/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js')); ?>"></script>
     ...
     <script src="<?php echo e(asset('js/validator.js')); ?>" type="text/JavaScript"></script>
    <!-- Main File-->
   ...
   <!--  <script src="<?php echo e(asset('theme/js/bootstrap-datepicker.js')); ?>"  type="text/JavaScript"></script> 
    <script src="<?php echo e(asset('admintheme/js/daterangepicker.js')); ?>"  type="text/JavaScript"></script>  -->
    <script src="<?php echo e(asset('js/uicommon.js')); ?>" type="text/JavaScript"></script> 
    
    <script src="<?php echo e(asset('admintheme/js/moment.min.js')); ?>"  type="text/JavaScript"></script> 
 <!-- <script src="<?php echo e(asset('admintheme/js/bootstrap-datepicker.js')); ?>"  type="text/JavaScript"></script> --> 
 <script src="<?php echo e(asset('admintheme/js/footable.js')); ?>"  type="text/JavaScript"></script>
 <script src="<?php echo e(asset('admintheme/js/bootstrap-datetimepicker.js')); ?>"  type="text/JavaScript"></script> 
  <script src="<?php echo e(asset('theme/js/jquery.slicknav.js')); ?>"  type="text/JavaScript"></script>
...
</html><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/layouts/theme.blade.php ENDPATH**/ ?>