...
<?php $__env->startSection('bradcome', 'Physical Verification'); ?>
		...
		<div class="card card-shadow">
			<div class="card-header">
				...
				<div class="col-md-6 col-12"><!--<h4 class="mb-0">Physical Verification</h4>-->
					<a href="<?php echo e(url('/ropc/dashboard')); ?>" class="btn btn-primary"
					id="">Home</a>
					<a href="<?php echo e(url('/ropc/list_of_applicatiant_pdf')); ?>" class="btn btn-primary" id="">Print Pdf</a>
					<button id="show_qr_code" class="btn btn-primary" type="button" style="display: none;">Scan QR CODE</button>
				</div> 
				<div class="col-md-6 col-12 text-right">
					<button type="button" id="filter_btn" class="btn btn-primary" style='<?php echo e(empty($status_filter) ? '' : 'display: none;'); ?>'>Show All Application</button>
					<a id="filter_row_hide" href="<?php echo e(url('/ropc/listallapplicant')); ?>" class="btn btn-primary" style='<?php echo e(empty($status_filter) ? "display: none;" : ''); ?>'>Scan QR CODE</a>
				</div> 
				</div>	 
			</div>
			<div id="all_body" class="card-body vlight-pink p-0">
				<div class="qrCode" style='<?php echo e(!empty($status_filter) ? "display: none;" : ''); ?>'>
				<div class="qrBar">
				<img id="qr_image" src="<?php echo e(asset('theme/img/vendor/qrcode.png')); ?>" alt="">
				...
				<div id="filter_row" class="row m-1" style="<?php echo e(empty($status_filter) ? "display: none;" : ''); ?>">
					<div class="col">
						<fieldset class="mb-2">
							...
							<div class="row">
								<div class="col">
									<label class="radioBtn">All applications
										<input type="radio" class="filter_dropdown" name="filter"
											value="all" <?php echo e($status_filter=='all' ? 'checked' : ''); ?>>
								...
								<div class="col">
									<label class="radioBtn">Pending physical verification
										<input type="radio" class="filter_dropdown" name="filter"
											value="pending" <?php echo e($status_filter=='pending' ? 'checked' : ''); ?>>
										<span class="checkmark"></span>
									</label>
								</div>
								<div class="col">
									<label class="radioBtn">Physical verification done
										<input type="radio" class="filter_dropdown" name="filter"
											value="cleared" <?php echo e($status_filter=='cleared' ? 'checked' : ''); ?>>
										<span class="checkmark"></span>
									</label>
								</div>
							</div>
				...
				<div class="srchBox">
				<div id="input_search_box" class="input-group" style='<?php echo e(!empty($status_filter) ? "display: none;" : ''); ?>'>
...
<div class="physc-wrap" style="<?php echo e(($status_filter=='') ? 'display: none' : ''); ?>">
    <?php $i=1; ?>
        ...
        <figure class="mb-0"><img src="<?php echo e(asset('theme/img/vendor/icon-001.png')); ?>"></figure>
         ...
         <h6 class="mb-0"><?php echo e($result['father_name']); ?></h6>
          ...
          <figure class="mb-0"><img src="<?php echo e(asset('theme/img/vendor/icon-003.png')); ?>"></figure>
					 <div>
						<h6><?php if(isset($result['nomination_no'])): ?><?php echo e($result['nomination_no']); ?><?php endif; ?></h6>
					 </div> 
				  </div>	

			  <!-- <div class="d-inline-flex align-items-center mt-1">
				  <figure class="mb-0"><img src="<?php echo e(asset('theme/img/vendor/district-icon.png')); ?>"></figure>
				  <div>
					  <h6><?php echo e(!empty($result['DIST_NO_HDQTR']) ? $result['DIST_NO_HDQTR'].'-'.getdistrictbydistrictno($result['st_code'],$result['DIST_NO_HDQTR'])->DIST_NAME : ''); ?></h6>
				  </div>
			  </div> -->
			  ...
			  <div class="d-inline-flex align-items-center mt-1">
				  ...
				  <div>
					  <h6><?php if(isset($party)): ?><?php echo e($party->PARTYNAME); ?> <?php endif; ?></h6>
				  </div>
			  </div>

			  
			  <div class="d-inline-flex align-items-center mt-1">
				  <figure class="mb-0"><img src="<?php echo e(asset('theme/img/vendor/state-icon.png')); ?>"></figure>
				  <div>
					  <h6><?php echo e(!empty($result['st_code']) ? getstatebystatecode($result['st_code'])->ST_NAME : ''); ?></h6>
				  </div>
			  </div>
			  
			  <div class="d-inline-flex align-items-center mt-1">
				  <figure class="mb-0"><img src="<?php echo e(asset('theme/img/vendor/ac-name-icon.png')); ?>"></figure>
				  <div>
					  <h6><?php echo e(!empty($result['ac_no']) ? $result['ac_no'].'-'.getacbyacno($result['st_code'], $result['ac_no'])->PC_NAME : ''); ?></h6>
				  </div>
			  </div>
			</div>
			...
			<div class="bg-light p-2 custom-border-right w-15">
				...
				<h5><?php echo e($status_txt); ?></h5> 
				<div class="phyStatus">
				  <span class="<?php echo e($status_color); ?>"></span>
				</div> 
				<strong>Status Date</strong>
				<?php if($result['finalize_after_payment'] == '1'): ?>
				<h5><?php echo e(!empty($result['finalize_after_payment_date']) ? date('d-m-Y', strtotime($result['finalize_after_payment_date'])) : ''); ?></h5>
				<?php else: ?>
				<h5>-</h5>
				<?php endif; ?>
			</div>
			...
			<div class="bg-custom-deposit w-25 p-2">
				...
				<?php if($payment_details['payment_type'] == 'Online'): ?>
					<h5>Online/</h5>&nbsp;
					<?php if(count($payment_details['payment_detail']) > 0): ?>
						<?php if($payment_details['payment_detail'][0]->bank_transtimestamp): ?>
							<h5><?php echo e(date('d-m-Y',strtotime($payment_details['payment_detail'][0]->bank_transtimestamp))); ?></h5>/&nbsp;
						<?php else: ?>
							<h5><?php echo e($payment_details['payment_detail'][0]->bank_transtimestamp); ?></h5>/&nbsp;
						<?php endif; ?>
					<?php else: ?>
					<h5>-</h5>/&nbsp;
					<?php endif; ?>
					<?php if($status_color=='defected'): ?>
					<h5>Not Avilable</h5>&nbsp;
				<?php else: ?>
					<h5><a href="#" class="payment_recipt_view" nom_id="<?php echo e($result['nomination_no']); ?>" >View</a></h5> &nbsp;
				<?php endif; ?>
				<?php elseif($payment_details['payment_type'] == 'Challan'): ?>
				<h5>Challan/</h5>&nbsp;
					<?php if(count($payment_details['payment_detail']) > 0): ?>
					<h5><?php echo e(date('d-m-Y',strtotime($payment_details['payment_detail'][0]->challan_date))); ?></h5>/&nbsp;
					<?php else: ?>
					<h5>-</h5>/&nbsp;
					<?php endif; ?>
					<?php if($status_color=='defected'): ?>
					<h5>Not Avilable</h5>&nbsp;
					<?php else: ?>
						<h5><a href="#" class="challan_payment_recipt_view" nom_id="<?php echo e($result['nomination_no']); ?>" >View</a></h5> &nbsp;
					<?php endif; ?>
					<?php elseif($payment_details['payment_type'] == 'Pay By Cash Paid'): ?>
					<h5>Paid by cash/</h5>&nbsp;
						<?php if(count($payment_details['payment_detail']) > 0 && $payment_details['payment_detail'][0]->pay_by_cash_paid == '1'): ?>
						<h5><?php echo e(date('d-m-Y',strtotime($payment_details['payment_detail'][0]->date_time_of_pbc))); ?></h5>&nbsp;
						<?php else: ?>
						<h5>-</h5>&nbsp;
						<?php endif; ?>
						<?php if($status_color=='defected'): ?>
						...
						<?php endif; ?>
				<?php else: ?>
				<h5><button cand_id="<?php echo e($result['candidate_id']); ?>" Pay_by_cash=<?php echo e($payment_details['payment_opt_ro'] == 'Pay By Cash' ? '1' : '0'); ?> class="btn btn-primary enter_details">Enter Payment Detail</button></h5> &nbsp;
				<?php endif; ?>
			</div>
			</div>
					<?php 
			...
			<div class="text-center w-15 p-2">
				...
				<div class="my-2">
					<?php if(!$btn_status): ?>
					<a href="<?php echo e($url.'/ropc/candidateinformation?nom_id='.encrypt_string($result['nomination_no'])); ?>" class="phy-btn dark-purple-btn">Proceed For Physical Verification</a>
					<?php else: ?>
					Receipt <i class="fa fa-download" aria-hidden="true"><a href="<?php echo e(url('/ropc/nomination-receipt-print').'?'.http_build_query(['nom_id' => encrypt_string($result['nomination_no']), 'direct_print'=> true])); ?>" target="_blank">English</a></i>\<i class="fa fa-download" aria-hidden="true"><a href="<?php echo e(url('/ropc/nomination-receipt-print/Hindi').'?'.http_build_query(['nom_id' => encrypt_string($result['nomination_no']), 'direct_print'=> true])); ?>" target="_blank">Hindi</a></i>
					<?php endif; ?>
				</div>
				
            <div>
		<div><a href="<?php echo e(url('/ropc/detail/'.encrypt_string($result['id']))); ?>" class="btn font-big">View All Details</a></div>
        </div>
			</div>
		</div>
      <?php $i++; ?>
		   ...
		   <div class="pop-header pt-3 pb-1">
			...
			<form class="form-horizontal" method="post" action="" multiple="multiple">
			 ...
			 <div class="modal-body">
			  ...
			  <div class="challan_text" style="text-align: center; font-size: 15px; font-weight: bold;"><?php echo e(__('Paid by challan')); ?></div>
			   <?php if(!empty($state_payment_url)): ?>
				<div style="text-align: center;"><?php echo e(__('messages.paylink')); ?><span><a href="http://<?php echo $state_payment_url; ?>" target="_blank">&nbsp; Payment Link</a></span></div>
			   <?php endif; ?>	
			  <br>
			  <ul style="list-style: none;">
				...
				<li>
					<div class="row">
					<div class="col-md-4">
						<label><?php echo e(__('Challan No')); ?></label>
					</div>
					<div class="col-md-8">
				...
				<li>
					<div class="row">
						<div class="col-md-4">
							<label><?php echo e(__('Challan Date')); ?></label>
						</div>
						<div class="col-md-8">
				...
				<li class="mb-3">
					<div class="row">
						<div class="col-md-4
						">
							<label><?php echo e(__('Challan Receipt')); ?></label>
						</div>
						<div class="col-md-8">
			  ...
			  <div class="confirm-footer mt-4">
				<button type="button" class="btn btn-secondary" data-dismiss="modal" style="background:#f0587e; border: none;"><?php echo e(__('Cancel')); ?></button>	
				&nbsp;
...
<?php echo $__env->make('admin/nfd/nomination/form/step1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('script'); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset('theme/js/instascan.min.js')); ?>"></script>
<script type="text/javascript">
    ...
    jQuery(document).ready(function(){
		...
		$('.payment_recipt_view').click(function(e) {
			...
			$.ajax({
			url: "<?php echo e(url('/ropc/recipt_details')); ?>",
			type: 'POST',
		...
		$('.challan_payment_recipt_view').click(function(e) {
			var nom_id_value = $(this).attr('nom_id');
			$.ajax({
			url: "<?php echo e(url('/ropc/challan_recipt_details')); ?>",
			type: 'POST',
			data: '_token=<?php echo csrf_token() ?>&nom_id='+nom_id_value,
			dataType: 'json',
			beforeSend: function() {
		...
		$('#camera_btn').click(function(e) {
			...
			scanner.addListener('scan', function (content) {
					$.ajax({
						url: "<?php echo e(url('/ropc/decrypt_nom_id')); ?>",
						type: 'POST',
						data: {
		...
		$('#payment_detail_form_submit').click(function(e) {
			...
			var formData = new FormData(form[0]);
				$.ajax({
				url: "<?php echo e(url('/ropc/submit_challan_details')); ?>",
				type: 'POST',
				data: formData,
				dataType: 'json',
				processData: false,
...
<?php echo $__env->make('admin.layouts.pc.dashboard-theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/admin/candform/list-all-applicant.blade.php ENDPATH**/ ?>