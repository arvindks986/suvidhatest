...
<div class="container">
 <div class="step-wrap mt-4">
	 <ul>
	   ...
	   <li class="step-current"><b>&#10004;</b><span><?php echo e(__('step1.step6')); ?></span></li>
          ...
          <div class="row">
		   ...
		   <?php 
               ...
               <div class="card-header d-flex align-items-center">
                <!-- <h4><?php echo e(__('part3a.Affidavit')); ?></h4>-->
				<h4><?php echo e(__('messages.Affidavit')); ?></h4>
               </div>
               <div class="card-body">
				 <div class="card-header d-flex align-items-center">
						...
						<div id="showprev" style="font-size: 18px; margin-top: 30px; width: 51%; float: right;display:none;">
						 <ul class="list-inline">						  
							<li class="list-inline-item text-right btn btn-primary" onclick="return showPo();"><?php echo e(__('messages.preaff')); ?></li>
						 </ul>
						</div>
						...
						<?php if(!empty($assigned_e_affidavit)): ?>	
						<div id="afterLink">	
						<div style="font-size:18px;color:black;">
						<?php echo e(__('messages.thenom')); ?> - (<?php echo e($reference_id); ?>) <?php echo e(__('messages.linked')); ?> - (<?php echo e($assigned_e_affidavit); ?>) 
						</div>
						
						<div style="float: right; margin-right: 40px;">
						<a href="<?php echo e(url('part-a-detailed-report?pdf=yes&affidavit_id='.$assigned_e_affidavit)); ?>" class="btn btn-primary" target="_blank"><?php echo e(__('messages.downaff')); ?></a>
						</div>
					...
					<div style="font-size: 18px; margin-top: 30px; width: 97%; border: 2px solid gray;">						
						...
						<?php if(empty($assigned_e_affidavit)): ?>							
						<span style="margin-left:6em;"><?php echo e(__('messages.selaff')); ?></span>
						...
						onchange="return showAction(this.value);">						 
						  <option value=""><?php echo e(__('messages.selaff')); ?></option>
						 <?php $__currentLoopData = $af; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						 ...
						 $kk++;
						 ?>
						  <option  value="<?php echo e($da['affidavit_id']); ?>*<?php echo e($finalizeSttaus); ?>*<?php echo e($da['id']); ?>" <?php if($assigned_e_affidavit==$da['affidavit_id']) { echo "selected";} ?>><?php echo e($da['affidavit_id']); ?></option>
						 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</select>		
						
						<div class="modal-content" style="display:none;" id="ifrDiv"> 
						  <div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('messages.fillaff')); ?></h5> 
							<div style="float: right; padding: 3px;margin-bottom:20px;">
							 <div onclick="return closePopup();" class="btn btn-lg  dark-pink-btn"><?php echo e(__('messages.Close')); ?></div>
							 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							 <div style="float: right; margin-right: -14px;" onclick="return downloadaffidavit();" class="btn btn-lg btn-primary"> <?php echo e(__('messages.downaff')); ?>
						  ...
						  <div onclick="return closePopup();" class="btn btn-lg  dark-pink-btn"> <?php echo e(__('messages.Close')); ?></div>
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  <div class="btn  btn-lg btn-primary" onclick="return editEaffidavit();"><?php echo e(__('messages.Edit')); ?></div> 
						  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						  <div class="btn btn-lg btn-primary" onclick="return MakeEAffidavitFinalize();"><?php echo e(__('messages.Finalize')); ?> </div> 
						  <br>
						  </div>
						  </div>
						</div>
						 <div class="col-md-5"  id="mainDivX" style="display:none;">
						  <ul class="list-inline float-right">						  
							<li class="list-inline-item text-right" onclick="return pageRid();" ><a  class="btn btn-primary" style="color:white;"><?php echo e(__('messages.preaff')); ?></a></li>
						...
						<div class="col-md-5"  id="PreviewX" style="display:<?php echo e($st); ?>;">
						  <ul class="list-inline float-right">						  
							<li class="list-inline-item text-right" onclick="return pageRid();" ><a  class="btn btn-primary" style="color:white;"><?php echo e(__('messages.preaff')); ?></a></li>
						  </ul>
						</div>
						...
						<br>
						<br>	
						<div class="col-md-12" id="Instruction1"><span style="color:red"><?php echo e(__('messages.Instruction')); ?></span>:-<br>
						1.  <?php echo e(__('messages.ins1')); ?><br><br>
						2.  <?php echo e(__('messages.ins2a')); ?> (<?php echo e($reference_id); ?>) <?php echo e(__('messages.ins2b')); ?>  <br><br>
						3.  <?php echo e(__('messages.ins3')); ?><br><br>
						4.  <?php echo e(__('messages.ins4')); ?>  <br> <br>
						5.  <?php echo e(__('messages.ins5')); ?> <br><br>
						6.  <?php echo e(__('messages.ins6')); ?><br><br>
						</div>
						<?php endif; ?>
						
						<?php else: ?> 
						<span class="col-md-5" > <?php echo e(__('messages.noaff')); ?></span>	<br>
						<span class="col-md-5" onclick="return first();"><a class="btn btn-primary" style="color:white;"><?php echo e(__('messages.fillaff')); ?></a></span>
						<br><br>
						<div class="col-md-12" id="Instruction2"><span style="color:red"><?php echo e(__('messages.Instruction')); ?></span>:-<br>
						1. <?php echo e(__('messages.ins1')); ?><br><br>
						2. <?php echo e(__('messages.ins2a')); ?> (<?php echo e($reference_id); ?>) <?php echo e(__('messages.ins2b')); ?> <br><br>
						3. <?php echo e(__('messages.ins3')); ?> <br><br>
						4. <?php echo e(__('messages.ins4')); ?> <br> <br>
                 ...
                 <div class="row" id="pdf" style="display:<?php echo e($st); ?>;margin-left:0px;width:100%;">
                   <div class="col">
				   <div style="font-size:18px;margin-bottom:20px;"> 
				   <span style="color: blue;"> <?php echo e(__('messages.Optional')); ?> </span> : <br> 
				  <?php echo e(__('messages.Optional_message')); ?></div>
				   <br>
                      ...
                      <div class="nomination-parts box recognized fullwidth">
                        <form method="post" action="<?php echo $action; ?>" enctype="multipart/form-data">
                          ...
                          <div class="file-frame" style="width: 100%;">
                            <button class="file btn btn-primary"  type="button" style="width: 100%;"><?php echo e(__('part3a.Browse')); ?> <i class="fa fa-upload"></i></button>
                            <input type="hidden" name="affidavit" id="affidavit" class="affidavit" value="<?php echo e($affidavit); ?>">
                          </div>  
                            </div>
						  ...
						  <div class="card-footer">
							<div class="row align-items-center">
							  ...
							  <div class="col-sm-6 col-12">
								...
								&nbsp;
								&nbsp;	
							<!--<button type="submit" class="btn btn-lg font-big dark-purple-btn pop-actn" onclick="return checkaff();"><?php echo e(__('step1.Save_Next')); ?></button>-->
			   ...
			   <div class="card-footer" style="display:<?php echo e($st2); ?>;" id="back">
				    <div class="row align-items-center">
					  <div class="col-sm-6 col-12"> <a href="<?php echo e($href_back); ?>"  class="btn btn-lg btn-secondary font-big"><?php echo e(__('step1.Back')); ?></a> </div>
					</div>
				</div> 
            </div>
          </div>
   ...
   <div class="modal fade" id="basicExampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">	
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			<h5 class="modal-title" id="exampleModalLabel"><?php echo e(__('messages.linkaff')); ?></h5> 
			...
			<div class="row">
				<div class="col-md-8 col-12">
				  <ul class="list-inline" style="width: 157%;">
				   <li class="list-inline-item"><?php echo e(__('messages.areryousure')); ?></span></li>
				  </ul>  
				</div>   
			  </div>
		  </div>
		  <input type="hidden" id="assined_id">
		  <input type="hidden" id="nom" value="<?php echo e($reference_id); ?>">
		  <div id="bt">
		...
		<div class="modal-content">
		  ...
		  <div class="modal-body" style="border-bottom: 1px solid #e9ecef;">
			<div class="row">
				<div class="col-md-8 col-12">
				  <ul class="list-inline" style="width: 157%;">
				   <li class="list-inline-item"><?php echo e(__('messages.ins2a')); ?> (<?php echo e($reference_id); ?>) <?php echo e(__('messages.ins2b')); ?>  </span></li>
				  </ul>  
				</div>   
			  </div>
		  </div>
		  ...
		  <div class="modal-footer">
			...
			<?php echo e(__('messages.Yes')); ?></a></button>
		  </div>
		  </div>
		</div>
	  </div>
  ...
  <?php $__env->startSection('script'); ?>
    ...
    x(document).ready(function(){
     ...
     if(k('#breadcrumb').length){
       var breadcrumb = '';
       k.each(<?php echo json_encode($breadcrumbs); ?>,function(index, object){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/nomination/apply-nomination-step-6.blade.php ENDPATH**/ ?>