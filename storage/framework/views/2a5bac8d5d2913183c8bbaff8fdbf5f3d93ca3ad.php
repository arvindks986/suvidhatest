...
<main>
  ...
  <section class="main-box">
     ...
     <div class="circle peach-gradient"><img src="<?php echo e(asset('theme/img/vendor/background.png')); ?>" alt=""></div>
...
<div class="container-fluid h-100">
   ...
   <div class=" btn-group main-nav">
          ...
          <input type="button" class="btn btn-link active" onclick="location.href = '<?php echo e($url); ?>/login';" value="Candidate Login"/> 
           <!--  <input type="button" class="btn btn-link" onclick="location.href = '<?php echo e($url); ?>/officer-login';" value="Officer Login"/>	 -->
        </div>
...
<script type="text/javascript">
  function redirect_parliament(){
    window.location.href = "<?php echo e(config('public_config.ac_url_cand')); ?>";
  }
</script>
 <form method="POST" action="<?php echo url('change-database'); ?>" id="change_databsse"> 
      ...
      <div class="form-group">
            <select name="database" class="form-control" id="new" onchange="submit()">
                ...
                <?php if($details->candidate_active_status == 1): ?>
     ...
     <script type="text/javascript">
	  ...
	  <form class="log-frm-area" method="POST" action="<?php echo e(url('/user-postlogin')); ?>" autocomplete='off' enctype="x-www-urlencoded" id="otpsend">
		 <?php echo e(csrf_field()); ?>

			<span class="help-block"> <strong><?php echo e(Session::get('log_message')); ?></strong></span>
			<div class="row m-0" id="logincondrow1">
    <div class="col" id="logincond1" style="display: block"> 
				<div class="form-group">
					<input id="mobile" type="text" class="form-control<?php echo e($errors->has('mobile') ? ' is-invalid' : ''); ?>" name="mobile" value="<?php echo e(old('mobile')); ?>"  autofocus placeholder="Mobile Number"  autocomplete="off" maxlength="10" minlength="10" autofocus >
    ...
    <div class="col col-xs-12 pr-0 d-flex align-items-center capchtainpyt">
		  <input id="captcha" type="text" class="form-control<?php echo e($errors->has('captcha') ? ' is-invalid' : ''); ?>" name="captcha"  placeholder="captcha"   autocomplete="off"/>&nbsp;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/auth/login.blade.php ENDPATH**/ ?>