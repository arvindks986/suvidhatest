...
<div class="container">
 <div class="step-wrap mt-4">
	 <ul>
	   ...
	   <li class="step-current"><b>&#10004;</b><span><?php echo e(__('step1.step5')); ?></span></li>
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-12">
          <div class="card">
           ...
           <div class="card-header d-flex align-items-center">
             <h4><?php echo e(__('part3a.nomp')); ?></h4>
           </div>
                 ...
                 <div class="part3 form_steps">
                    ...
                    <div class="nomination-parts">
                      <div class="nomination-form-heading text-center">
                        <h3><strong><?php echo e(__('part3a.Part3a')); ?></strong></h3>
                        (<?php echo e(__('part3a.tobe')); ?>) 
                      </div>

                      <div class="nomination-detail">
                        <div class="criminal-section">
                         (1)   (<?php echo e(__('part3a.whether')); ?>) —
                          <ul class="Ullist mb-3">
							  <li>(i) <?php echo e(__('part3a.conv')); ?>— 
								  <ul class="">
								  <li>(a)  <?php echo e(__('part3a.offe')); ?></li> <br />
								  <li>(b)  <?php echo e(__('part3a.oro')); ?> -</li> <br />
								  </ul>
							  </li> <br />
						  <li>(ii) <?php echo e(__('part3a.impo')); ?> </li>
						  <div class="animate-wrap court_wrap" style="display:<?php echo ($have_police_case=='yes' || $have_police_case=='no')?'none':'block';?>">
									<div class="animate-help-text dir-lft">
										<div class="help-text"><?php echo e(__('messages.arcrt')); ?></div>
					   ...
					   <div class="criminal-section">
						  <ul class="Ullist mb-3">
							<li class="d-inline-flex my-3">
								<div class="custom-control custom-radio customRadioBtn mx-4">
								  ...
								  <?php endif; ?>	
								  <label class="custom-control-label" for="tata"><?php echo e(__('part3a.Yes')); ?></label>
								</div> 
								<div class="custom-control custom-radio customRadioBtn">
								<?php if($have_police_case=='no'): ?> 	
							    ...
							    <?php endif; ?>
								<label class="custom-control-label" for="atat"><?php echo e(__('part3a.No')); ?></label>
								</div> 
                        ...
                        <div class="criminal-section have_police_case_div field_wrapper display_none">      
                         <div class="information"><strong>[<?php echo e(__('part3a.ifye')); ?>]</strong></div>
                          ...
                          <div class="fullwidth have_police_case_record">                            
                            <table class="table">
                              <tbody class="police_case_body"> 
                               ...
                               <tr class="row_class_<?php echo e($i); ?>">
                                 <td class="nomination-detail" colsan="2">
								 <fieldset>
								 <legend><h5><?php echo e(__('part3a.case')); ?> <?php echo $case_heading; ?></h5></legend>
								 
                                    <ol type="i">
                                      <li><?php echo e(__('part3a.ca1')); ?> <input type="text" name="police_case[<?php echo e($i); ?>][case_no]" class="form-control" value="<?php echo e($iterate_police_case['case_no']); ?>" required></li>
                                      <li><?php echo e(__('part3a.pol')); ?><input type="text" name="police_case[<?php echo e($i); ?>][police_station]" class="form-control nomination-field-2" value="<?php echo e($iterate_police_case['police_station']); ?>" required><br>
                                        <?php echo e(__('part3a.st')); ?>

                                        <select name="police_case[<?php echo e($i); ?>][st_code]" class="form-control nomination-field-2" onchange="load_district(this.value, <?php echo $i ?>)" required>
                                          <option value="">--  <?php echo e(__('part3a.sels')); ?> --</option>
                                          ...
                                          <?php if($iterate_state['st_code'] == $iterate_police_case['st_code']): ?>
                                         ...
                                         <?php echo e(__('part3a.dist')); ?>

                                        <select name="police_case[<?php echo e($i); ?>][district]" class=" form-control nomination-field-2 district_<?php echo $i ?>" required>
                                          <option value="">--  <?php echo e(__('part3a.disd')); ?> --</option>
                                          <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_district): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <?php if($iterate_district['st_code'] == $iterate_police_case['st_code']): ?>

                                          <?php if($iterate_district['st_code'] == $iterate_police_case['st_code']): ?>
                                          <option value="<?php echo e($iterate_district['district_no']); ?>" selected="selected"><?php echo e($iterate_district['district_name']); ?></option>
                                          <?php else: ?>
                                          <option value="<?php echo e($iterate_district['district_no']); ?>"><?php echo e($iterate_district['district_name']); ?></option>
                                          <?php endif; ?>
                                      ...
                                      <li><?php echo e(__('part3a.sec1')); ?>  <input type="text" name="police_case[<?php echo e($i); ?>][convicted_des]" class="form-control nomination-field-2" value="<?php echo e($iterate_police_case['convicted_des']); ?>" style='width:800px;' required></li>

                                      <li> <?php echo e(__('part3a.cdat')); ?> <input id="date_of_conviction<?php echo $i ?>" type="text" name="police_case[<?php echo e($i); ?>][date_of_conviction]" class="form-control  nomination-field-2 date_jqueryui" value="<?php echo e($iterate_police_case['date_of_conviction']); ?>" required></li>
                                      
                                      <li><?php echo e(__('part3a.cour')); ?>  <input type="text" name="police_case[<?php echo e($i); ?>][court_name]" class="form-control nomination-field-2" value="<?php echo e($iterate_police_case['court_name']); ?>" style='width:800px;' required></li>

                                      <li><?php echo e(__('part3a.puni')); ?> <input type="text" name="police_case[<?php echo e($i); ?>][punishment_imposed]" class="form-control nomination-field-2" value="<?php echo e($iterate_police_case['punishment_imposed']); ?>" style='width:800px;' required></li>
									  <?php $dt=''; ?>		
									  <?php if($iterate_police_case['date_of_release']!='1970-01-01'): ?>
									  <?php $dt=$iterate_police_case['date_of_release']; ?>		
									  <?php endif; ?>	
									  
                                      <li> <?php echo e(__('part3a.rele')); ?> <input type="text" id="date_of_release<?php echo $i ?>" name="police_case[<?php echo e($i); ?>][date_of_release]" class="form-control nomination-field-2 date_jqueryui" value="<?php echo e($dt); ?>"></li>
									  
									  
                                      <li><?php echo e(__('part3a.aga')); ?>

                                        <select name="police_case[<?php echo e($i); ?>][revision_against_conviction]" class="form-control nomination-field-2 against_conviction" required>
                                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <?php if($iterate_lis['id'] == $iterate_police_case['revision_against_conviction']): ?>
                                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                                          <?php else: ?>
                                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                                          <?php endif; ?>
                                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
										...
										<li><?php echo e(__('part3a.agad')); ?> <input type="text" id="revision_appeal_date<?php echo $i ?>" name="police_case[<?php echo e($i); ?>][revision_appeal_date]" class="form-control nomination-field-2 date_jqueryui"   value="<?php echo e($iterate_police_case['revision_appeal_date']); ?>" required></li>

                                        <li><?php echo e(__('part3a.revf')); ?> <input type="text" name="police_case[<?php echo e($i); ?>][rev_court_name]" class="form-control nomination-field-2" value="<?php echo e($iterate_police_case['rev_court_name']); ?>" style='width:800px;' required></li>

                                        <li><?php echo e(__('part3a.dips')); ?> 
                                          <select name="police_case[<?php echo e($i); ?>][status]" class="form-control nomination-field-2 status" required>
                                            <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($iterate_lis['id'] == $iterate_police_case['status']): ?>
                                            <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                                            <?php else: ?>
                                            <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                                            <?php endif; ?>
                                        ...
                                        <li class="statusReport"><?php echo e(__('part3a.diee')); ?> —

                                          <ul>
                                            <li>(a) <?php echo e(__('part3a.didd')); ?> <input type="text" id="revision_disposal_date<?php echo $i ?>" name="police_case[<?php echo e($i); ?>][revision_disposal_date]" class="form-control date_jqueryui"  value="<?php echo e($iterate_police_case['revision_disposal_date']); ?>" required></li>
                                            
                                            <li>(b) <?php echo e(__('part3a.nat')); ?> <input type="text" name="police_case[<?php echo e($i); ?>][revision_order_description]" class="form-control nomination-field-2" value="<?php echo e($iterate_police_case['revision_order_description']); ?>" style='width:800px;' required></li>
                                          </ul>
                                        </li>
                                      ...
                                      <button type="button" class="btn btn-default remove_police_case mb-3 float-right" id="remove_<?php echo $i; ?>" onclick="remove_police_case('row_class_<?php echo $i ?>')"><?php echo e(__('part3a.remo')); ?></button>
									  </fieldset>
                                    </td>
                                  </tr>
                                ...
                                <tfoot>
                                  <tr>
                                    ...
                                    <td class="text-right">
                                      <button type="button" class="btn btn-primary add_police_case"><?php echo e(__('part3a.add')); ?> </button>
                                    </td>
                       ...
                       (2) <?php echo e(__('part3a.prop')); ?> 
                        ...
                        <small>(<?php echo e(__('part3a.Yes')); ?> / <?php echo e(__('part3a.No')); ?> )</small>
                        <ul><li><?php echo e(__('part3a.ifyes1')); ?> 
						<?php 
						$widthStart='';
						if($office_held==''){
						 $d1='readonly';	
						...
						<input id="one" type="text" name="office_held" class="form-control nomination-field-2" value="<?php echo e($office_held); ?>" <?php echo e($d1); ?> <?php echo e($widthStart); ?>></li></ul>
						
				

                       (3) <?php echo e(__('part3a.inso')); ?>  <select name="court_insolvent" class="form-control nomination-field-2" onchange="return myval(this.value, 'two');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $court_insolvent): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select><small>(<?php echo e(__('part3a.Yes')); ?> / <?php echo e(__('part3a.No')); ?> )</small>
                        <ul><li>-<?php echo e(__('part3a.disc')); ?>  
						...
						<input id="two" type="text" name="discharged_insolvency" class="form-control nomination-field-2" value="<?php echo e($discharged_insolvency); ?>" <?php echo e($d2); ?> <?php echo e($widthoo); ?>> 
						
						</li></ul>

                      (4) <?php echo e(__('part3a.alle')); ?> <select name="allegiance_to_foreign_country" class="form-control nomination-field-2" onchange="return myval(this.value, 'three');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $allegiance_to_foreign_country): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                        ...
                        <ul><li>-<?php echo e(__('part3a.alled')); ?> 
						...
						?>
						<input id="three" type="text" name="country_detail" class="form-control nomination-field-2" value="<?php echo e($country_detail); ?>" <?php echo e($d3); ?> <?php echo e($width1); ?>> </li></ul>

                       (5) <?php echo e(__('part3a.disq')); ?> <select name="disqualified_section8A" class="form-control nomination-field-2" onchange="return myval(this.value, 'four');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $disqualified_section8A): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                        ...
                        <ul><li>-<?php echo e(__('part3a.peri')); ?> 
						...
						<input id="four" type="text" name="disqualified_period" class="form-control nomination-field-2"  value="<?php echo e($disqualified_period); ?>" <?php echo e($d4); ?> <?php echo e($width2); ?>></li></ul>

                      (6) <?php echo e(__('part3a.corr')); ?> <select name="disloyalty_status" class="form-control nomination-field-2" onchange="return myval(this.value, 'date_of_dismissal');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $disloyalty_status): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                        ...
                        <ul><li>-<?php echo e(__('part3a.cord')); ?> 
						...
						<input type="text" id="date_of_dismissal" name="date_of_dismissal" class="form-control nomination-field-2 date_jqueryui" value="<?php echo e($date_of_dismissal); ?>"    <?php echo e($d5); ?>></li></ul>

                        (7) <?php echo e(__('part3a.subs')); ?><select name="subsiting_gov_taken" class="form-control nomination-field-2" onchange="return myval(this.value, 'subsitting_contract');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $subsiting_gov_taken): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                        ...
                        <ul><li>-<?php echo e(__('part3a.subp')); ?>
						...
						<input type="text" id="subsitting_contract" name="subsitting_contract" class="form-control nomination-field-2" value="<?php echo e($subsitting_contract); ?>" <?php echo e($d6); ?> <?php echo e($width4); ?>></li></ul>

                       (8) <?php echo e(__('part3a.agen')); ?><select name="managing_agent" class="form-control nomination-field-2" onchange="return myval(this.value, 'gov_detail');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $managing_agent): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                        ...
                        <ul><li>-<?php echo e(__('part3a.aged')); ?> 
						...
						<input type="text" id="gov_detail" name="gov_detail" class="form-control nomination-field-2" value="<?php echo e($gov_detail); ?>" <?php echo e($d8); ?> <?php echo e($width5); ?>></li></ul>

                       (9) <?php echo e(__('part3a.comm')); ?> <select name="disqualified_by_comission_10Asec" class="form-control nomination-field-2" onchange="return myval(this.value, 'date_of_disqualification');">
                          <?php $__currentLoopData = $yes_no_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $iterate_lis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($iterate_lis['id'] == $disqualified_by_comission_10Asec): ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>" selected="selected"><?php echo e($iterate_lis['name']); ?></option>
                          <?php else: ?>
                          <option value="<?php echo e($iterate_lis['id']); ?>"><?php echo e($iterate_lis['name']); ?></option>
                          <?php endif; ?>
                        ...
                        <ul><li>-<?php echo e(__('part3a.comd')); ?> 
						...
						?>
						<input type="text" id="date_of_disqualification" name="date_of_disqualification" class="form-control nomination-field-2 date_jqueryui" value="<?php echo e($date_of_disqualification); ?>" <?php echo e($d7); ?>></li></ul>

                      </div>
				
                      <div class="nomination-signature">
                        <span class="nomination-date left"><?php echo e(__('part3a.Date')); ?>: <input type="text" name="date_of_disloyal" id="date_of_disloyal" class="nomination-field-4" value="<?php if($date_of_disloyal==''): ?><?php echo e(date('Y-m-d')); ?><?php else: ?><?php echo e($date_of_disloyal); ?><?php endif; ?>" readonly="readonly" required>
         ...
         <!-- <div class="card-footer">
          <div class="form-group row ">
            <div class="col">
              <a href="<?php echo e($href_back); ?>" id="" class="btn btn-secondary float-left">Back</a>
            </div>
            <div class="col ">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-sm-6 col-12">
			...
			&nbsp;
			&nbsp;	
			<button type="submit" class="btn btn-lg font-big dark-purple-btn pop-actn"><?php echo e(__('step1.Save_Next')); ?></button>
			</div>          
		  </div>
        </div>
      </div> 
...
<script>
  ...
  $(document).ready(function(){  
   ...
   $('.add_police_case').click(function(e){
    ...
    <?php foreach($states as $iterate_state){ ?>
      html += "<option value='<?php echo e($iterate_state['st_code']); ?>'><?php echo e($iterate_state['st_name']); ?></option>";
    <?php } ?>
    html += "</select>";
    ...
    <?php foreach($yes_no_lists as $iterate_lis){ ?>
      html += "<option value='<?php echo e($iterate_lis['id']); ?>'><?php echo e($iterate_lis['name']); ?></option>";
    <?php } ?>
    html += "</select>";
    html += "</li>";
    html += "<li>";
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.theme', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\suvidha\resources\views/nomination/apply-nomination-step-5.blade.php ENDPATH**/ ?>