...
class PostalBallotResultsPublishModel extends Model
{
    
    protected $table ="postal_ballot_results_publish";
    protected $primaryKey ='id'; 
 
    protected $fillable = ['st_code','election_id','pc_no','ac_no','certificate','agree','added_create_at','created_by','updated_at','added_update_at','updated_by','transactiontime','created_at','roname','name'];
   
   public static function add_records($data = array()){
              date_default_timezone_set('Asia/Kolkata');
                $datetime = date("Y-m-d H:i:s");
                $date = date("Y-m-d");
              $object = new PostalBallotResultsPublishModel();
